(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();var b=(n=>(n[n.Arousal=0]="Arousal",n[n.Flow=1]="Flow",n[n.Control=2]="Control",n[n.Relaxation=3]="Relaxation",n[n.Boredom=4]="Boredom",n[n.Apathy=5]="Apathy",n[n.Worry=6]="Worry",n[n.Anxiety=7]="Anxiety",n))(b||{});let J={};async function V(n,e){try{J=await e.loadJson(`locales/${n}.json`)}catch(t){console.warn(`Failed to load ${n} translations:`,t),n!=="en"&&await V("en",e)}}function ne(){return typeof navigator<"u"&&navigator.language?navigator.language.split("-")[0]:"en"}function a(n,e={}){let s=n.split(".").reduce((i,o)=>i?i[o]:void 0,J);if(!s)return console.warn(`Translation not found for key: ${n}`),n;for(const i in e)s=s.replace(`{${i}}`,String(e[i]));return s}async function ae(n){const e=ne();await V(e,n)}class k{constructor(){this.entries=[],this.listeners=[],this.muted=!1}static getInstance(){return k.instance||(k.instance=new k),k.instance}on(e){this.listeners.push(e)}log(e,t="INFO",s){const i=a(`log_messages.${e}`,s),o={message:i,level:t,timestamp:Date.now(),data:s};this.muted||(this.entries.push(o),t!=="DEBUG"&&console.log(`[${t}] ${i}`)),this.listeners.forEach(r=>r(o))}debug(e){const t={message:e,level:"DEBUG",timestamp:Date.now()};this.muted||this.entries.push(t),this.listeners.forEach(s=>s(t))}info(e,t){this.log(e,"INFO",t)}warn(e,t){this.log(e,"WARN",t)}error(e,t){this.log(e,"ERROR",t)}toJSON(){return{entries:this.entries}}loadEntries(e){this.entries=e||[]}static fromJSON(e){const t=k.getInstance();return t.loadEntries(e.entries),t}}class oe{constructor(e){this.seed=e}setSeed(e){this.seed=e}nextFloat(){let e=this.seed+=1831565813;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}nextInt(e,t){return Math.floor(this.nextFloat()*(t-e+1))+e}}const y=new oe(Date.now()),Q=n=>`${n}_${y.nextFloat().toString(36).substr(2,9)}`,re=(n,e)=>y.nextInt(n,e),Y=n=>{const e=[...n];for(let t=e.length-1;t>0;t--){const s=y.nextInt(0,t);[e[t],e[s]]=[e[s],e[t]]}return e},X=(n,e,t,s)=>{const i=e.filter(d=>n.includes(d.id)),o=[],r={common:.6,uncommon:.3,rare:.1,legendary:0},l={common:0,uncommon:0,rare:0,legendary:0},c={common:0,uncommon:0,rare:0,legendary:0};Object.keys(r).forEach(d=>{c[d]=Math.floor(t*r[d])});let u=Object.values(c).reduce((d,f)=>d+f,0);for(;u<t;)c.common+=1,u+=1;i.filter(d=>d.cost!==null).forEach(d=>{o.push(s(d)),l[d.rarity]+=1}),Object.keys(r).forEach((d,f)=>{const h=i.filter(p=>p.rarity===d);for(;l[d]<c[d]&&h.length!==0;){const p=y.nextInt(0,h.length-1),g=h[p];o.push(s(g)),l[d]+=1}});const m=i.filter(d=>d.rarity==="common");for(;o.length<t&&m.length>0;){const d=y.nextInt(0,m.length-1),f=m[d];o.push(s(f))}return Y(o)},U=(n,e,t)=>X(n,e,t,s=>({...s,instanceId:Q(s.id)})),j=(n,e,t)=>X(n,e,t,i=>{const o={...i,instanceId:Q(i.id)};return o.type==="room_enemy"&&o.stats.minUnits&&o.stats.maxUnits&&(o.units=re(o.stats.minUnits,o.stats.maxUnits)),o}),le=n=>n.roomHand.length<3&&!n.roomHand.some(e=>e.type==="room_boss"),ce=n=>[...new Set(n.hand.map(t=>t.id))].length<2&&n.hand.length>0;function de(n,e){const t=Math.max(0,Math.min(100,n)),s=Math.max(0,Math.min(100,e));return s>66?t<33?b.Anxiety:t<87?b.Arousal:b.Flow:s>33?t<33?b.Worry:t<67?b.Apathy:b.Control:t<67?b.Boredom:b.Relaxation}const L={hp:100,maxHp:100,power:5},he=3;class T{constructor(e,t){this.hp=L.hp,this.maxHp=L.maxHp,this.power=L.power,this.skill=e.skill,this.challengeHistory=[50],this.flowState=b.Boredom,this.traits=e,this.inventory={weapon:null,armor:null,potions:[]},this.activeBuffs=[],this.logger=k.getInstance(),this.roomHistory=[],this.lootHistory=[],this.boredomCounter=0,this.firstName=t?t.firstNames[Math.floor(Math.random()*t.firstNames.length)]:"Testy",this.lastName=t?t.lastNames[Math.floor(Math.random()*t.lastNames.length)]:"McTest"}get challenge(){return this.challengeHistory.length===0?50:this.challengeHistory.reduce((t,s)=>t+s,0)/this.challengeHistory.length}modifySkill(e){const t=this.skill;this.skill=Math.max(0,Math.min(100,this.skill+e)),t.toFixed(1)!==this.skill.toFixed(1)&&this.logger.debug(`Skill changed from ${t.toFixed(1)} to ${this.skill.toFixed(1)}`),this.updateFlowState()}modifyChallenge(e){const t=this.challenge,s=Math.max(0,Math.min(100,e));this.challengeHistory.push(s),this.challengeHistory.length>he&&this.challengeHistory.shift(),this.logger.debug(`Challenge changed from ${t.toFixed(1)} to ${this.challenge.toFixed(1)} (new value: ${s})`),this.updateFlowState()}updateFlowState(){const e=this.flowState;this.flowState=de(this.skill,this.challenge),e!==this.flowState&&this.logger.info("info_flow_state_changed",{from:a("flow_states."+b[e]),to:a("flow_states."+b[this.flowState])})}equip(e){e.type==="item_weapon"?this.inventory.weapon=e:e.type==="item_armor"&&(this.inventory.armor=e),this.recalculateStats()}addPotion(e){e.type==="item_potion"&&this.inventory.potions.push(e)}applyBuff(e){this.activeBuffs.push(e),this.recalculateStats()}updateBuffs(){const e=this.activeBuffs.filter(t=>t.stats.duration!==void 0&&t.stats.duration<=1);this.activeBuffs=this.activeBuffs.map(t=>(t.stats.duration&&(t.stats.duration-=1),t)).filter(t=>t.stats.duration===void 0||t.stats.duration>0),e.length>0&&this.recalculateStats()}recalculateStats(){const e=this.hp/this.maxHp;let t=L.power,s=L.maxHp;this.inventory.weapon&&(t+=this.inventory.weapon.stats.power||0,s+=this.inventory.weapon.stats.maxHp||0),this.inventory.armor&&(t+=this.inventory.armor.stats.power||0,s+=this.inventory.armor.stats.maxHp||0),this.activeBuffs.forEach(i=>{t+=i.stats.power||0,s+=i.stats.maxHp||0}),this.power=t,this.maxHp=s,this.hp=Math.round(this.maxHp*e)}toJSON(){return{hp:this.hp,maxHp:this.maxHp,power:this.power,traits:this.traits,inventory:this.inventory,activeBuffs:this.activeBuffs,skill:this.skill,challengeHistory:this.challengeHistory,flowState:this.flowState,roomHistory:this.roomHistory,lootHistory:this.lootHistory,boredomCounter:this.boredomCounter,firstName:this.firstName,lastName:this.lastName}}static fromJSON(e,t){const s=e.traits,i=new T(s);return i.hp=e.hp,i.maxHp=e.maxHp,i.power=e.power,i.inventory=e.inventory,i.activeBuffs=e.activeBuffs,i.skill=e.skill,i.challengeHistory=e.challengeHistory,i.flowState=e.flowState,i.roomHistory=e.roomHistory,i.lootHistory=e.lootHistory,i.boredomCounter=e.boredomCounter,i.firstName=e.firstName,i.lastName=e.lastName,i}}const me=99,ue=10,O=10,F=32,pe=18,fe=8;var w=(n=>(n.WORKSHOP="workshop",n.ROOM_DECK_SIZE_INCREASE="room_deck_size_increase",n.HAND_SIZE_INCREASE="hand_size_increase",n.ADVENTURER_TRAITS="ADVENTURER_TRAITS",n.BP_MULTIPLIER="BP_MULTIPLIER",n.WORKSHOP_ACCESS="WORKSHOP_ACCESS",n.BP_MULTIPLIER_2="BP_MULTIPLIER_2",n))(w||{});const ee=[{feature:"workshop",runThreshold:2,title:()=>a("unlocks.workshop.title"),description:()=>a("unlocks.workshop.description")},{feature:"room_deck_size_increase",runThreshold:3,title:()=>a("unlocks.room_deck_size_increase.title"),description:()=>a("unlocks.room_deck_size_increase.description")},{feature:"hand_size_increase",runThreshold:4,title:()=>a("unlocks.hand_size_increase.title"),description:()=>a("unlocks.hand_size_increase.description")},{feature:"ADVENTURER_TRAITS",runThreshold:5,title:()=>a("unlocks.adventurer_traits.title"),description:()=>a("unlocks.adventurer_traits.description")},{feature:"BP_MULTIPLIER",runThreshold:8,title:()=>a("unlocks.bp_multiplier.title"),description:()=>a("unlocks.bp_multiplier.description")},{feature:"WORKSHOP_ACCESS",runThreshold:13,title:()=>a("unlocks.workshop_access.title"),description:()=>a("unlocks.workshop_access.description")},{feature:"BP_MULTIPLIER_2",runThreshold:21,title:()=>a("unlocks.bp_multiplier_2.title"),description:()=>a("unlocks.bp_multiplier_2.description")}],te=10;function se(n,e){var u,m,d,f;const{traits:t,inventory:s,hp:i,maxHp:o}=n;let r=(e.rarity==="uncommon"?2:e.rarity==="rare"?3:1)*5;const l=((u=s.weapon)==null?void 0:u.stats.power)||0,c=((m=s.armor)==null?void 0:m.stats.maxHp)||0;switch(e.type){case"item_weapon":const h=(e.stats.power||0)-l;if(h<=0&&e.id!==((d=s.weapon)==null?void 0:d.id))return-1;r+=h*(t.offense/10),h>0&&(r+=h*(n.skill/10));const p=e.stats.maxHp||0;p<0&&(r+=p*(100-t.resilience)/20);break;case"item_armor":const g=(e.stats.maxHp||0)-c;if(g<=0&&e.id!==((f=s.armor)==null?void 0:f.id))return-1;r+=g*(100-t.offense)/10,g>0&&(r+=g*(n.skill/10));const _=e.stats.power||0;_>0&&(r+=_*(t.offense/15));const v=e.stats.power||0;v<0&&(r+=v*(t.resilience/10));break;case"item_potion":const S=i/o;r+=10*(100-t.resilience)/100,S<.7&&(r+=20*(1-S)),r+=5*(n.skill/100),s.potions.length>=me&&(r*=.1);break}return r}function ge(n,e,t){t.debug(`--- Adventurer Loot Decision --- (Offense: ${n.traits.offense}, Resilience: ${n.traits.resilience}, Skill: ${n.skill})`);const s=e.map(r=>({item:r,score:se(n,r)})).filter(r=>r.score>0);if(s.sort((r,l)=>l.score-r.score),s.length===0||s[0].score<ue)return{choice:null,reason:a("game_engine.adventurer_declines_offer")};const i=s[0].item;t.debug(`Adventurer chooses: ${a("items_and_rooms."+i.id)} (Score: ${s[0].score.toFixed(1)})`);const o=a("game_engine.adventurer_accepts_offer",{itemName:a("items_and_rooms."+i.id)});return{choice:i,reason:o}}function _e(n,e){const{flowState:t,hp:s,maxHp:i,inventory:o,traits:r}=n,l=s/i;if(o.potions.length===0)return"attack";let c=.5;switch(t){case b.Anxiety:case b.Worry:c=.8;break;case b.Arousal:case b.Flow:c=.6;break;case b.Control:case b.Relaxation:c=.4;break;case b.Boredom:case b.Apathy:c=.2;break}return c-=r.resilience/200,l<Math.max(.1,c)?"use_potion":"attack"}function ve(n,e,t){if(e){n.lootHistory.push(e.id),n.lootHistory.filter(o=>o===e.id).length>2&&(n.modifyChallenge(n.challenge-te),n.logger.info("info_repetitive_choice",{name:a("items_and_rooms."+e.id)}));const i=se(n,e);i>60?(n.modifySkill(10),n.modifyChallenge(n.challenge+5)):i>30?(n.modifySkill(5),n.modifyChallenge(n.challenge+2)):n.modifySkill(2)}else t.length>0?n.modifyChallenge(n.challenge-5):n.modifyChallenge(n.challenge-10);n.updateFlowState()}function be(n,e){n.roomHistory.push(e.id),n.roomHistory.filter(i=>i===e.id).length>2&&(n.modifyChallenge(n.challenge-te),n.logger.info("info_deja_vu",{name:a("items_and_rooms."+e.id)}));let s=0;switch(e.type){case"room_enemy":s=5;break;case"room_boss":s=15;break;case"room_trap":s=10;break;case"room_healing":s=-15;break}n.modifyChallenge(n.challenge+s),n.updateFlowState()}function Se(n){n.modifySkill(-2),n.updateFlowState()}function P(n,e){switch(e){case"hit":n.modifySkill(.5);break;case"miss":n.modifySkill(-.5);break;case"take_damage":n.modifyChallenge(n.challenge+1);break}n.updateFlowState()}function ye(n,e,t,s){let i;return e>.7?(i=a("game_engine.too_close_for_comfort"),n.modifyChallenge(n.challenge+10),n.modifySkill(-3)):e>.4?(i=a("game_engine.great_battle"),n.modifyChallenge(n.challenge+5),n.modifySkill(5)):t>3&&n.traits.offense>60?(i=a("game_engine.easy_fight"),n.modifyChallenge(n.challenge-10)):(i=a("game_engine.worthy_challenge"),n.modifyChallenge(n.challenge-2),n.modifySkill(2)),t===s&&n.modifySkill(1*t),n.updateFlowState(),i}class we{constructor(e,t,s){this.gameState=null,this.isLoading=!0,this.error=null,this._allItems=[],this._allRooms=[],this._allNames={firstNames:[],lastNames:[]},this._listeners={},this.init=async()=>{await this._loadGameData()},this.startNewGame=i=>{this.metaManager.incrementAdventurers();const o={offense:y.nextInt(10,90),resilience:y.nextInt(10,90),skill:0},r=k.getInstance();r.loadEntries([]);const l=new T(o,this._allNames),c=(i==null?void 0:i.items)||this._allItems.filter(v=>v.cost===null).map(v=>v.id),u=U(c,this._allItems,F),m=this._getHandSize(),d=u.slice(0,m),f=u.slice(m),h=(i==null?void 0:i.rooms)||this._allRooms.filter(v=>v.cost===null).map(v=>v.id),p=j(h,this._allRooms,this._getRoomDeckSize()),g=p.slice(0,m),_=p.slice(m);r.info("info_new_adventurer",{fullName:`${l.firstName} ${l.lastName}`,id:this.metaManager.metaState.adventurers.toString()}),this.gameState={phase:"DESIGNER_CHOOSING_ROOM",designer:{balancePoints:0},adventurer:l,unlockedDeck:c,availableDeck:f,hand:d,unlockedRoomDeck:h,availableRoomDeck:_,roomHand:g,handSize:m,shopItems:[],offeredLoot:[],offeredRooms:[],feedback:a("game_engine.new_adventurer"),logger:r,run:1,room:1,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null},this.gameState.logger.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),this.gameState.logger.debug(`Deck size: ${u.length}, Hand size: ${m}, Room Deck size: ${p.length}, Room Hand size: ${g.length}`),this._emit("state-change",this.gameState)},this.continueGame=()=>{const i=this.gameSaver.load();i?(this.gameState=i,this._emit("state-change",this.gameState)):this.startNewGame()},this.startNewRun=i=>{if(!this.gameState)return;const o=i||this.gameState.run+1;this.metaManager.updateRun(o);const r=this._getHandSize(),l=U(this.gameState.unlockedDeck,this._allItems,F),c=l.slice(0,r),u=l.slice(r),m=j(this.gameState.unlockedRoomDeck,this._allRooms,this._getRoomDeckSize()),d=m.slice(0,r),f=m.slice(r),h=new T(this.gameState.adventurer.traits,this._allNames);h.skill=this.gameState.adventurer.skill,h.challengeHistory=[...this.gameState.adventurer.challengeHistory],h.flowState=this.gameState.adventurer.flowState,this.gameState.logger.info("info_adventurer_returns"),this.gameState.logger.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),this.gameState={...this.gameState,adventurer:h,phase:"DESIGNER_CHOOSING_ROOM",availableDeck:u,hand:c,availableRoomDeck:f,roomHand:d,handSize:r,room:1,run:o,feedback:a("game_engine.adventurer_returns"),runEnded:{isOver:!1,reason:"",success:!1,decision:null}},this._emit("state-change",this.gameState)},this.presentOffer=i=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_LOOT"||!this.gameState.hand)return;const o=this.gameState.hand.filter(v=>i.includes(v.instanceId));this.gameState.offeredLoot=o;const r=this.gameState.adventurer,{choice:l,reason:c}=ge(r,this.gameState.offeredLoot,this.gameState.logger);ve(r,l,this.gameState.offeredLoot),l&&this.gameState.logger.info("info_item_chosen",{name:r.firstName,item:a("items_and_rooms."+l.id)});let u=this.gameState.hand,m=this.gameState.availableDeck;u.forEach(v=>v.justDrafted=!1);let d=u.filter(v=>!i.includes(v.instanceId));const f=this.gameState.handSize-d.length,h=m.slice(0,f);h.forEach(v=>{v.draftedRoom=this.gameState.room,v.justDrafted=!0});const p=m.slice(f);d.push(...h),l&&(l.type==="item_potion"?r.addPotion(l):l.type==="item_buff"?r.applyBuff(l):r.equip(l));const g=this.gameState.room+1,_=this.gameState.designer.balancePoints+this._getBpPerRoom();this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",adventurer:r,feedback:c,availableDeck:p,hand:d,room:g,designer:{balancePoints:_}},this._emit("state-change",this.gameState)},this.runEncounter=i=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_ROOM")return;this.gameState.offeredRooms=i;let o=this.gameState.adventurer,r=[];const l=y.nextInt(0,this.gameState.offeredRooms.length-1),c=this.gameState.offeredRooms[l];switch(o.roomHistory.push(c.id),be(o,c),this.gameState.logger.info("info_encounter",{name:o.firstName,roomName:a("items_and_rooms."+c.id)}),c.type){case"room_enemy":case"room_boss":const _={enemyCount:c.units??1,enemyPower:c.stats.attack||5,enemyHp:c.stats.hp||10},v=this._simulateEncounter(o,this.gameState.room,_);o=v.newAdventurer,r=v.feedback;break;case"room_healing":const S=c.stats.hp||0;o.hp=Math.min(o.maxHp,o.hp+S),r.push(a("game_engine.healing_room",{name:a("items_and_rooms."+c.id),healing:S})),this.gameState.logger.info("info_healing_room",{name:o.firstName,healingRoomName:a("items_and_rooms."+c.id),healing:S});break;case"room_trap":const x=c.stats.attack||0;o.hp-=x,Se(o),r.push(a("game_engine.trap_room",{name:a("items_and_rooms."+c.id),damage:x})),this.gameState.logger.info("info_trap_room",{name:o.firstName,trapName:a("items_and_rooms."+c.id),damage:x});break}o.updateBuffs(),this.gameState.designer.balancePoints+=this._getBpPerRoom();let u=this.gameState.roomHand,m=this.gameState.availableRoomDeck;u.forEach(_=>_.justDrafted=!1);const d=this.gameState.offeredRooms.map(_=>_.instanceId);let f=u.filter(_=>!d.includes(_.instanceId));const h=this.gameState.handSize-f.length,p=m.slice(0,h);p.forEach(_=>{_.draftedRoom=this.gameState.room,_.justDrafted=!0});const g=m.slice(h);if(f.push(...p),this.gameState.adventurer=o,o.hp<=0){this._endRun(a("game_engine.adventurer_fell",{room:this.gameState.room,run:this.gameState.run}));return}if(o.boredomCounter>2){const _=o.flowState===b.Boredom?a("game_engine.adventurer_bored",{room:this.gameState.room,run:this.gameState.run}):a("game_engine.adventurer_apathy",{room:this.gameState.room,run:this.gameState.run});this._endRun(_);return}this.gameState.hand&&this.gameState.hand.length===0?(this.gameState.logger.warn("warn_empty_hand"),r.push(a("game_engine.empty_hand")),this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",room:this.gameState.room+1,designer:{balancePoints:this.gameState.designer.balancePoints+this._getBpPerRoom()},feedback:r,encounter:void 0,roomHand:f,availableRoomDeck:g}):this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_LOOT",feedback:r,encounter:void 0,roomHand:f,availableRoomDeck:g},this._emit("state-change",this.gameState)},this.forceEndRun=()=>{this.gameState&&(this.gameState.adventurer.modifyChallenge(-20),this.gameState.adventurer.updateFlowState(),this._endRun(a("game_engine.no_more_rooms"),!0))},this.enterWorkshop=()=>{if(!this.gameState)return;if(this.gameState.logger.info("info_entering_workshop",{name:this.gameState.adventurer.firstName}),!this.metaManager.acls.has(w.WORKSHOP)){this.gameState.logger.info("info_workshop_not_unlocked"),this.startNewRun();return}const i=this.gameState.run+1,o=this._allItems.filter(c=>c.cost!==null).filter(c=>!this.gameState.unlockedDeck.includes(c.id)),r=this._allRooms.filter(c=>c.cost!==null).filter(c=>!this.gameState.unlockedRoomDeck.includes(c.id)),l=[...o,...r];this.gameState={...this.gameState,phase:"SHOP",shopReturnPhase:this.gameState.phase,run:i,room:0,shopItems:Y(l).slice(0,4),runEnded:{isOver:!1,reason:"",success:!1,decision:null},feedback:a("game_engine.welcome_to_workshop")},this._emit("state-change",this.gameState)},this.exitWorkshop=()=>{this.gameState&&this.startNewRun()},this.purchaseItem=i=>{if(!this.gameState)return;const o=this._allItems.find(p=>p.id===i),r=this._allRooms.find(p=>p.id===i),l=o||r;if(!l||l.cost===null||this.gameState.designer.balancePoints<l.cost)return;let c=this.gameState.unlockedDeck,u=this.gameState.unlockedRoomDeck,m=this.gameState.availableDeck,d=this.gameState.availableRoomDeck;o?(c=[...this.gameState.unlockedDeck,i],this.isWorkshopAccessUnlocked()&&(m=[o,...this.gameState.availableDeck])):r&&(u=[...this.gameState.unlockedRoomDeck,i],this.isWorkshopAccessUnlocked()&&(d=[r,...this.gameState.availableRoomDeck]));const f=this.gameState.designer.balancePoints-l.cost,h=this.gameState.shopItems.filter(p=>p.id!==i);this.gameState.logger.info("info_item_purchased",{name:this.gameState.adventurer.firstName,item:a("items_and_rooms."+l.id)}),this.gameState={...this.gameState,designer:{balancePoints:f},unlockedDeck:c,unlockedRoomDeck:u,availableDeck:m,availableRoomDeck:d,shopItems:h},this._emit("state-change",this.gameState)},this.quitGame=(i=!0)=>{i&&this.gameSaver.clear(),this.showMenu()},this.showMenu=()=>{this.gameState={...this.gameState||this._getInitialGameState(),phase:"MENU"},this._emit("state-change",this.gameState)},this._getBpPerRoom=()=>this.metaManager.acls.has(w.BP_MULTIPLIER_2)?O*4:this.metaManager.acls.has(w.BP_MULTIPLIER)?O*2:O,this.saveGame=()=>{this.gameState&&this.gameState.phase!=="MENU"&&this.gameState.phase!=="RUN_OVER"&&this.gameSaver.save(this.gameState)},this.metaManager=e,this.dataLoader=t,this.gameSaver=s}on(e,t){this._listeners[e]||(this._listeners[e]=[]),this._listeners[e].push(t)}_emit(e,t){e==="state-change"&&this.saveGame();const s=this._listeners[e];s&&s.forEach(i=>i(t))}_simulateEncounter(e,t,s){var d,f,h,p,g,_,v,S,x,D,G;(d=this.gameState)==null||d.logger.debug(`--- Encounter: Room ${t} - ${s.enemyCount} enemies (Power: ${s.enemyPower}, HP: ${s.enemyHp}) ---`);const i=[];let o=0,r=0;const l=e.hp;for(let N=0;N<s.enemyCount;N++){(f=this.gameState)==null||f.logger.info("info_encounter_enemy",{name:e.firstName,current:N+1,total:s.enemyCount});let A=s.enemyHp;for(;A>0&&e.hp>0;){if(_e(e)==="use_potion"){const E=e.inventory.potions.shift();if(E){const I=E.stats.hp||0;e.hp=Math.min(e.maxHp,e.hp+I),i.push(a("game_engine.adventurer_drinks_potion",{potionName:a("items_and_rooms."+E.id)})),(h=this.gameState)==null||h.logger.info("info_adventurer_drinks_potion",{name:e.firstName,potionName:a("items_and_rooms."+E.id)})}}else{const E=Math.min(.95,.75+e.traits.skill/500+e.traits.offense/1e3);if(y.nextFloat()<E){const I=e.power;A-=I,(p=this.gameState)==null||p.logger.debug(`Adventurer hits for ${I} damage.`),P(e,"hit")}else(g=this.gameState)==null||g.logger.debug("Adventurer misses."),P(e,"miss")}if(A<=0){(_=this.gameState)==null||_.logger.info("info_enemy_defeated"),r++;break}const ie=Math.max(.4,.75-e.traits.skill/500-(100-e.traits.offense)/1e3);if(y.nextFloat()<ie){const E=(((v=e.inventory.armor)==null?void 0:v.stats.maxHp)||0)/10,I=Math.max(1,s.enemyPower-E);o+=I,e.hp-=I,(S=this.gameState)==null||S.logger.debug(`Enemy hits for ${I} damage.`),P(e,"take_damage")}else(x=this.gameState)==null||x.logger.debug("Enemy misses.")}if(e.hp<=0){(D=this.gameState)==null||D.logger.warn("info_adventurer_defeated");break}}const c=l-e.hp,u=c/e.maxHp;(G=this.gameState)==null||G.logger.debug(`hpLost: ${c}, hpLostRatio: ${u.toFixed(2)}`);const m=ye(e,u,r,s.enemyCount);return i.push(m),{newAdventurer:e,feedback:i,totalDamageTaken:o}}_endRun(e,t=!1){if(!this.gameState)return;this.metaManager.updateRun(this.gameState.run);const s=this.metaManager.checkForUnlocks(this.gameState.run);this.gameState.logger.debug(`Run ended with ${this.gameState.designer.balancePoints} BP.`),this.gameState.logger.error("info_game_over",{reason:e});const i=this._getAdventurerEndRunDecision();this.gameState={...this.gameState,phase:"RUN_OVER",runEnded:{isOver:!0,reason:e,success:t,decision:i},newlyUnlocked:s},this._emit("state-change",this.gameState)}_getAdventurerEndRunDecision(){if(!this.gameState)return"retire";const{flowState:e,traits:t,skill:s}=this.gameState.adventurer,{resilience:i,offense:o}=t,r=Math.min(s/100,1);if(e===b.Flow)return"continue";let l=.55;switch(e){case b.Anxiety:l+=.25-i/400;break;case b.Arousal:l-=.1-o/1e3;break;case b.Worry:l+=.2;break;case b.Control:l-=.15;break;case b.Relaxation:l+=.1;break;case b.Boredom:l+=.3;break;case b.Apathy:l+=.4;break}return l-=r*.1,l=Math.max(.05,Math.min(.95,l)),y.nextFloat()<l?"retire":"continue"}handleEndOfRun(e){if(this.gameState){if(this.gameState.logger.info("info_adventurer_decision",{name:this.gameState.adventurer.firstName,decision:e}),e==="retire"){this.quitGame(!0);return}this.enterWorkshop()}}_getInitialGameState(){const e={offense:y.nextInt(10,90),resilience:y.nextInt(10,90),skill:0},t=k.getInstance(),s=new T(e,this._allNames);return{phase:"MENU",designer:{balancePoints:0},adventurer:s,unlockedDeck:[],availableDeck:[],hand:[],unlockedRoomDeck:[],availableRoomDeck:[],roomHand:[],handSize:this._getHandSize(),shopItems:[],offeredLoot:[],offeredRooms:[],feedback:"",logger:t,run:0,room:0,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null}}_getHandSize(){return this.metaManager.acls.has(w.HAND_SIZE_INCREASE)?12:fe}_getRoomDeckSize(){return this.metaManager.acls.has(w.ROOM_DECK_SIZE_INCREASE)?36:pe}isWorkshopAccessUnlocked(){return this.metaManager.acls.has(w.WORKSHOP_ACCESS)}isWorkshopUnlocked(){return this.metaManager.acls.has(w.WORKSHOP)}hasSaveGame(){return this.gameSaver.hasSaveGame()}async _loadGameData(){try{this._allItems=await this.dataLoader.loadJson("game/items.json"),this._allRooms=await this.dataLoader.loadJson("game/rooms.json"),this._allNames=await this.dataLoader.loadJson("game/names.json")}catch(e){this.error=e.message||a("global.unknown_error"),this._emit("error",null)}finally{this.isLoading=!1,this._emit("state-change",this.gameState)}}}class H{constructor(e,t,s,i){this.resolve=i;const o=document.createElement("div");o.dataset.testid="info-modal-overlay",Object.assign(o.style,{position:"fixed",top:"0",left:"0",right:"0",bottom:"0",backgroundColor:"rgba(0, 0, 0, 0.4)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:"1000"}),o.addEventListener("click",g=>{if(g.target===o){const _=s.find(v=>typeof v.value=="boolean"&&v.value===!1);_&&this.dismiss(_.value)}});const r=document.createElement("div");this.element=r,r.className="window",r.style.width="min(90vw, 800px)",r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true"),r.setAttribute("aria-labelledby","info-modal-title");const l=document.createElement("div");l.className="title-bar";const c=document.createElement("div");c.id="info-modal-title",c.className="title-bar-text",c.textContent=e,l.appendChild(c),r.appendChild(l);const u=document.createElement("div");u.className="window-body text-center p-4";const m=document.createElement("div");m.innerHTML=t,u.appendChild(m);const d=document.createElement("div");d.className="flex justify-center gap-2 mt-4",s.forEach(g=>{const _=document.createElement("button");_.textContent=g.text,_.addEventListener("click",()=>{this.dismiss(g.value)}),d.appendChild(_)}),u.appendChild(d),r.appendChild(u),o.appendChild(r),document.body.appendChild(o),this.handleKeydown=g=>{if(g.key==="Escape"){const _=s.find(v=>typeof v.value=="boolean"&&v.value===!1);_&&this.dismiss(_.value)}},document.addEventListener("keydown",this.handleKeydown);const f=r.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'),h=f[0],p=f[f.length-1];h==null||h.focus(),r.addEventListener("keydown",g=>{g.key==="Tab"&&(g.shiftKey?document.activeElement===h&&(p.focus(),g.preventDefault()):document.activeElement===p&&(h.focus(),g.preventDefault()))})}dismiss(e){this.element.parentElement.remove(),document.removeEventListener("keydown",this.handleKeydown),this.resolve(e)}static show(e,t,s){return new Promise(i=>{new H(e,t,s,i)})}static showInfo(e,t,s=a("global.continue")){const i=[{text:s,value:void 0}];return H.show(e,t,i)}}class z{static show(e,t){const s=[{text:a("global.cancel"),value:!1,variant:"secondary"},{text:a("global.confirm"),value:!0,variant:"primary"}];return H.show(e,t,s)}}const ke=`<div class="w-full p-4 md:p-6 lg:p-8">
  <div class="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-6">
    ...
    <div class="lg:col-span-5">
      <div class="window">
        ...
        <div id="game-phase-panel" class="window-body"></div>
                ...
                <div class="flex-grow space-y-2">
                    <div data-tooltip-key="adventurer_health">
                        <div class="flex justify-between items-center">
                            <div class="flex items-center">${Me()} <span>${a("global.health")}</span></div>
            ...
            <fieldset id="traits-section" class="${t?"":"hidden"} mt-2">
    ...
    `;const e=this.querySelector("#item-cards");if(e){e.innerHTML="";for(const t of this._items){const s=document.createElement("choice-card");s.item=t,s.purchaseInfo={cost:t.cost||0,canAfford:this._balancePoints>=(t.cost||0)},e.appendChild(s)}}}}customElements.define("workshop-screen",Ke);class Ze extends HTMLElement{constructor(){super(),this.engine=null,this.metaManager=null,this.addEventListener("click",async e=>{if(!this.engine||!this.metaManager)return;const t=e.target;t.id==="new-game-button"?(this.metaManager.metaState.adventurers>0||this.metaManager.metaState.highestRun>0,this.engine.hasSaveGame()?await z.show(a("menu.new_game"),a("menu.new_game_confirm"))&&this.engine.startNewGame():this.engine.startNewGame()):t.id==="continue-game-button"?this.engine.continueGame():t.id==="reset-game-button"&&await z.show(a("menu.reset_save"),a("menu.reset_save_confirm"))&&(this.metaManager.reset(),this.engine.quitGame(!0),this.render())})}connectedCallback(){this.render()}render(){if(!this.metaManager||!this.engine)return;const e=this.metaManager.metaState,t=this.engine.hasSaveGame();let s="";if(t){const i=e.adventurers||0;s=`
      ...
      <div class="window" style="width: 400px;">
        ...
        <div class="status-bar">
          ...
          <p class="status-bar-field">build 126</p>
        </div>
      </div>
    `}}customElements.define("menu-screen",Ze);class Je extends HTMLElement{constructor(){super(),this.isDesktop=!0,this.attachShadow({mode:"open"}),this.onclick=t=>{window.matchMedia("(pointer: coarse)").matches&&t.target===this&&this.hide()};const e=document.createElement("style");e.textContent=`
        ...
        `,this.contentContainer=document.createElement("div"),this.contentContainer.className="content-container",this.titleElement=document.createElement("h3"),this.bodyElement=document.createElement("div"),this.contentContainer.appendChild(this.titleElement),this.contentContainer.appendChild(this.bodyElement),this.shadowRoot.appendChild(e),this.shadowRoot.appendChild(this.contentContainer)}show(e,t,s){this.titleElement.textContent=e.title,this.bodyElement.innerHTML=e.body,this.isDesktop=!window.matchMedia("(pointer: coarse)").matches,this.classList.add("show")}hide(){this.classList.remove("show")}}customElements.define("tooltip-box",Je);class R{constructor(){this.showTimeout=null,this.hideTimeout=null,this.desktopTooltipActive=!1,this.tooltipBox=document.createElement("tooltip-box"),document.body.appendChild(this.tooltipBox)}static getInstance(){return R.instance||(R.instance=new R),R.instance}handleMouseEnter(e){if(this.isTouchDevice())return;const t=e.target,s=this.findTooltipKey(t);this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=null),s&&this.activeToolipKey!==s&&(this.showTimeout=window.setTimeout(()=>{t.addEventListener("mouseleave",this.handleMouseLeave.bind(this),{once:!0}),this.activeToolipKey=s;const i=this.getTooltipContent(s);i&&(this.tooltipBox.show(i,e.clientX,e.clientY),this.desktopTooltipActive=!0)},300))}handleMouseLeave(){this.isTouchDevice()||(this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=null),this.tooltipBox.hide(),this.activeToolipKey="",this.desktopTooltipActive=!1)}handleClick(e){const t=e.target;if(t.classList.contains("tooltip-icon")){const s=this.findTooltipKey(t.parentElement);if(s){const i=this.getTooltipContent(s);i&&this.tooltipBox.show(i,0,0)}}}isTouchDevice(){return"ontouchstart"in window||navigator.maxTouchPoints>0}findTooltipKey(e){return e?e.getAttribute("data-tooltip-key")||this.findTooltipKey(e.parentElement):null}getTooltipContent(e){const t=a(`tooltips.${e}.body`);if(t.includes("tooltips."))return null;let s=a(`tooltips.${e}.title`);return s.includes("tooltips.")&&(s=a("global.information")),{title:s,body:t}}}const Z=R.getInstance(),C=document.getElementById("app");if(!C)throw new Error("Could not find app element to mount to");async function Ve(){C.innerHTML="<div>Initializing...</div>";const n=new Le;await ae(n);const e=new He,t=new Re(e),s=new Te(e),i=new we(t,n,s);i.on("state-change",o=>{if(i.isLoading){C.innerHTML=`<div>${a("global.loading_game_data")}</div>`;return}if(i.error){C.innerHTML=`
            ...
            `;return}Ce(C,o,i),$e()}),C.innerHTML=`<div>${a("global.initializing")}</div>`,document.body.addEventListener("mouseover",o=>Z.handleMouseEnter(o)),document.body.addEventListener("click",o=>Z.handleClick(o)),await i.init(),i.showMenu()}Ve().catch(n=>{console.error(n),C&&(C.innerHTML=`
      <div class="min-h-screen flex items-center justify-center p-4">
          <div class="bg-brand-surface p-8 rounded-xl shadow-2xl text-center border border-brand-secondary">
