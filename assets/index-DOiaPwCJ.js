(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();const le="modulepreload",ce=function(o){return"/hypercubicle/"+o},K={},de=function(e,t,n){let s=Promise.resolve();if(t&&t.length>0){let i=function(c){return Promise.all(c.map(u=>Promise.resolve(u).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),d=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=i(t.map(c=>{if(c=ce(c),c in K)return;K[c]=!0;const u=c.endsWith(".css"),h=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${h}`))return;const f=document.createElement("link");if(f.rel=u?"stylesheet":le,u||(f.as="script"),f.crossOrigin="",f.href=c,d&&f.setAttribute("nonce",d),document.head.appendChild(f),u)return new Promise((m,g)=>{f.addEventListener("load",m),f.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${c}`)))})}))}function a(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return s.then(i=>{for(const l of i||[])l.status==="rejected"&&a(l.reason);return e().catch(a)})};var v=(o=>(o.Arousal="arousal",o.Flow="flow",o.Control="control",o.Relaxation="relaxation",o.Boredom="boredom",o.Apathy="apathy",o.Worry="worry",o.Anxiety="anxiety",o))(v||{});let X={};async function Q(o,e){try{X=await e.loadJson(`locales/${o}.json`)}catch(t){console.warn(`Failed to load ${o} translations:`,t),o!=="en"&&await Q("en",e)}}function he(){return typeof navigator<"u"&&navigator.language?navigator.language.split("-")[0]:"en"}function r(o,e={}){let n=o.split(".").reduce((s,a)=>s?s[a]:void 0,X);if(!n)return console.warn(`Translation not found for key: ${o}`),o;for(const s in e)n=n.replace(`{${s}}`,String(e[s]));return n}async function ue(o){const e=he();await Q(e,o)}class E{constructor(){this.entries=[],this.listeners=[],this.muted=!1}static getInstance(){return E.instance||(E.instance=new E),E.instance}on(e){this.listeners.push(e)}log(e,t="INFO",n){const s=r(`log_messages.${e}`,n),a={message:s,level:t,timestamp:Date.now(),data:n};this.muted||(this.entries.push(a),t!=="DEBUG"&&console.log(`[${t}] ${s}`)),this.listeners.forEach(i=>i(a))}debug(e){const t={message:e,level:"DEBUG",timestamp:Date.now()};this.muted||this.entries.push(t),this.listeners.forEach(n=>n(t))}metric(e){const t={message:"metric",level:"DEBUG",timestamp:Date.now(),data:e};this.listeners.forEach(n=>n(t))}info(e,t){this.log(e,"INFO",t)}warn(e,t){this.log(e,"WARN",t)}error(e,t){this.log(e,"ERROR",t)}toJSON(){return{entries:this.entries}}loadEntries(e){this.entries=e||[]}static fromJSON(e){const t=E.getInstance();return t.loadEntries(e.entries),t}}class me{constructor(e){this.seed=e}setSeed(e){this.seed=e}nextFloat(){let e=this.seed+=1831565813;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}nextInt(e,t){return Math.floor(this.nextFloat()*(t-e+1))+e}}const x=new me(Date.now()),ee=o=>`${o}_${x.nextFloat().toString(36).substr(2,9)}`,fe=(o,e)=>x.nextInt(o,e),te=o=>{const e=[...o];for(let t=e.length-1;t>0;t--){const n=x.nextInt(0,t);[e[t],e[n]]=[e[n],e[t]]}return e},se=(o,e,t,n)=>{const s=e.filter(h=>o.includes(h.id)),a=[],i={common:.6,uncommon:.3,rare:.1,legendary:0},l={common:0,uncommon:0,rare:0,legendary:0},d={common:0,uncommon:0,rare:0,legendary:0};Object.keys(i).forEach(h=>{d[h]=Math.floor(t*i[h])});let c=Object.values(d).reduce((h,f)=>h+f,0);for(;c<t;)d.common+=1,c+=1;s.filter(h=>h.cost!==null).forEach(h=>{a.push(n(h)),l[h.rarity]+=1}),Object.keys(i).forEach((h,f)=>{const m=s.filter(g=>g.rarity===h);for(;l[h]<d[h]&&m.length!==0;){const g=x.nextInt(0,m.length-1),p=m[g];a.push(n(p)),l[h]+=1}});const u=s.filter(h=>h.rarity==="common");for(;a.length<t&&u.length>0;){const h=x.nextInt(0,u.length-1),f=u[h];a.push(n(f))}return te(a)},W=(o,e,t)=>se(o,e,t,n=>({...n,instanceId:ee(n.id)})),V=(o,e,t)=>se(o,e,t,s=>{const a={...s,instanceId:ee(s.id)};return a.type==="room_enemy"&&a.stats.minUnits&&a.stats.maxUnits&&(a.units=fe(a.stats.minUnits,a.stats.maxUnits)),a}),pe=o=>o.roomHand.length<3&&!o.roomHand.some(e=>e.type==="room_boss"),ge=o=>[...new Set(o.hand.map(t=>t.id))].length<2&&o.hand.length>0;function ne(o,e){const t=Math.max(0,Math.min(100,o)),n=Math.max(0,Math.min(100,e));return n>66?t<33?v.Anxiety:t<87?v.Arousal:v.Flow:n>33?t<33?v.Worry:t<67?v.Apathy:v.Control:t<67?v.Boredom:v.Relaxation}const M={hp:100,maxHp:100,power:5},_e=3;class I{constructor(e,t){this.hp=M.hp,this.maxHp=M.maxHp,this.power=M.power,this.skill=e.skill,this.challengeHistory=[50],this.flowState=v.Boredom,this.traits=e,this.inventory={weapon:null,armor:null,potions:[]},this.activeBuffs=[],this.logger=E.getInstance(),this.roomHistory=[],this.lootHistory=[],this.boredomCounter=0,this.firstName=t?t.firstNames[Math.floor(Math.random()*t.firstNames.length)]:"Testy",this.lastName=t?t.lastNames[Math.floor(Math.random()*t.lastNames.length)]:"McTest"}get challenge(){return this.challengeHistory.length===0?50:this.challengeHistory.reduce((t,n)=>t+n,0)/this.challengeHistory.length}modifySkill(e){const t=this.skill;this.skill=Math.max(0,Math.min(100,this.skill+e)),t.toFixed(1)!==this.skill.toFixed(1)&&this.logger.debug(`Skill changed from ${t.toFixed(1)} to ${this.skill.toFixed(1)}`),this.updateFlowState()}modifyChallenge(e){const t=this.challenge,n=Math.max(0,Math.min(100,e));this.challengeHistory.push(n),this.challengeHistory.length>_e&&this.challengeHistory.shift(),this.logger.debug(`Challenge changed from ${t.toFixed(1)} to ${this.challenge.toFixed(1)} (new value: ${n})`),this.updateFlowState()}updateFlowState(){const e=this.flowState;this.flowState=ne(this.skill,this.challenge),e!==this.flowState&&this.logger.info("info_flow_state_changed",{name:this.firstName,from:r("flow_states."+e),to:r("flow_states."+this.flowState)})}equip(e){e.type==="item_weapon"?this.inventory.weapon=e:e.type==="item_armor"&&(this.inventory.armor=e),this.recalculateStats()}addPotion(e){e.type==="item_potion"&&this.inventory.potions.push(e)}applyBuff(e){this.activeBuffs.push(e),this.recalculateStats()}updateBuffs(){const e=this.activeBuffs.filter(t=>t.stats.duration!==void 0&&t.stats.duration<=1);this.activeBuffs=this.activeBuffs.map(t=>(t.stats.duration&&(t.stats.duration-=1),t)).filter(t=>t.stats.duration===void 0||t.stats.duration>0),e.length>0&&this.recalculateStats()}recalculateStats(){const e=this.hp/this.maxHp;let t=M.power,n=M.maxHp;this.inventory.weapon&&(t+=this.inventory.weapon.stats.power||0,n+=this.inventory.weapon.stats.maxHp||0),this.inventory.armor&&(t+=this.inventory.armor.stats.power||0,n+=this.inventory.armor.stats.maxHp||0),this.activeBuffs.forEach(s=>{t+=s.stats.power||0,n+=s.stats.maxHp||0}),this.power=t,this.maxHp=n,this.hp=Math.round(this.maxHp*e)}toJSON(){return{hp:this.hp,maxHp:this.maxHp,power:this.power,traits:this.traits,inventory:this.inventory,activeBuffs:this.activeBuffs,skill:this.skill,challengeHistory:this.challengeHistory,flowState:this.flowState,roomHistory:this.roomHistory,lootHistory:this.lootHistory,boredomCounter:this.boredomCounter,firstName:this.firstName,lastName:this.lastName}}static fromJSON(e){const t=e.traits,n=new I(t);return n.hp=e.hp,n.maxHp=e.maxHp,n.power=e.power,n.inventory=e.inventory,n.activeBuffs=e.activeBuffs,n.skill=e.skill,n.challengeHistory=e.challengeHistory,n.flowState=e.flowState,n.roomHistory=e.roomHistory,n.lootHistory=e.lootHistory,n.boredomCounter=e.boredomCounter,n.firstName=e.firstName,n.lastName=e.lastName,n}}class H{constructor(e){this._path=["start"],this._linkLabels={},this._nodes={id:"start",label:e,children:[]},this._currentNode=this._nodes}addRoomSelection(e,t,n){e.forEach(s=>{this._currentNode.children.push({id:s.instanceId,label:`Floor ${this._path.length}: ${r("items_and_rooms."+s.id)}`,children:[]})}),this._currentNode=this._currentNode.children.find(s=>s.id===t.instanceId),this._path.push(t.instanceId),this._linkLabels[t.instanceId]=r(`flow_states.${n}`)}setRetirementNode(){this._currentNode.isRetirementNode=!0}generateChartData(){return{nodes:this._nodes,path:this._path,linkLabels:this._linkLabels}}toJSON(){return{nodes:this._nodes,path:this._path,linkLabels:this._linkLabels,currentNodePath:this._getNodePath(this._nodes,this._currentNode)}}_getNodePath(e,t){const n=[];function s(a){if(a.id===t.id)return n.push(a.id),!0;for(const i of a.children)if(s(i))return n.push(a.id),!0;return!1}return s(e),n.reverse()}static fromJSON(e){const t=new H("");t._nodes=e.nodes,t._path=e.path,t._linkLabels=e.linkLabels;let n=t._nodes;for(let s=1;s<e.currentNodePath.length;s++)n=n.children.find(a=>a.id===e.currentNodePath[s]);return t._currentNode=n,t}}const ve=99,ye=10,B=10,Z=32,be=18,we=8;var C=(o=>(o.WORKSHOP="workshop",o.ROOM_DECK_SIZE_INCREASE="room_deck_size_increase",o.HAND_SIZE_INCREASE="hand_size_increase",o.ADVENTURER_TRAITS="ADVENTURER_TRAITS",o.BP_MULTIPLIER="BP_MULTIPLIER",o.WORKSHOP_ACCESS="WORKSHOP_ACCESS",o.BP_MULTIPLIER_2="BP_MULTIPLIER_2",o))(C||{});const ie=[{feature:"workshop",runThreshold:2,title:()=>r("unlocks.workshop.title"),description:()=>r("unlocks.workshop.description")},{feature:"room_deck_size_increase",runThreshold:3,title:()=>r("unlocks.room_deck_size_increase.title"),description:()=>r("unlocks.room_deck_size_increase.description")},{feature:"hand_size_increase",runThreshold:4,title:()=>r("unlocks.hand_size_increase.title"),description:()=>r("unlocks.hand_size_increase.description")},{feature:"ADVENTURER_TRAITS",runThreshold:5,title:()=>r("unlocks.adventurer_traits.title"),description:()=>r("unlocks.adventurer_traits.description")},{feature:"BP_MULTIPLIER",runThreshold:8,title:()=>r("unlocks.bp_multiplier.title"),description:()=>r("unlocks.bp_multiplier.description")},{feature:"WORKSHOP_ACCESS",runThreshold:13,title:()=>r("unlocks.workshop_access.title"),description:()=>r("unlocks.workshop_access.description")},{feature:"BP_MULTIPLIER_2",runThreshold:21,title:()=>r("unlocks.bp_multiplier_2.title"),description:()=>r("unlocks.bp_multiplier_2.description")}],ae=10;function oe(o,e){var c,u,h,f;const{traits:t,inventory:n,hp:s,maxHp:a}=o;let i=(e.rarity==="uncommon"?2:e.rarity==="rare"?3:1)*5;const l=((c=n.weapon)==null?void 0:c.stats.power)||0,d=((u=n.armor)==null?void 0:u.stats.maxHp)||0;switch(e.type){case"item_weapon":const m=(e.stats.power||0)-l;if(m<=0&&e.id!==((h=n.weapon)==null?void 0:h.id))return-1;i+=m*(t.offense/10),m>0&&(i+=m*(o.skill/10));const g=e.stats.maxHp||0;g<0&&(i+=g*(100-t.resilience)/20);break;case"item_armor":const p=(e.stats.maxHp||0)-d;if(p<=0&&e.id!==((f=n.armor)==null?void 0:f.id))return-1;i+=p*(100-t.offense)/10,p>0&&(i+=p*(o.skill/10));const y=e.stats.power||0;y>0&&(i+=y*(t.offense/15));const b=e.stats.power||0;b<0&&(i+=b*(t.resilience/10));break;case"item_potion":const w=s/a;i+=10*(100-t.resilience)/100,w<.7&&(i+=20*(1-w)),i+=5*(o.skill/100),n.potions.length>=ve&&(i*=.1);break}return i}function Se(o,e,t){t.debug(`--- Adventurer Loot Decision --- (Offense: ${o.traits.offense}, Resilience: ${o.traits.resilience}, Skill: ${o.skill})`);const n=e.map(a=>({item:a,score:oe(o,a)})).filter(a=>a.score>0);if(n.sort((a,i)=>i.score-a.score),n.length===0||n[0].score<ye)return null;const s=n[0].item;return t.debug(`Adventurer chooses: ${r("items_and_rooms."+s.id)} (Score: ${n[0].score.toFixed(1)})`),s}function xe(o,e){const{flowState:t,hp:n,maxHp:s,inventory:a,traits:i}=o,l=n/s;if(a.potions.length===0)return"attack";let d=.5;switch(t){case v.Anxiety:case v.Worry:d=.8;break;case v.Arousal:case v.Flow:d=.6;break;case v.Control:case v.Relaxation:d=.4;break;case v.Boredom:case v.Apathy:d=.2;break}return d-=i.resilience/200,l<Math.max(.1,d)?"use_potion":"attack"}function ke(o,e,t){if(e){o.lootHistory.push(e.id),o.lootHistory.filter(a=>a===e.id).length>2&&(o.modifyChallenge(o.challenge-ae),o.logger.info("info_repetitive_choice",{name:r("items_and_rooms."+e.id)}));const s=oe(o,e);s>60?(o.modifySkill(10),o.modifyChallenge(o.challenge+5)):s>30?(o.modifySkill(5),o.modifyChallenge(o.challenge+2)):o.modifySkill(2)}else t.length>0?o.modifyChallenge(o.challenge-5):o.modifyChallenge(o.challenge-10);o.updateFlowState()}function Ee(o,e){o.roomHistory.push(e.id),o.roomHistory.filter(s=>s===e.id).length>2&&(o.modifyChallenge(o.challenge-ae),o.logger.info("info_deja_vu",{name:r("items_and_rooms."+e.id)}));let n=0;switch(e.type){case"room_enemy":n=5;break;case"room_boss":n=15;break;case"room_trap":n=10;break;case"room_healing":n=-15;break}o.modifyChallenge(o.challenge+n),o.updateFlowState()}function Ce(o){o.modifySkill(-2),o.updateFlowState()}function G(o,e){switch(e){case"hit":o.modifySkill(.5);break;case"miss":o.modifySkill(-.5);break;case"take_damage":o.modifyChallenge(o.challenge+1);break}o.updateFlowState()}function Ie(o,e,t,n){let s;return e>.7?(s=r("game_engine.too_close_for_comfort"),o.modifyChallenge(o.challenge+10),o.modifySkill(-3)):e>.4?(s=r("game_engine.great_battle"),o.modifyChallenge(o.challenge+5),o.modifySkill(5)):t>3&&o.traits.offense>60?(s=r("game_engine.easy_fight"),o.modifyChallenge(o.challenge-10)):(s=r("game_engine.worthy_challenge"),o.modifyChallenge(o.challenge-2),o.modifySkill(2)),t===n&&o.modifySkill(1*t),o.updateFlowState(),s}const _=E.getInstance();class $e{constructor(e,t,n){this.gameState=null,this.isLoading=!0,this.error=null,this._allItems=[],this._allRooms=[],this._allNames={firstNames:[],lastNames:[]},this._listeners={},this.init=async()=>{await this._loadGameData()},this.startNewGame=s=>{this.metaManager.incrementAdventurers();const a={offense:x.nextInt(10,90),resilience:x.nextInt(10,90),skill:0};_.loadEntries([]);const i=new I(a,this._allNames);this.dungeonHistory=new H(i.fullName);const l=(s==null?void 0:s.items)||this._allItems.filter(y=>y.cost===null).map(y=>y.id),d=W(l,this._allItems,Z),c=this._getHandSize(),u=d.slice(0,c),h=d.slice(c),f=(s==null?void 0:s.rooms)||this._allRooms.filter(y=>y.cost===null).map(y=>y.id),m=V(f,this._allRooms,this._getRoomDeckSize()),g=m.slice(0,c),p=m.slice(c);this.gameState={phase:"DESIGNER_CHOOSING_ROOM",designer:{balancePoints:0},adventurer:i,unlockedDeck:l,availableDeck:h,hand:u,unlockedRoomDeck:f,availableRoomDeck:p,roomHand:g,handSize:c,shopItems:[],offeredLoot:[],offeredRooms:[],run:1,room:1,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null},_.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),_.debug(`Deck size: ${d.length}, Hand size: ${c}, Room Deck size: ${m.length}, Room Hand size: ${g.length}`),_.info("info_designer_choosing_room",{name:i.firstName}),this._emit("state-change",this.gameState)},this.continueGame=()=>{const s=this.gameSaver.load();if(s){const[a,i]=s;this.gameState=a,i&&(this.dungeonHistory=i),this._emit("state-change",this.gameState),this.gameState.phase==="AWAITING_ENCOUNTER_RESULT"&&this.gameState.encounterPayload&&this._emit("show-encounter",this.gameState.encounterPayload)}else this.startNewGame()},this.startNewRun=s=>{if(!this.gameState)return;const a=s||this.gameState.run+1;this.metaManager.updateRun(a);const i=this._getHandSize(),l=W(this.gameState.unlockedDeck,this._allItems,Z),d=l.slice(0,i),c=l.slice(i),u=V(this.gameState.unlockedRoomDeck,this._allRooms,this._getRoomDeckSize()),h=u.slice(0,i),f=u.slice(i),m=new I(this.gameState.adventurer.traits,this._allNames);m.skill=this.gameState.adventurer.skill,m.challengeHistory=[...this.gameState.adventurer.challengeHistory],m.flowState=this.gameState.adventurer.flowState,m.firstName=this.gameState.adventurer.firstName,m.lastName=this.gameState.adventurer.lastName,this.dungeonHistory=new H(m.fullName),_.info("info_adventurer_returns",{name:m.firstName}),_.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),this.gameState={...this.gameState,adventurer:m,phase:"DESIGNER_CHOOSING_ROOM",availableDeck:c,hand:d,availableRoomDeck:f,roomHand:h,handSize:i,room:1,run:a,runEnded:{isOver:!1,reason:"",success:!1,decision:null}},_.info("info_designer_choosing_room",{name:m.firstName}),this._emit("state-change",this.gameState)},this.presentOffer=s=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_LOOT"||!this.gameState.hand)return;const a=this.gameState.hand.filter(w=>s.includes(w.instanceId));this.gameState.offeredLoot=a;const i=this.gameState.adventurer,l=Se(i,this.gameState.offeredLoot,_),d=this.gameState.offeredLoot.map(w=>r("items_and_rooms."+w.id)).join(", ");_.info("info_loot_chosen",{name:i.firstName,items:d});const c=i.flowState;ke(i,l,this.gameState.offeredLoot),c!==i.flowState&&_.metric({event:"flow_state_changed",flowState:i.flowState}),l?(_.info("info_item_chosen",{name:i.firstName,item:r("items_and_rooms."+l.id)}),_.metric({event:"item_chosen",item:l})):_.info("info_loot_declined",{name:i.firstName});let u=this.gameState.hand,h=this.gameState.availableDeck;u.forEach(w=>w.justDrafted=!1);let f=u.filter(w=>!s.includes(w.instanceId));const m=this.gameState.handSize-f.length,g=h.slice(0,m);g.forEach(w=>{w.draftedRoom=this.gameState.room,w.justDrafted=!0});const p=h.slice(m);f.push(...g),l&&(l.type==="item_potion"?i.addPotion(l):l.type==="item_buff"?i.applyBuff(l):i.equip(l));const y=this.gameState.room+1,b=this.gameState.designer.balancePoints+this._getBpPerRoom();this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",adventurer:i,availableDeck:p,hand:f,room:y,designer:{balancePoints:b}},_.info("info_designer_choosing_room",{name:i.firstName}),this._emit("state-change",this.gameState)},this.runEncounter=s=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_ROOM")return;this.gameState.offeredRooms=s;const a=x.nextInt(0,this.gameState.offeredRooms.length-1),i=this.gameState.offeredRooms[a];if(this.dungeonHistory.addRoomSelection(s,i,this.gameState.adventurer.flowState),this.gameState.offeredRooms.length===1&&i.type==="room_boss")_.info("info_boss_room_chosen",{name:this.gameState.adventurer.firstName,chosenRoom:r("items_and_rooms."+i.id)});else{const u=this.gameState.offeredRooms.map(h=>r("items_and_rooms."+h.id)).join(", ");_.info("info_room_chosen",{name:this.gameState.adventurer.firstName,rooms:u})}_.metric({event:"room_encountered",room:i});const{log:l,finalAdventurer:d}=this._generateEncounterLog(this.gameState.adventurer,i),c={room:i,log:l,finalAdventurer:d};this.gameState={...this.gameState,phase:"AWAITING_ENCOUNTER_RESULT",encounterPayload:c},this._emit("state-change",this.gameState),this._emit("show-encounter",c)},this.continueEncounter=()=>{!this.gameState||this.gameState.phase!=="AWAITING_ENCOUNTER_RESULT"||this._postEncounterUpdate()},this._postEncounterUpdate=()=>{if(!this.gameState)return;const s=I.fromJSON(this.gameState.encounterPayload.finalAdventurer);s.updateBuffs(),this.gameState.designer.balancePoints+=this._getBpPerRoom();let a=this.gameState.roomHand,i=this.gameState.availableRoomDeck;a.forEach(f=>f.justDrafted=!1);const l=this.gameState.offeredRooms.map(f=>f.instanceId);let d=a.filter(f=>!l.includes(f.instanceId));const c=this.gameState.handSize-d.length,u=i.slice(0,c);u.forEach(f=>{f.draftedRoom=this.gameState.room,f.justDrafted=!0});const h=i.slice(c);if(d.push(...u),this.gameState.adventurer=s,s.hp<=0){this._endRun(r("game_engine.adventurer_fell",{room:this.gameState.room,run:this.gameState.run}));return}if(s.boredomCounter>2){const f=s.flowState===v.Boredom?r("game_engine.adventurer_bored",{room:this.gameState.room,run:this.gameState.run}):r("game_engine.adventurer_apathy",{room:this.gameState.room,run:this.gameState.run});this._endRun(f);return}this.gameState.hand&&this.gameState.hand.length===0?(_.warn("warn_empty_hand",{name:s.firstName}),this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",room:this.gameState.room+1,designer:{balancePoints:this.gameState.designer.balancePoints+this._getBpPerRoom()},encounterPayload:void 0,roomHand:d,availableRoomDeck:h},_.info("info_designer_choosing_room",{name:s.firstName})):(this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_LOOT",encounterPayload:void 0,roomHand:d,availableRoomDeck:h},_.info("info_designer_choosing_loot",{name:s.firstName})),this._emit("state-change",this.gameState)},this.forceEndRun=()=>{this.gameState&&(this.gameState.adventurer.modifyChallenge(-20),this.gameState.adventurer.updateFlowState(),this._endRun(r("game_engine.no_more_rooms"),!0))},this.enterWorkshop=()=>{if(!this.gameState)return;if(!this.metaManager.acls.has(C.WORKSHOP)){_.debug("Workshop not unlocked, starting new run directly."),this.startNewRun();return}_.info("info_entering_workshop",{name:this.gameState.adventurer.firstName});const s=this.gameState.run+1,a=this._allItems.filter(d=>d.cost!==null).filter(d=>!this.gameState.unlockedDeck.includes(d.id)),i=this._allRooms.filter(d=>d.cost!==null).filter(d=>!this.gameState.unlockedRoomDeck.includes(d.id)),l=[...a,...i];this.gameState={...this.gameState,phase:"SHOP",shopReturnPhase:this.gameState.phase,run:s,room:0,shopItems:te(l).slice(0,4),runEnded:{isOver:!1,reason:"",success:!1,decision:null}},_.info("info_welcome_to_workshop"),this._emit("state-change",this.gameState)},this.exitWorkshop=()=>{this.gameState&&this.startNewRun()},this.purchaseItem=s=>{if(!this.gameState)return;const a=this._allItems.find(g=>g.id===s),i=this._allRooms.find(g=>g.id===s),l=a||i;if(!l||l.cost===null||this.gameState.designer.balancePoints<l.cost)return;let d=this.gameState.unlockedDeck,c=this.gameState.unlockedRoomDeck,u=this.gameState.availableDeck,h=this.gameState.availableRoomDeck;a?(d=[...this.gameState.unlockedDeck,s],this.isWorkshopAccessUnlocked()&&(u=[a,...this.gameState.availableDeck])):i&&(c=[...this.gameState.unlockedRoomDeck,s],this.isWorkshopAccessUnlocked()&&(h=[i,...this.gameState.availableRoomDeck]));const f=this.gameState.designer.balancePoints-l.cost,m=this.gameState.shopItems.filter(g=>g.id!==s);_.info("info_item_purchased",{name:this.gameState.adventurer.firstName,item:r("items_and_rooms."+l.id)}),_.metric({event:"item_purchased",item:l}),this.gameState={...this.gameState,designer:{balancePoints:f},unlockedDeck:d,unlockedRoomDeck:c,availableDeck:u,availableRoomDeck:h,shopItems:m},this._emit("state-change",this.gameState)},this.quitGame=(s=!0)=>{s&&this.gameSaver.clear(),this.showMenu()},this.showMenu=()=>{this.gameState={...this.gameState||this._getInitialGameState(),phase:"MENU"},this._emit("state-change",this.gameState)},this._getBpPerRoom=()=>this.metaManager.acls.has(C.BP_MULTIPLIER_2)?B*4:this.metaManager.acls.has(C.BP_MULTIPLIER)?B*2:B,this.saveGame=()=>{this.gameState&&this.gameState.phase!=="MENU"&&this.gameState.phase!=="RUN_OVER"&&this.gameSaver.save({...this.gameState,dungeonHistory:this.dungeonHistory})},this.metaManager=e,this.dataLoader=t,this.gameSaver=n,this.dungeonHistory=new H("")}on(e,t){this._listeners[e]||(this._listeners[e]=[]),this._listeners[e].push(t)}_emit(e,...t){e==="state-change"&&this.saveGame();const n=this._listeners[e];n&&n.forEach(s=>s(...t))}_createAdventurerSnapshot(e){return{firstName:e.firstName,lastName:e.lastName,hp:e.hp,maxHp:e.maxHp,power:e.power,flowState:e.flowState,inventory:JSON.parse(JSON.stringify(e.inventory))}}_generateEncounterLog(e,t){var i;const n=[],s=I.fromJSON(e.toJSON());_.info("info_encounter",{name:s.firstName,roomName:r("items_and_rooms."+t.id)});const a=s.flowState;switch(Ee(s,t),a!==s.flowState&&_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_encounter",replacements:{name:s.firstName,roomName:r("items_and_rooms."+t.id)},adventurer:this._createAdventurerSnapshot(s)}),t.type){case"room_enemy":case"room_boss":{const l={enemyCount:t.units??1,enemyPower:t.stats.attack||5,enemyHp:t.stats.hp||10};let d=0;const c=s.hp;for(let g=0;g<l.enemyCount;g++){let p=l.enemyHp;_.info("info_encounter_enemy",{name:s.firstName,enemyName:t.entity_id?r("entities."+t.entity_id):r("items_and_rooms."+t.id),current:g+1,total:l.enemyCount});const y=t.entity_id?r("entities."+t.entity_id):r("items_and_rooms."+t.id),b={currentHp:p,maxHp:l.enemyHp,power:l.enemyPower,name:y,count:g+1,total:l.enemyCount};for(n.push({messageKey:"log_messages.info_encounter_enemy",replacements:{name:s.firstName,enemyName:t.entity_id?r("entities."+t.entity_id):r("items_and_rooms."+t.id),current:g+1,total:l.enemyCount},adventurer:this._createAdventurerSnapshot(s),enemy:b,animations:[{target:"enemy",animation:"spawn"}]});p>0&&s.hp>0;){if(xe(s)==="use_potion"){const S=s.inventory.potions.shift();if(S){const k=S.stats.hp||0;s.hp=Math.min(s.maxHp,s.hp+k),_.info("info_adventurer_drinks_potion",{name:s.firstName,potionName:r("items_and_rooms."+S.id)}),n.push({messageKey:"log_messages.info_adventurer_drinks_potion",replacements:{name:s.firstName,potionName:r("items_and_rooms."+S.id)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p},animations:[{target:"adventurer",animation:"heal"}]})}}else{const S=Math.min(.95,.75+s.traits.skill/500+s.traits.offense/1e3);if(x.nextFloat()<S){const k=s.power;p-=k,_.debug(`Adventurer hits for ${k} damage.`);const A=s.flowState;G(s,"hit"),A!==s.flowState&&(_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:s.firstName,from:r(`flow_states.${A}`),to:r(`flow_states.${s.flowState}`)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p}})),n.push({messageKey:"log_messages.info_adventurer_hit",replacements:{name:s.firstName,damage:k},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p},animations:[{target:"adventurer",animation:"attack"},{target:"enemy",animation:"shake"}]})}else{_.debug("Adventurer misses.");const k=s.flowState;G(s,"miss"),k!==s.flowState&&(_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:s.firstName,from:r(`flow_states.${k}`),to:r(`flow_states.${s.flowState}`)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p}})),n.push({messageKey:"log_messages.info_adventurer_miss",replacements:{name:s.firstName},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p},animations:[{target:"adventurer",animation:"attack"},{target:"enemy",animation:"miss"}]})}}if(p<=0){_.info("info_enemy_defeated",{enemyName:b.name}),d++,n.push({messageKey:"log_messages.info_enemy_defeated",replacements:{enemyName:b.name},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:0},animations:[{target:"enemy",animation:"defeat"}]});break}const N=Math.max(.4,.75-s.traits.skill/500-(100-s.traits.offense)/1e3);if(x.nextFloat()<N){const S=(((i=s.inventory.armor)==null?void 0:i.stats.maxHp)||0)/10,k=Math.max(1,l.enemyPower-S);s.hp-=k,_.debug(`Enemy hits for ${k} damage.`);const A=s.flowState;G(s,"take_damage"),A!==s.flowState&&(_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:s.firstName,from:r(`flow_states.${A}`),to:r(`flow_states.${s.flowState}`)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p}})),n.push({messageKey:"log_messages.info_enemy_hit",replacements:{damage:k,enemyName:b.name},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p},animations:[{target:"enemy",animation:"attack"},{target:"adventurer",animation:"shake"}]})}else _.debug("Enemy misses."),n.push({messageKey:"log_messages.info_enemy_miss",replacements:{enemyName:b.name},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p},animations:[{target:"enemy",animation:"attack"},{target:"adventurer",animation:"miss"}]})}if(s.hp<=0){_.warn("info_adventurer_defeated",{name:s.firstName}),n.push({messageKey:"log_messages.info_adventurer_defeated",replacements:{name:s.firstName},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p},animations:[{target:"adventurer",animation:"defeat"}]});break}}const u=c-s.hp,h=u/s.maxHp;_.debug(`hpLost: ${u}, hpLostRatio: ${h.toFixed(2)}`);const f=s.flowState,m=Ie(s,h,d,l.enemyCount);f!==s.flowState&&_.metric({event:"flow_state_changed",flowState:s.flowState}),_.info("info_battle_outcome",{outcome:m});break}case"room_healing":{const l=t.stats.hp||0;s.hp=Math.min(s.maxHp,s.hp+l),_.info("info_healing_room",{name:s.firstName,healingRoomName:r("items_and_rooms."+t.id),healing:l}),n.push({messageKey:"log_messages.info_healing_room",replacements:{name:s.firstName,healingRoomName:r("items_and_rooms."+t.id),healing:l},adventurer:this._createAdventurerSnapshot(s),animations:[{target:"adventurer",animation:"heal"}]});break}case"room_trap":{const l=t.stats.attack||0;s.hp-=l;const d=s.flowState;Ce(s),d!==s.flowState&&_.metric({event:"flow_state_changed",flowState:s.flowState}),_.info("info_trap_room",{name:s.firstName,trapName:r("items_and_rooms."+t.id),damage:l}),n.push({messageKey:"log_messages.info_trap_room",replacements:{name:s.firstName,trapName:r("items_and_rooms."+t.id),damage:l},adventurer:this._createAdventurerSnapshot(s),animations:[{target:"adventurer",animation:"shake"}]});break}}return{log:n,finalAdventurer:s}}_endRun(e,t=!1){if(!this.gameState)return;this.metaManager.updateRun(this.gameState.run);const n=this.metaManager.checkForUnlocks(this.gameState.run);_.debug(`Run ended with ${this.gameState.designer.balancePoints} BP.`),_.metric({event:"run_end",bp:this.gameState.designer.balancePoints}),_.error("info_game_over",{reason:e});const s=this._getAdventurerEndRunDecision();s==="retire"&&this.dungeonHistory.setRetirementNode(),this.gameState={...this.gameState,phase:"RUN_OVER",runEnded:{isOver:!0,reason:e,success:t,decision:s},newlyUnlocked:n},this._emit("state-change",this.gameState)}_getAdventurerEndRunDecision(){if(!this.gameState)return"retire";const{flowState:e,traits:t,skill:n}=this.gameState.adventurer,{resilience:s,offense:a}=t,i=Math.min(n/100,1);if(e===v.Flow)return"continue";let l=.55;switch(e){case v.Anxiety:l+=.25-s/400;break;case v.Arousal:l-=.1-a/1e3;break;case v.Worry:l+=.2;break;case v.Control:l-=.15;break;case v.Relaxation:l+=.1;break;case v.Boredom:l+=.3;break;case v.Apathy:l+=.4;break}return l-=i*.1,l=Math.max(.05,Math.min(.95,l)),x.nextFloat()<l?"retire":"continue"}handleEndOfRun(e){if(this.gameState){if(_.info("info_adventurer_decision",{name:this.gameState.adventurer.firstName,decision:e}),e==="retire"){this.quitGame(!0);return}this.enterWorkshop()}}_getInitialGameState(){const e={offense:x.nextInt(10,90),resilience:x.nextInt(10,90),skill:0},t=new I(e,this._allNames);return{phase:"MENU",designer:{balancePoints:0},adventurer:t,unlockedDeck:[],availableDeck:[],hand:[],unlockedRoomDeck:[],availableRoomDeck:[],roomHand:[],handSize:this._getHandSize(),shopItems:[],offeredLoot:[],offeredRooms:[],run:0,room:0,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null}}_getHandSize(){return this.metaManager.acls.has(C.HAND_SIZE_INCREASE)?12:we}_getRoomDeckSize(){return this.metaManager.acls.has(C.ROOM_DECK_SIZE_INCREASE)?36:be}isWorkshopAccessUnlocked(){return this.metaManager.acls.has(C.WORKSHOP_ACCESS)}isWorkshopUnlocked(){return this.metaManager.acls.has(C.WORKSHOP)}getDungeonChartData(){return this.dungeonHistory.generateChartData()}hasSaveGame(){return this.gameSaver.hasSaveGame()}async _loadGameData(){try{this._allItems=await this.dataLoader.loadJson("game/items.json"),this._allRooms=await this.dataLoader.loadJson("game/rooms.json"),this._allNames=await this.dataLoader.loadJson("game/names.json")}catch(e){this.error=e.message||r("global.unknown_error"),this._emit("error",null)}finally{this.isLoading=!1,this._emit("state-change",this.gameState)}}}class D{constructor(e,t,n,s){this.resolve=s;const a=document.createElement("div");a.dataset.testid="info-modal-overlay",Object.assign(a.style,{position:"fixed",top:"0",left:"0",right:"0",bottom:"0",backgroundColor:"rgba(0, 0, 0, 0.4)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:"1000"}),a.addEventListener("click",p=>{if(p.target===a){const y=n.find(b=>typeof b.value=="boolean"&&b.value===!1);y&&this.dismiss(y.value)}});const i=document.createElement("div");this.element=i,i.className="window",i.style.width="min(90vw, 800px)",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-labelledby","info-modal-title");const l=document.createElement("div");l.className="title-bar";const d=document.createElement("div");d.id="info-modal-title",d.className="title-bar-text",d.textContent=e,l.appendChild(d),i.appendChild(l);const c=document.createElement("div");c.className="window-body text-center p-4";const u=document.createElement("div");u.innerHTML=t,c.appendChild(u);const h=document.createElement("div");h.className="flex justify-end gap-2 mt-4",n.forEach(p=>{const y=document.createElement("button");y.textContent=p.text,y.addEventListener("click",()=>{this.dismiss(p.value)}),h.appendChild(y)}),c.appendChild(h),i.appendChild(c),a.appendChild(i),document.body.appendChild(a),document.body.style.overflow="hidden",this.handleKeydown=p=>{if(p.key==="Escape"){const y=n.find(b=>typeof b.value=="boolean"&&b.value===!1);y&&this.dismiss(y.value)}},document.addEventListener("keydown",this.handleKeydown);const f=i.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'),m=f[0],g=f[f.length-1];m==null||m.focus(),i.addEventListener("keydown",p=>{p.key==="Tab"&&(p.shiftKey?document.activeElement===m&&(g.focus(),p.preventDefault()):document.activeElement===g&&(m.focus(),p.preventDefault()))})}dismiss(e){this.element.parentElement.remove(),document.removeEventListener("keydown",this.handleKeydown),document.body.style.overflow="",this.resolve(e)}static show(e,t,n){return new Promise(s=>{new D(e,t,n,s)})}static showInfo(e,t,n=r("global.continue")){const s=[{text:n,value:void 0}];return D.show(e,t,s)}}class j{static show(e,t){const n=[{text:r("global.cancel"),value:!1,variant:"secondary"},{text:r("global.confirm"),value:!0,variant:"primary"}];return D.show(e,t,n)}}class Ne extends HTMLElement{constructor(){super(),this.isDesktop=!0,this.attachShadow({mode:"open"}),this.onclick=t=>{window.matchMedia("(pointer: coarse)").matches&&t.target===this&&this.hide()};const e=document.createElement("style");e.textContent=`
  ...
  <div class="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-6">
    ...
    `;const u=this.querySelector("#loot-card-container");u&&i.forEach(h=>{const f=document.createElement("choice-card");f.item=h,"stackCount"in h&&(f.stackCount=h.stackCount),f.isSelected=this._selectedIds.includes(h.instanceId);let m=this._disabled;if(this._offerImpossible)m=!0;else if(a){const g=this._choices.filter(y=>this._selectedIds.includes(y.instanceId)),p=g.some(y=>y.type==="room_boss");f.isSelected?m=!1:(p||h.type==="room_boss"&&g.length>0||g.length>=3)&&(m=!0)}else{const g=new Map(this._choices.map(b=>[b.instanceId,b.id])),p=this._selectedIds.map(b=>g.get(b));m=!f.isSelected&&p.includes(h.id)||this._disabled}f.isDisabled=m,f.isNewlyDrafted=h.justDrafted&&this._initialRender||!1,u.appendChild(f)}),setTimeout(()=>{this._initialRender=!1},0)}}customElements.define("choice-panel",Xe);class Qe extends HTMLElement{constructor(){super(),this._items=[],this._balancePoints=0,this.engine=null,this.addEventListener("click",e=>{const t=e.target,n=t.dataset.itemId;n&&this.engine&&this.engine.purchaseItem(n),t.id==="start-run-button"&&this.engine&&this.engine.startNewRun()})}set items(e){this._items=e,this.render()}set balancePoints(e){this._balancePoints=e,this.render()}connectedCallback(){this.render()}async render(){this.innerHTML=`
    ...
    `;const e=this.querySelector("#item-cards");if(e){e.innerHTML="";for(const t of this._items){const n=document.createElement("choice-card");n.item=t,n.purchaseInfo={cost:t.cost||0,canAfford:this._balancePoints>=(t.cost||0)},e.appendChild(n)}}}}customElements.define("workshop-screen",Qe);class et extends HTMLElement{constructor(){super(),this.engine=null,this.metaManager=null,this.addEventListener("click",async e=>{if(!this.engine||!this.metaManager)return;const t=e.target;t.id==="new-game-button"?(this.metaManager.metaState.adventurers>0||this.metaManager.metaState.highestRun>0,this.engine.hasSaveGame()?await j.show(r("menu.new_game"),r("menu.new_game_confirm"))&&this.engine.startNewGame():this.engine.startNewGame()):t.id==="continue-game-button"?this.engine.continueGame():t.id==="reset-game-button"&&await j.show(r("menu.reset_save"),r("menu.reset_save_confirm"))&&(this.metaManager.reset(),this.engine.quitGame(!0),this.render())})}connectedCallback(){this.render()}render(){if(!this.metaManager||!this.engine)return;const e=this.metaManager.metaState,t=this.engine.hasSaveGame();let n="";if(t){const s=e.adventurers||0;n=`
      ...
      <div class="window" style="width: 400px;">
        ...
        <div class="status-bar">
          ...
          <p class="status-bar-field">build 194</p>
        </div>
      </div>
