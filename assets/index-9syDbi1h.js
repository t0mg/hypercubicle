                    ...
                    <div class="space-y-4">
                        <div>
                            <div class="flex justify-between items-center mb-1">
                                <div class="flex items-center">${Y()} <span class="font-semibold text-lg">${n("global.health")}</span></div>
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-1">
                                <div class="flex items-center">${z()} <span class="font-semibold text-lg">${n("adventurer_status.interest")}</span></div>
