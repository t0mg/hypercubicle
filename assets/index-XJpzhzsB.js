(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=t(i);fetch(i.href,n)}})();const te="modulepreload",se=function(a){return"/rogue-steward/"+a},q={},ne=function(e,t,s){let i=Promise.resolve();if(t&&t.length>0){let l=function(d){return Promise.all(d.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),c=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));i=l(t.map(d=>{if(d=se(d),d in q)return;q[d]=!0;const f=d.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${m}`))return;const p=document.createElement("link");if(p.rel=f?"stylesheet":te,f||(p.as="script"),p.crossOrigin="",p.href=d,c&&p.setAttribute("nonce",c),document.head.appendChild(p),f)return new Promise((h,u)=>{p.addEventListener("load",h),p.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${d}`)))})}))}function n(l){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=l,window.dispatchEvent(r),!r.defaultPrevented)throw l}return i.then(l=>{for(const r of l||[])r.status==="rejected"&&n(r.reason);return e().catch(n)})};var _=(a=>(a.Arousal="arousal",a.Flow="flow",a.Control="control",a.Relaxation="relaxation",a.Boredom="boredom",a.Apathy="apathy",a.Worry="worry",a.Anxiety="anxiety",a))(_||{});let j={};async function W(a,e){try{j=await e.loadJson(`locales/${a}.json`)}catch(t){console.warn(`Failed to load ${a} translations:`,t),a!=="en"&&await W("en",e)}}function ie(){return typeof navigator<"u"&&navigator.language?navigator.language.split("-")[0]:"en"}function o(a,e={}){let s=a.split(".").reduce((i,n)=>i?i[n]:void 0,j);if(!s)return console.warn(`Translation not found for key: ${a}`),a;for(const i in e)s=s.replace(`{${i}}`,String(e[i]));return s}async function ae(a){const e=ie();await W(e,a)}class x{constructor(){this.entries=[],this.listeners=[],this.muted=!1}static getInstance(){return x.instance||(x.instance=new x),x.instance}on(e){this.listeners.push(e)}log(e,t="INFO",s){const i=o(`log_messages.${e}`,s),n={message:i,level:t,timestamp:Date.now(),data:s};this.muted||(this.entries.push(n),t!=="DEBUG"&&console.log(`[${t}] ${i}`)),this.listeners.forEach(l=>l(n))}debug(e){const t={message:e,level:"DEBUG",timestamp:Date.now()};this.muted||this.entries.push(t),this.listeners.forEach(s=>s(t))}info(e,t){this.log(e,"INFO",t)}warn(e,t){this.log(e,"WARN",t)}error(e,t){this.log(e,"ERROR",t)}toJSON(){return{entries:this.entries}}loadEntries(e){this.entries=e||[]}static fromJSON(e){const t=x.getInstance();return t.loadEntries(e.entries),t}}class oe{constructor(e){this.seed=e}setSeed(e){this.seed=e}nextFloat(){let e=this.seed+=1831565813;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}nextInt(e,t){return Math.floor(this.nextFloat()*(t-e+1))+e}}const k=new oe(Date.now()),Z=a=>`${a}_${k.nextFloat().toString(36).substr(2,9)}`,re=(a,e)=>k.nextInt(a,e),V=a=>{const e=[...a];for(let t=e.length-1;t>0;t--){const s=k.nextInt(0,t);[e[t],e[s]]=[e[s],e[t]]}return e},J=(a,e,t,s)=>{const i=e.filter(m=>a.includes(m.id)),n=[],l={common:.6,uncommon:.3,rare:.1,legendary:0},r={common:0,uncommon:0,rare:0,legendary:0},c={common:0,uncommon:0,rare:0,legendary:0};Object.keys(l).forEach(m=>{c[m]=Math.floor(t*l[m])});let d=Object.values(c).reduce((m,p)=>m+p,0);for(;d<t;)c.common+=1,d+=1;i.filter(m=>m.cost!==null).forEach(m=>{n.push(s(m)),r[m.rarity]+=1}),Object.keys(l).forEach((m,p)=>{const h=i.filter(u=>u.rarity===m);for(;r[m]<c[m]&&h.length!==0;){const u=k.nextInt(0,h.length-1),g=h[u];n.push(s(g)),r[m]+=1}});const f=i.filter(m=>m.rarity==="common");for(;n.length<t&&f.length>0;){const m=k.nextInt(0,f.length-1),p=f[m];n.push(s(p))}return V(n)},B=(a,e,t)=>J(a,e,t,s=>({...s,instanceId:Z(s.id)})),z=(a,e,t)=>J(a,e,t,i=>{const n={...i,instanceId:Z(i.id)};return n.type==="room_enemy"&&n.stats.minUnits&&n.stats.maxUnits&&(n.units=re(n.stats.minUnits,n.stats.maxUnits)),n}),le=a=>a.roomHand.length<3&&!a.roomHand.some(e=>e.type==="room_boss"),ce=a=>[...new Set(a.hand.map(t=>t.id))].length<2&&a.hand.length>0;function de(a,e){const t=Math.max(0,Math.min(100,a)),s=Math.max(0,Math.min(100,e));return s>66?t<33?_.Anxiety:t<87?_.Arousal:_.Flow:s>33?t<33?_.Worry:t<67?_.Apathy:_.Control:t<67?_.Boredom:_.Relaxation}const L={hp:100,maxHp:100,power:5},he=3;class I{constructor(e,t){this.hp=L.hp,this.maxHp=L.maxHp,this.power=L.power,this.skill=e.skill,this.challengeHistory=[50],this.flowState=_.Boredom,this.traits=e,this.inventory={weapon:null,armor:null,potions:[]},this.activeBuffs=[],this.logger=x.getInstance(),this.roomHistory=[],this.lootHistory=[],this.boredomCounter=0,this.firstName=t?t.firstNames[Math.floor(Math.random()*t.firstNames.length)]:"Testy",this.lastName=t?t.lastNames[Math.floor(Math.random()*t.lastNames.length)]:"McTest"}get challenge(){return this.challengeHistory.length===0?50:this.challengeHistory.reduce((t,s)=>t+s,0)/this.challengeHistory.length}modifySkill(e){const t=this.skill;this.skill=Math.max(0,Math.min(100,this.skill+e)),t.toFixed(1)!==this.skill.toFixed(1)&&this.logger.debug(`Skill changed from ${t.toFixed(1)} to ${this.skill.toFixed(1)}`),this.updateFlowState()}modifyChallenge(e){const t=this.challenge,s=Math.max(0,Math.min(100,e));this.challengeHistory.push(s),this.challengeHistory.length>he&&this.challengeHistory.shift(),this.logger.debug(`Challenge changed from ${t.toFixed(1)} to ${this.challenge.toFixed(1)} (new value: ${s})`),this.updateFlowState()}updateFlowState(){const e=this.flowState;this.flowState=de(this.skill,this.challenge),e!==this.flowState&&this.logger.info("info_flow_state_changed",{name:this.firstName,from:o("flow_states."+e),to:o("flow_states."+this.flowState)})}equip(e){e.type==="item_weapon"?this.inventory.weapon=e:e.type==="item_armor"&&(this.inventory.armor=e),this.recalculateStats()}addPotion(e){e.type==="item_potion"&&this.inventory.potions.push(e)}applyBuff(e){this.activeBuffs.push(e),this.recalculateStats()}updateBuffs(){const e=this.activeBuffs.filter(t=>t.stats.duration!==void 0&&t.stats.duration<=1);this.activeBuffs=this.activeBuffs.map(t=>(t.stats.duration&&(t.stats.duration-=1),t)).filter(t=>t.stats.duration===void 0||t.stats.duration>0),e.length>0&&this.recalculateStats()}recalculateStats(){const e=this.hp/this.maxHp;let t=L.power,s=L.maxHp;this.inventory.weapon&&(t+=this.inventory.weapon.stats.power||0,s+=this.inventory.weapon.stats.maxHp||0),this.inventory.armor&&(t+=this.inventory.armor.stats.power||0,s+=this.inventory.armor.stats.maxHp||0),this.activeBuffs.forEach(i=>{t+=i.stats.power||0,s+=i.stats.maxHp||0}),this.power=t,this.maxHp=s,this.hp=Math.round(this.maxHp*e)}toJSON(){return{hp:this.hp,maxHp:this.maxHp,power:this.power,traits:this.traits,inventory:this.inventory,activeBuffs:this.activeBuffs,skill:this.skill,challengeHistory:this.challengeHistory,flowState:this.flowState,roomHistory:this.roomHistory,lootHistory:this.lootHistory,boredomCounter:this.boredomCounter,firstName:this.firstName,lastName:this.lastName}}static fromJSON(e){const t=e.traits,s=new I(t);return s.hp=e.hp,s.maxHp=e.maxHp,s.power=e.power,s.inventory=e.inventory,s.activeBuffs=e.activeBuffs,s.skill=e.skill,s.challengeHistory=e.challengeHistory,s.flowState=e.flowState,s.roomHistory=e.roomHistory,s.lootHistory=e.lootHistory,s.boredomCounter=e.boredomCounter,s.firstName=e.firstName,s.lastName=e.lastName,s}}const ue=99,me=10,A=10,U=32,pe=18,fe=8;var E=(a=>(a.WORKSHOP="workshop",a.ROOM_DECK_SIZE_INCREASE="room_deck_size_increase",a.HAND_SIZE_INCREASE="hand_size_increase",a.ADVENTURER_TRAITS="ADVENTURER_TRAITS",a.BP_MULTIPLIER="BP_MULTIPLIER",a.WORKSHOP_ACCESS="WORKSHOP_ACCESS",a.BP_MULTIPLIER_2="BP_MULTIPLIER_2",a))(E||{});const Y=[{feature:"workshop",runThreshold:2,title:()=>o("unlocks.workshop.title"),description:()=>o("unlocks.workshop.description")},{feature:"room_deck_size_increase",runThreshold:3,title:()=>o("unlocks.room_deck_size_increase.title"),description:()=>o("unlocks.room_deck_size_increase.description")},{feature:"hand_size_increase",runThreshold:4,title:()=>o("unlocks.hand_size_increase.title"),description:()=>o("unlocks.hand_size_increase.description")},{feature:"ADVENTURER_TRAITS",runThreshold:5,title:()=>o("unlocks.adventurer_traits.title"),description:()=>o("unlocks.adventurer_traits.description")},{feature:"BP_MULTIPLIER",runThreshold:8,title:()=>o("unlocks.bp_multiplier.title"),description:()=>o("unlocks.bp_multiplier.description")},{feature:"WORKSHOP_ACCESS",runThreshold:13,title:()=>o("unlocks.workshop_access.title"),description:()=>o("unlocks.workshop_access.description")},{feature:"BP_MULTIPLIER_2",runThreshold:21,title:()=>o("unlocks.bp_multiplier_2.title"),description:()=>o("unlocks.bp_multiplier_2.description")}],Q=10;function X(a,e){var d,f,m,p;const{traits:t,inventory:s,hp:i,maxHp:n}=a;let l=(e.rarity==="uncommon"?2:e.rarity==="rare"?3:1)*5;const r=((d=s.weapon)==null?void 0:d.stats.power)||0,c=((f=s.armor)==null?void 0:f.stats.maxHp)||0;switch(e.type){case"item_weapon":const h=(e.stats.power||0)-r;if(h<=0&&e.id!==((m=s.weapon)==null?void 0:m.id))return-1;l+=h*(t.offense/10),h>0&&(l+=h*(a.skill/10));const u=e.stats.maxHp||0;u<0&&(l+=u*(100-t.resilience)/20);break;case"item_armor":const g=(e.stats.maxHp||0)-c;if(g<=0&&e.id!==((p=s.armor)==null?void 0:p.id))return-1;l+=g*(100-t.offense)/10,g>0&&(l+=g*(a.skill/10));const v=e.stats.power||0;v>0&&(l+=v*(t.offense/15));const b=e.stats.power||0;b<0&&(l+=b*(t.resilience/10));break;case"item_potion":const S=i/n;l+=10*(100-t.resilience)/100,S<.7&&(l+=20*(1-S)),l+=5*(a.skill/100),s.potions.length>=ue&&(l*=.1);break}return l}function ge(a,e,t){t.debug(`--- Adventurer Loot Decision --- (Offense: ${a.traits.offense}, Resilience: ${a.traits.resilience}, Skill: ${a.skill})`);const s=e.map(l=>({item:l,score:X(a,l)})).filter(l=>l.score>0);if(s.sort((l,r)=>r.score-l.score),s.length===0||s[0].score<me)return{choice:null,reason:o("game_engine.adventurer_declines_offer")};const i=s[0].item;t.debug(`Adventurer chooses: ${o("items_and_rooms."+i.id)} (Score: ${s[0].score.toFixed(1)})`);const n=o("game_engine.adventurer_accepts_offer",{itemName:o("items_and_rooms."+i.id)});return{choice:i,reason:n}}function _e(a,e){const{flowState:t,hp:s,maxHp:i,inventory:n,traits:l}=a,r=s/i;if(n.potions.length===0)return"attack";let c=.5;switch(t){case _.Anxiety:case _.Worry:c=.8;break;case _.Arousal:case _.Flow:c=.6;break;case _.Control:case _.Relaxation:c=.4;break;case _.Boredom:case _.Apathy:c=.2;break}return c-=l.resilience/200,r<Math.max(.1,c)?"use_potion":"attack"}function ve(a,e,t){if(e){a.lootHistory.push(e.id),a.lootHistory.filter(n=>n===e.id).length>2&&(a.modifyChallenge(a.challenge-Q),a.logger.info("info_repetitive_choice",{name:o("items_and_rooms."+e.id)}));const i=X(a,e);i>60?(a.modifySkill(10),a.modifyChallenge(a.challenge+5)):i>30?(a.modifySkill(5),a.modifyChallenge(a.challenge+2)):a.modifySkill(2)}else t.length>0?a.modifyChallenge(a.challenge-5):a.modifyChallenge(a.challenge-10);a.updateFlowState()}function be(a,e){a.roomHistory.push(e.id),a.roomHistory.filter(i=>i===e.id).length>2&&(a.modifyChallenge(a.challenge-Q),a.logger.info("info_deja_vu",{name:o("items_and_rooms."+e.id)}));let s=0;switch(e.type){case"room_enemy":s=5;break;case"room_boss":s=15;break;case"room_trap":s=10;break;case"room_healing":s=-15;break}a.modifyChallenge(a.challenge+s),a.updateFlowState()}function ye(a){a.modifySkill(-2),a.updateFlowState()}function M(a,e){switch(e){case"hit":a.modifySkill(.5);break;case"miss":a.modifySkill(-.5);break;case"take_damage":a.modifyChallenge(a.challenge+1);break}a.updateFlowState()}function Se(a,e,t,s){let i;return e>.7?(i=o("game_engine.too_close_for_comfort"),a.modifyChallenge(a.challenge+10),a.modifySkill(-3)):e>.4?(i=o("game_engine.great_battle"),a.modifyChallenge(a.challenge+5),a.modifySkill(5)):t>3&&a.traits.offense>60?(i=o("game_engine.easy_fight"),a.modifyChallenge(a.challenge-10)):(i=o("game_engine.worthy_challenge"),a.modifyChallenge(a.challenge-2),a.modifySkill(2)),t===s&&a.modifySkill(1*t),a.updateFlowState(),i}const y=x.getInstance();class we{constructor(e,t,s){this.gameState=null,this.isLoading=!0,this.error=null,this._allItems=[],this._allRooms=[],this._allNames={firstNames:[],lastNames:[]},this._listeners={},this.init=async()=>{await this._loadGameData()},this.startNewGame=i=>{this.metaManager.incrementAdventurers();const n={offense:k.nextInt(10,90),resilience:k.nextInt(10,90),skill:0};y.loadEntries([]);const l=new I(n,this._allNames),r=(i==null?void 0:i.items)||this._allItems.filter(v=>v.cost===null).map(v=>v.id),c=B(r,this._allItems,U),d=this._getHandSize(),f=c.slice(0,d),m=c.slice(d),p=(i==null?void 0:i.rooms)||this._allRooms.filter(v=>v.cost===null).map(v=>v.id),h=z(p,this._allRooms,this._getRoomDeckSize()),u=h.slice(0,d),g=h.slice(d);y.info("info_new_adventurer",{fullName:`${l.firstName} ${l.lastName}`,id:this.metaManager.metaState.adventurers.toString()}),this.gameState={phase:"DESIGNER_CHOOSING_ROOM",designer:{balancePoints:0},adventurer:l,unlockedDeck:r,availableDeck:m,hand:f,unlockedRoomDeck:p,availableRoomDeck:g,roomHand:u,handSize:d,shopItems:[],offeredLoot:[],offeredRooms:[],feedback:o("game_engine.new_adventurer"),run:1,room:1,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null},y.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),y.debug(`Deck size: ${c.length}, Hand size: ${d}, Room Deck size: ${h.length}, Room Hand size: ${u.length}`),this._emit("state-change",this.gameState)},this.continueGame=()=>{const i=this.gameSaver.load();i?(this.gameState=i,this._emit("state-change",this.gameState),this.gameState.phase==="AWAITING_ENCOUNTER_RESULT"&&this.gameState.encounterPayload&&this._emit("show-encounter",this.gameState.encounterPayload)):this.startNewGame()},this.startNewRun=i=>{if(!this.gameState)return;const n=i||this.gameState.run+1;this.metaManager.updateRun(n);const l=this._getHandSize(),r=B(this.gameState.unlockedDeck,this._allItems,U),c=r.slice(0,l),d=r.slice(l),f=z(this.gameState.unlockedRoomDeck,this._allRooms,this._getRoomDeckSize()),m=f.slice(0,l),p=f.slice(l),h=new I(this.gameState.adventurer.traits,this._allNames);h.skill=this.gameState.adventurer.skill,h.challengeHistory=[...this.gameState.adventurer.challengeHistory],h.flowState=this.gameState.adventurer.flowState,y.info("info_adventurer_returns"),y.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),this.gameState={...this.gameState,adventurer:h,phase:"DESIGNER_CHOOSING_ROOM",availableDeck:d,hand:c,availableRoomDeck:p,roomHand:m,handSize:l,room:1,run:n,feedback:o("game_engine.adventurer_returns"),runEnded:{isOver:!1,reason:"",success:!1,decision:null}},this._emit("state-change",this.gameState)},this.presentOffer=i=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_LOOT"||!this.gameState.hand)return;const n=this.gameState.hand.filter(b=>i.includes(b.instanceId));this.gameState.offeredLoot=n;const l=this.gameState.adventurer,{choice:r,reason:c}=ge(l,this.gameState.offeredLoot,y);ve(l,r,this.gameState.offeredLoot),r&&y.info("info_item_chosen",{name:l.firstName,item:o("items_and_rooms."+r.id)});let d=this.gameState.hand,f=this.gameState.availableDeck;d.forEach(b=>b.justDrafted=!1);let m=d.filter(b=>!i.includes(b.instanceId));const p=this.gameState.handSize-m.length,h=f.slice(0,p);h.forEach(b=>{b.draftedRoom=this.gameState.room,b.justDrafted=!0});const u=f.slice(p);m.push(...h),r&&(r.type==="item_potion"?l.addPotion(r):r.type==="item_buff"?l.applyBuff(r):l.equip(r));const g=this.gameState.room+1,v=this.gameState.designer.balancePoints+this._getBpPerRoom();this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",adventurer:l,feedback:c,availableDeck:u,hand:m,room:g,designer:{balancePoints:v}},this._emit("state-change",this.gameState)},this.runEncounter=i=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_ROOM")return;this.gameState.offeredRooms=i;const n=k.nextInt(0,this.gameState.offeredRooms.length-1),l=this.gameState.offeredRooms[n],{log:r,finalAdventurer:c,feedback:d}=this._generateEncounterLog(this.gameState.adventurer,l),f={room:l,log:r,finalAdventurer:c,feedback:d};this.gameState={...this.gameState,phase:"AWAITING_ENCOUNTER_RESULT",encounterPayload:f},this._emit("state-change",this.gameState),this._emit("show-encounter",f)},this.continueEncounter=()=>{!this.gameState||this.gameState.phase!=="AWAITING_ENCOUNTER_RESULT"||this._postEncounterUpdate()},this._postEncounterUpdate=()=>{if(!this.gameState)return;const i=I.fromJSON(this.gameState.encounterPayload.finalAdventurer),n=this.gameState.encounterPayload.feedback;i.updateBuffs(),this.gameState.designer.balancePoints+=this._getBpPerRoom();let l=this.gameState.roomHand,r=this.gameState.availableRoomDeck;l.forEach(h=>h.justDrafted=!1);const c=this.gameState.offeredRooms.map(h=>h.instanceId);let d=l.filter(h=>!c.includes(h.instanceId));const f=this.gameState.handSize-d.length,m=r.slice(0,f);m.forEach(h=>{h.draftedRoom=this.gameState.room,h.justDrafted=!0});const p=r.slice(f);if(d.push(...m),this.gameState.adventurer=i,i.hp<=0){this._endRun(o("game_engine.adventurer_fell",{room:this.gameState.room,run:this.gameState.run}));return}if(i.boredomCounter>2){const h=i.flowState===_.Boredom?o("game_engine.adventurer_bored",{room:this.gameState.room,run:this.gameState.run}):o("game_engine.adventurer_apathy",{room:this.gameState.room,run:this.gameState.run});this._endRun(h);return}this.gameState.hand&&this.gameState.hand.length===0?(y.warn("warn_empty_hand"),n.push(o("game_engine.empty_hand")),this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",room:this.gameState.room+1,designer:{balancePoints:this.gameState.designer.balancePoints+this._getBpPerRoom()},feedback:n,encounterPayload:void 0,roomHand:d,availableRoomDeck:p}):this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_LOOT",feedback:n,encounterPayload:void 0,roomHand:d,availableRoomDeck:p},this._emit("state-change",this.gameState)},this.forceEndRun=()=>{this.gameState&&(this.gameState.adventurer.modifyChallenge(-20),this.gameState.adventurer.updateFlowState(),this._endRun(o("game_engine.no_more_rooms"),!0))},this.enterWorkshop=()=>{if(!this.gameState)return;if(y.info("info_entering_workshop",{name:this.gameState.adventurer.firstName}),!this.metaManager.acls.has(E.WORKSHOP)){y.info("info_workshop_not_unlocked"),this.startNewRun();return}const i=this.gameState.run+1,n=this._allItems.filter(c=>c.cost!==null).filter(c=>!this.gameState.unlockedDeck.includes(c.id)),l=this._allRooms.filter(c=>c.cost!==null).filter(c=>!this.gameState.unlockedRoomDeck.includes(c.id)),r=[...n,...l];this.gameState={...this.gameState,phase:"SHOP",shopReturnPhase:this.gameState.phase,run:i,room:0,shopItems:V(r).slice(0,4),runEnded:{isOver:!1,reason:"",success:!1,decision:null},feedback:o("game_engine.welcome_to_workshop")},this._emit("state-change",this.gameState)},this.exitWorkshop=()=>{this.gameState&&this.startNewRun()},this.purchaseItem=i=>{if(!this.gameState)return;const n=this._allItems.find(u=>u.id===i),l=this._allRooms.find(u=>u.id===i),r=n||l;if(!r||r.cost===null||this.gameState.designer.balancePoints<r.cost)return;let c=this.gameState.unlockedDeck,d=this.gameState.unlockedRoomDeck,f=this.gameState.availableDeck,m=this.gameState.availableRoomDeck;n?(c=[...this.gameState.unlockedDeck,i],this.isWorkshopAccessUnlocked()&&(f=[n,...this.gameState.availableDeck])):l&&(d=[...this.gameState.unlockedRoomDeck,i],this.isWorkshopAccessUnlocked()&&(m=[l,...this.gameState.availableRoomDeck]));const p=this.gameState.designer.balancePoints-r.cost,h=this.gameState.shopItems.filter(u=>u.id!==i);y.info("info_item_purchased",{name:this.gameState.adventurer.firstName,item:o("items_and_rooms."+r.id)}),this.gameState={...this.gameState,designer:{balancePoints:p},unlockedDeck:c,unlockedRoomDeck:d,availableDeck:f,availableRoomDeck:m,shopItems:h},this._emit("state-change",this.gameState)},this.quitGame=(i=!0)=>{i&&this.gameSaver.clear(),this.showMenu()},this.showMenu=()=>{this.gameState={...this.gameState||this._getInitialGameState(),phase:"MENU"},this._emit("state-change",this.gameState)},this._getBpPerRoom=()=>this.metaManager.acls.has(E.BP_MULTIPLIER_2)?A*4:this.metaManager.acls.has(E.BP_MULTIPLIER)?A*2:A,this.saveGame=()=>{this.gameState&&this.gameState.phase!=="MENU"&&this.gameState.phase!=="RUN_OVER"&&this.gameSaver.save(this.gameState)},this.metaManager=e,this.dataLoader=t,this.gameSaver=s}on(e,t){this._listeners[e]||(this._listeners[e]=[]),this._listeners[e].push(t)}_emit(e,...t){e==="state-change"&&this.saveGame();const s=this._listeners[e];s&&s.forEach(i=>i(...t))}_createAdventurerSnapshot(e){return{firstName:e.firstName,hp:e.hp,maxHp:e.maxHp,power:e.power,flowState:e.flowState,inventory:JSON.parse(JSON.stringify(e.inventory))}}_generateEncounterLog(e,t){var l;const s=[],i=[],n=I.fromJSON(e.toJSON());switch(y.info("info_encounter",{name:n.firstName,roomName:o("items_and_rooms."+t.id)}),be(n,t),s.push({messageKey:"log_messages.info_encounter",replacements:{name:n.firstName,roomName:o("items_and_rooms."+t.id)},adventurer:this._createAdventurerSnapshot(n)}),t.type){case"room_enemy":case"room_boss":{const r={enemyCount:t.units??1,enemyPower:t.stats.attack||5,enemyHp:t.stats.hp||10};let c=0;const d=n.hp;for(let h=0;h<r.enemyCount;h++){let u=r.enemyHp;y.info("info_encounter_enemy",{name:n.firstName,current:h+1,total:r.enemyCount});const g={currentHp:u,maxHp:r.enemyHp,power:r.enemyPower,name:o("items_and_rooms."+t.id),count:h+1,total:r.enemyCount};for(s.push({messageKey:"log_messages.info_encounter_enemy",replacements:{name:n.firstName,current:h+1,total:r.enemyCount},adventurer:this._createAdventurerSnapshot(n),enemy:g});u>0&&n.hp>0;){if(_e(n)==="use_potion"){const S=n.inventory.potions.shift();if(S){const w=S.stats.hp||0;n.hp=Math.min(n.maxHp,n.hp+w),y.info("info_adventurer_drinks_potion",{name:n.firstName,potionName:o("items_and_rooms."+S.id)}),i.push(o("game_engine.adventurer_drinks_potion",{potionName:o("items_and_rooms."+S.id)})),s.push({messageKey:"log_messages.info_adventurer_drinks_potion",replacements:{name:n.firstName,potionName:o("items_and_rooms."+S.id)},adventurer:this._createAdventurerSnapshot(n),enemy:{...g,currentHp:u}})}}else{const S=Math.min(.95,.75+n.traits.skill/500+n.traits.offense/1e3);if(k.nextFloat()<S){const w=n.power;u-=w,y.debug(`Adventurer hits for ${w} damage.`);const R=n.flowState;M(n,"hit"),R!==n.flowState&&s.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:n.firstName,from:o(`flow_states.${R}`),to:o(`flow_states.${n.flowState}`)},adventurer:this._createAdventurerSnapshot(n),enemy:{...g,currentHp:u}}),s.push({messageKey:"log_messages.info_adventurer_hit",replacements:{damage:w},adventurer:this._createAdventurerSnapshot(n),enemy:{...g,currentHp:u}})}else{y.debug("Adventurer misses.");const w=n.flowState;M(n,"miss"),w!==n.flowState&&s.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:n.firstName,from:o(`flow_states.${w}`),to:o(`flow_states.${n.flowState}`)},adventurer:this._createAdventurerSnapshot(n),enemy:{...g,currentHp:u}}),s.push({messageKey:"log_messages.info_adventurer_miss",adventurer:this._createAdventurerSnapshot(n),enemy:{...g,currentHp:u}})}}if(u<=0){y.info("info_enemy_defeated"),c++,s.push({messageKey:"log_messages.info_enemy_defeated",adventurer:this._createAdventurerSnapshot(n),enemy:{...g,currentHp:0}});break}const b=Math.max(.4,.75-n.traits.skill/500-(100-n.traits.offense)/1e3);if(k.nextFloat()<b){const S=(((l=n.inventory.armor)==null?void 0:l.stats.maxHp)||0)/10,w=Math.max(1,r.enemyPower-S);n.hp-=w,y.debug(`Enemy hits for ${w} damage.`);const R=n.flowState;M(n,"take_damage"),R!==n.flowState&&s.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:n.firstName,from:o(`flow_states.${R}`),to:o(`flow_states.${n.flowState}`)},adventurer:this._createAdventurerSnapshot(n),enemy:{...g,currentHp:u}}),s.push({messageKey:"log_messages.info_enemy_hit",replacements:{damage:w},adventurer:this._createAdventurerSnapshot(n),enemy:{...g,currentHp:u}})}else y.debug("Enemy misses."),s.push({messageKey:"log_messages.info_enemy_miss",adventurer:this._createAdventurerSnapshot(n),enemy:{...g,currentHp:u}})}if(n.hp<=0){y.warn("info_adventurer_defeated",{name:n.firstName}),s.push({messageKey:"log_messages.info_adventurer_defeated",replacements:{name:n.firstName},adventurer:this._createAdventurerSnapshot(n),enemy:{...g,currentHp:u}});break}}const f=d-n.hp,m=f/n.maxHp;y.debug(`hpLost: ${f}, hpLostRatio: ${m.toFixed(2)}`);const p=Se(n,m,c,r.enemyCount);i.push(p);break}case"room_healing":{const r=t.stats.hp||0;n.hp=Math.min(n.maxHp,n.hp+r),y.info("info_healing_room",{name:n.firstName,healingRoomName:o("items_and_rooms."+t.id),healing:r}),i.push(o("game_engine.healing_room",{name:o("items_and_rooms."+t.id),healing:r})),s.push({messageKey:"log_messages.info_healing_room",replacements:{name:n.firstName,healingRoomName:o("items_and_rooms."+t.id),healing:r},adventurer:this._createAdventurerSnapshot(n)});break}case"room_trap":{const r=t.stats.attack||0;n.hp-=r,ye(n),y.info("info_trap_room",{name:n.firstName,trapName:o("items_and_rooms."+t.id),damage:r}),i.push(o("game_engine.trap_room",{name:o("items_and_rooms."+t.id),damage:r})),s.push({messageKey:"log_messages.info_trap_room",replacements:{name:n.firstName,trapName:o("items_and_rooms."+t.id),damage:r},adventurer:this._createAdventurerSnapshot(n)});break}}return{log:s,finalAdventurer:n,feedback:i}}_endRun(e,t=!1){if(!this.gameState)return;this.metaManager.updateRun(this.gameState.run);const s=this.metaManager.checkForUnlocks(this.gameState.run);y.debug(`Run ended with ${this.gameState.designer.balancePoints} BP.`),y.error("info_game_over",{reason:e});const i=this._getAdventurerEndRunDecision();this.gameState={...this.gameState,phase:"RUN_OVER",runEnded:{isOver:!0,reason:e,success:t,decision:i},newlyUnlocked:s},this._emit("state-change",this.gameState)}_getAdventurerEndRunDecision(){if(!this.gameState)return"retire";const{flowState:e,traits:t,skill:s}=this.gameState.adventurer,{resilience:i,offense:n}=t,l=Math.min(s/100,1);if(e===_.Flow)return"continue";let r=.55;switch(e){case _.Anxiety:r+=.25-i/400;break;case _.Arousal:r-=.1-n/1e3;break;case _.Worry:r+=.2;break;case _.Control:r-=.15;break;case _.Relaxation:r+=.1;break;case _.Boredom:r+=.3;break;case _.Apathy:r+=.4;break}return r-=l*.1,r=Math.max(.05,Math.min(.95,r)),k.nextFloat()<r?"retire":"continue"}handleEndOfRun(e){if(this.gameState){if(y.info("info_adventurer_decision",{name:this.gameState.adventurer.firstName,decision:e}),e==="retire"){this.quitGame(!0);return}this.enterWorkshop()}}_getInitialGameState(){const e={offense:k.nextInt(10,90),resilience:k.nextInt(10,90),skill:0},t=new I(e,this._allNames);return{phase:"MENU",designer:{balancePoints:0},adventurer:t,unlockedDeck:[],availableDeck:[],hand:[],unlockedRoomDeck:[],availableRoomDeck:[],roomHand:[],handSize:this._getHandSize(),shopItems:[],offeredLoot:[],offeredRooms:[],feedback:"",run:0,room:0,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null}}_getHandSize(){return this.metaManager.acls.has(E.HAND_SIZE_INCREASE)?12:fe}_getRoomDeckSize(){return this.metaManager.acls.has(E.ROOM_DECK_SIZE_INCREASE)?36:pe}isWorkshopAccessUnlocked(){return this.metaManager.acls.has(E.WORKSHOP_ACCESS)}isWorkshopUnlocked(){return this.metaManager.acls.has(E.WORKSHOP)}hasSaveGame(){return this.gameSaver.hasSaveGame()}async _loadGameData(){try{this._allItems=await this.dataLoader.loadJson("game/items.json"),this._allRooms=await this.dataLoader.loadJson("game/rooms.json"),this._allNames=await this.dataLoader.loadJson("game/names.json")}catch(e){this.error=e.message||o("global.unknown_error"),this._emit("error",null)}finally{this.isLoading=!1,this._emit("state-change",this.gameState)}}}class H{constructor(e,t,s,i){this.resolve=i;const n=document.createElement("div");n.dataset.testid="info-modal-overlay",Object.assign(n.style,{position:"fixed",top:"0",left:"0",right:"0",bottom:"0",backgroundColor:"rgba(0, 0, 0, 0.4)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:"1000"}),n.addEventListener("click",g=>{if(g.target===n){const v=s.find(b=>typeof b.value=="boolean"&&b.value===!1);v&&this.dismiss(v.value)}});const l=document.createElement("div");this.element=l,l.className="window",l.style.width="min(90vw, 800px)",l.setAttribute("role","dialog"),l.setAttribute("aria-modal","true"),l.setAttribute("aria-labelledby","info-modal-title");const r=document.createElement("div");r.className="title-bar";const c=document.createElement("div");c.id="info-modal-title",c.className="title-bar-text",c.textContent=e,r.appendChild(c),l.appendChild(r);const d=document.createElement("div");d.className="window-body text-center p-4";const f=document.createElement("div");f.innerHTML=t,d.appendChild(f);const m=document.createElement("div");m.className="flex justify-center gap-2 mt-4",s.forEach(g=>{const v=document.createElement("button");v.textContent=g.text,v.addEventListener("click",()=>{this.dismiss(g.value)}),m.appendChild(v)}),d.appendChild(m),l.appendChild(d),n.appendChild(l),document.body.appendChild(n),this.handleKeydown=g=>{if(g.key==="Escape"){const v=s.find(b=>typeof b.value=="boolean"&&b.value===!1);v&&this.dismiss(v.value)}},document.addEventListener("keydown",this.handleKeydown);const p=l.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'),h=p[0],u=p[p.length-1];h==null||h.focus(),l.addEventListener("keydown",g=>{g.key==="Tab"&&(g.shiftKey?document.activeElement===h&&(u.focus(),g.preventDefault()):document.activeElement===u&&(h.focus(),g.preventDefault()))})}dismiss(e){this.element.parentElement.remove(),document.removeEventListener("keydown",this.handleKeydown),this.resolve(e)}static show(e,t,s){return new Promise(i=>{new H(e,t,s,i)})}static showInfo(e,t,s=o("global.continue")){const i=[{text:s,value:void 0}];return H.show(e,t,i)}}class P{static show(e,t){const s=[{text:o("global.cancel"),value:!1,variant:"secondary"},{text:o("global.confirm"),value:!0,variant:"primary"}];return H.show(e,t,s)}}const ke=`<div class="w-full p-4 md:p-6 lg:p-8">
  <div class="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-6">
    ...
    <div class="lg:col-span-5">
      <div class="window">
        ...
        `}updateDecision(e){const t=this.querySelector("#decision-container"),s=this.querySelector("#button-container");if(!t||!s||this.state!=="decision-revealed")return;let i="",n="";const l=e?"animate-fade-in-up":"",r=this.hasAttribute("workshop-unlocked");this.decision==="continue"?(i=`
                <h3 class="${l}" style="color: var(--color-stat-positive);">${o("run_ended_screen.continue_quote")}</h3>
                <p class="${l}" style="animation-delay: 0.5s;">${o("run_ended_screen.continue_decision")}</p>
            `,n=`
                <button id="continue-run-button" class="${l}" style="animation-delay: 1.2s;">
                    ${o(r?"run_ended_screen.enter_workshop":"run_ended_screen.start_new_run")}
                </button>
            `):(i=`
                <h3 class="${l}" style="color: var(--color-stat-negative);">${o("run_ended_screen.retire_quote")}</h3>
                <p class="${l}" style="animation-delay: 0.5s;">${o("run_ended_screen.retire_decision",{run:this.getAttribute("run")})}</p>
            `,n=`
    ...
    `;const m=this.querySelector("#loot-card-container");m&&r.forEach(p=>{const h=document.createElement("choice-card");h.item=p,"stackCount"in p&&(h.stackCount=p.stackCount),h.isSelected=this._selectedIds.includes(p.instanceId);let u=this._disabled;if(this._offerImpossible)u=!0;else if(l){const g=this._choices.filter(b=>this._selectedIds.includes(b.instanceId)),v=g.some(b=>b.type==="room_boss");h.isSelected?u=!1:(v||p.type==="room_boss"&&g.length>0||g.length>=3)&&(u=!0)}else{const g=new Map(this._choices.map(S=>[S.instanceId,S.id])),v=this._selectedIds.map(S=>g.get(S));u=!h.isSelected&&v.includes(p.id)||this._disabled}h.isDisabled=u,h.isNewlyDrafted=p.justDrafted&&this._initialRender||!1,m.appendChild(h)}),setTimeout(()=>{this._initialRender=!1},0)}}customElements.define("choice-panel",je);class We extends HTMLElement{constructor(){super(),this._items=[],this._balancePoints=0,this.engine=null,this.addEventListener("click",e=>{const t=e.target,s=t.dataset.itemId;s&&this.engine&&this.engine.purchaseItem(s),t.id==="start-run-button"&&this.engine&&this.engine.startNewRun()})}set items(e){this._items=e,this.render()}set balancePoints(e){this._balancePoints=e,this.render()}connectedCallback(){this.render()}async render(){this.innerHTML=`
    ...
    `;const e=this.querySelector("#item-cards");if(e){e.innerHTML="";for(const t of this._items){const s=document.createElement("choice-card");s.item=t,s.purchaseInfo={cost:t.cost||0,canAfford:this._balancePoints>=(t.cost||0)},e.appendChild(s)}}}}customElements.define("workshop-screen",We);class Ze extends HTMLElement{constructor(){super(),this.engine=null,this.metaManager=null,this.addEventListener("click",async e=>{if(!this.engine||!this.metaManager)return;const t=e.target;t.id==="new-game-button"?(this.metaManager.metaState.adventurers>0||this.metaManager.metaState.highestRun>0,this.engine.hasSaveGame()?await P.show(o("menu.new_game"),o("menu.new_game_confirm"))&&this.engine.startNewGame():this.engine.startNewGame()):t.id==="continue-game-button"?this.engine.continueGame():t.id==="reset-game-button"&&await P.show(o("menu.reset_save"),o("menu.reset_save_confirm"))&&(this.metaManager.reset(),this.engine.quitGame(!0),this.render())})}connectedCallback(){this.render()}render(){if(!this.metaManager||!this.engine)return;const e=this.metaManager.metaState,t=this.engine.hasSaveGame();let s="";if(t){const i=e.adventurers||0;s=`
      ...
      <div class="window" style="width: 400px;">
        ...
        <div class="status-bar">
          ...
          <p class="status-bar-field">build 141</p>
        </div>
      </div>
    ...
    `}updateProgressBar(){if(!this.payload)return;const e=this.currentEventIndex/(this.payload.log.length-1);this.querySelector("#progress-indicator").style.width=`${e*100}%`}dismiss(e){clearTimeout(this.battleTimeout),this.querySelector("#progress-container").classList.add("hidden"),this.querySelector("#slider-container").classList.add("hidden"),this.remove(),this.onDismiss({skipped:e})}static show(e){return new Promise(t=>{const s=document.createElement("encounter-modal");s.payload=e,s.onDismiss=t,document.body.appendChild(s)})}}customElements.define("encounter-modal",ee);const Qe=Object.freeze(Object.defineProperty({__proto__:null,EncounterModal:ee},Symbol.toStringTag,{value:"Module"}));class T{constructor(){this.showTimeout=null,this.hideTimeout=null,this.desktopTooltipActive=!1,this.tooltipBox=document.createElement("tooltip-box"),document.body.appendChild(this.tooltipBox)}static getInstance(){return T.instance||(T.instance=new T),T.instance}handleMouseEnter(e){if(this.isTouchDevice())return;const t=e.target,s=this.findTooltipKey(t);this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=null),s&&this.activeToolipKey!==s&&(this.showTimeout=window.setTimeout(()=>{t.addEventListener("mouseleave",this.handleMouseLeave.bind(this),{once:!0}),this.activeToolipKey=s;const i=this.getTooltipContent(s);i&&(this.tooltipBox.show(i,e.clientX,e.clientY),this.desktopTooltipActive=!0)},300))}handleMouseLeave(){this.isTouchDevice()||(this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=null),this.tooltipBox.hide(),this.activeToolipKey="",this.desktopTooltipActive=!1)}handleClick(e){const t=e.target;if(t.classList.contains("tooltip-icon")){const s=this.findTooltipKey(t.parentElement);if(s){const i=this.getTooltipContent(s);i&&this.tooltipBox.show(i,0,0)}}}isTouchDevice(){return"ontouchstart"in window||navigator.maxTouchPoints>0}findTooltipKey(e){return e?e.getAttribute("data-tooltip-key")||this.findTooltipKey(e.parentElement):null}getTooltipContent(e){const t=o(`tooltips.${e}.body`);if(t.includes("tooltips."))return null;let s=o(`tooltips.${e}.title`);return s.includes("tooltips.")&&(s=o("global.information")),{title:s,body:t}}}const K=T.getInstance(),C=document.getElementById("app");if(!C)throw new Error("Could not find app element to mount to");async function Xe(){C.innerHTML="<div>Initializing...</div>";const a=new Le;await ae(a);const e=new He,t=new Re(e),s=new Te(e),i=new we(t,a,s);i.on("state-change",n=>{if(i.isLoading){C.innerHTML=`<div>${o("global.loading_game_data")}</div>`;return}if(i.error){C.innerHTML=`
            ...
            `;return}Ce(C,n,i),$e()}),i.on("show-encounter",async n=>{const{EncounterModal:l}=await ne(async()=>{const{EncounterModal:r}=await Promise.resolve().then(()=>Qe);return{EncounterModal:r}},void 0);await l.show(n),i.continueEncounter()}),C.innerHTML=`<div>${o("global.initializing")}</div>`,document.body.addEventListener("mouseover",n=>K.handleMouseEnter(n)),document.body.addEventListener("click",n=>K.handleClick(n)),await i.init(),i.showMenu()}Xe().catch(a=>{console.error(a),C&&(C.innerHTML=`
      <div class="min-h-screen flex items-center justify-center p-4">
          <div class="bg-brand-surface p-8 rounded-xl shadow-2xl text-center border border-brand-secondary">
