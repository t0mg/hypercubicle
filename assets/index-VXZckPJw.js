(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=t(i);fetch(i.href,n)}})();const ie="modulepreload",ae=function(o){return"/hypercubicle/"+o},U={},oe=function(e,t,s){let i=Promise.resolve();if(t&&t.length>0){let r=function(d){return Promise.all(d.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),c=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));i=r(t.map(d=>{if(d=ae(d),d in U)return;U[d]=!0;const f=d.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${m}`))return;const u=document.createElement("link");if(u.rel=f?"stylesheet":ie,f||(u.as="script"),u.crossOrigin="",u.href=d,c&&u.setAttribute("nonce",c),document.head.appendChild(u),f)return new Promise((h,p)=>{u.addEventListener("load",h),u.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${d}`)))})}))}function n(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return i.then(r=>{for(const l of r||[])l.status==="rejected"&&n(l.reason);return e().catch(n)})};var b=(o=>(o.Arousal="arousal",o.Flow="flow",o.Control="control",o.Relaxation="relaxation",o.Boredom="boredom",o.Apathy="apathy",o.Worry="worry",o.Anxiety="anxiety",o))(b||{});let V={};async function J(o,e){try{V=await e.loadJson(`locales/${o}.json`)}catch(t){console.warn(`Failed to load ${o} translations:`,t),o!=="en"&&await J("en",e)}}function re(){return typeof navigator<"u"&&navigator.language?navigator.language.split("-")[0]:"en"}function a(o,e={}){let s=o.split(".").reduce((i,n)=>i?i[n]:void 0,V);if(!s)return console.warn(`Translation not found for key: ${o}`),o;for(const i in e)s=s.replace(`{${i}}`,String(e[i]));return s}async function le(o){const e=re();await J(e,o)}class E{constructor(){this.entries=[],this.listeners=[],this.muted=!1}static getInstance(){return E.instance||(E.instance=new E),E.instance}on(e){this.listeners.push(e)}log(e,t="INFO",s){const i=a(`log_messages.${e}`,s),n={message:i,level:t,timestamp:Date.now(),data:s};this.muted||(this.entries.push(n),t!=="DEBUG"&&console.log(`[${t}] ${i}`)),this.listeners.forEach(r=>r(n))}debug(e){const t={message:e,level:"DEBUG",timestamp:Date.now()};this.muted||this.entries.push(t),this.listeners.forEach(s=>s(t))}info(e,t){this.log(e,"INFO",t)}warn(e,t){this.log(e,"WARN",t)}error(e,t){this.log(e,"ERROR",t)}toJSON(){return{entries:this.entries}}loadEntries(e){this.entries=e||[]}static fromJSON(e){const t=E.getInstance();return t.loadEntries(e.entries),t}}class ce{constructor(e){this.seed=e}setSeed(e){this.seed=e}nextFloat(){let e=this.seed+=1831565813;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}nextInt(e,t){return Math.floor(this.nextFloat()*(t-e+1))+e}}const k=new ce(Date.now()),Y=o=>`${o}_${k.nextFloat().toString(36).substr(2,9)}`,de=(o,e)=>k.nextInt(o,e),Q=o=>{const e=[...o];for(let t=e.length-1;t>0;t--){const s=k.nextInt(0,t);[e[t],e[s]]=[e[s],e[t]]}return e},X=(o,e,t,s)=>{const i=e.filter(m=>o.includes(m.id)),n=[],r={common:.6,uncommon:.3,rare:.1,legendary:0},l={common:0,uncommon:0,rare:0,legendary:0},c={common:0,uncommon:0,rare:0,legendary:0};Object.keys(r).forEach(m=>{c[m]=Math.floor(t*r[m])});let d=Object.values(c).reduce((m,u)=>m+u,0);for(;d<t;)c.common+=1,d+=1;i.filter(m=>m.cost!==null).forEach(m=>{n.push(s(m)),l[m.rarity]+=1}),Object.keys(r).forEach((m,u)=>{const h=i.filter(p=>p.rarity===m);for(;l[m]<c[m]&&h.length!==0;){const p=k.nextInt(0,h.length-1),v=h[p];n.push(s(v)),l[m]+=1}});const f=i.filter(m=>m.rarity==="common");for(;n.length<t&&f.length>0;){const m=k.nextInt(0,f.length-1),u=f[m];n.push(s(u))}return Q(n)},F=(o,e,t)=>X(o,e,t,s=>({...s,instanceId:Y(s.id)})),j=(o,e,t)=>X(o,e,t,i=>{const n={...i,instanceId:Y(i.id)};return n.type==="room_enemy"&&n.stats.minUnits&&n.stats.maxUnits&&(n.units=de(n.stats.minUnits,n.stats.maxUnits)),n}),he=o=>o.roomHand.length<3&&!o.roomHand.some(e=>e.type==="room_boss"),me=o=>[...new Set(o.hand.map(t=>t.id))].length<2&&o.hand.length>0;function ue(o,e){const t=Math.max(0,Math.min(100,o)),s=Math.max(0,Math.min(100,e));return s>66?t<33?b.Anxiety:t<87?b.Arousal:b.Flow:s>33?t<33?b.Worry:t<67?b.Apathy:b.Control:t<67?b.Boredom:b.Relaxation}const M={hp:100,maxHp:100,power:5},fe=3;class C{constructor(e,t){this.hp=M.hp,this.maxHp=M.maxHp,this.power=M.power,this.skill=e.skill,this.challengeHistory=[50],this.flowState=b.Boredom,this.traits=e,this.inventory={weapon:null,armor:null,potions:[]},this.activeBuffs=[],this.logger=E.getInstance(),this.roomHistory=[],this.lootHistory=[],this.boredomCounter=0,this.firstName=t?t.firstNames[Math.floor(Math.random()*t.firstNames.length)]:"Testy",this.lastName=t?t.lastNames[Math.floor(Math.random()*t.lastNames.length)]:"McTest"}get challenge(){return this.challengeHistory.length===0?50:this.challengeHistory.reduce((t,s)=>t+s,0)/this.challengeHistory.length}modifySkill(e){const t=this.skill;this.skill=Math.max(0,Math.min(100,this.skill+e)),t.toFixed(1)!==this.skill.toFixed(1)&&this.logger.debug(`Skill changed from ${t.toFixed(1)} to ${this.skill.toFixed(1)}`),this.updateFlowState()}modifyChallenge(e){const t=this.challenge,s=Math.max(0,Math.min(100,e));this.challengeHistory.push(s),this.challengeHistory.length>fe&&this.challengeHistory.shift(),this.logger.debug(`Challenge changed from ${t.toFixed(1)} to ${this.challenge.toFixed(1)} (new value: ${s})`),this.updateFlowState()}updateFlowState(){const e=this.flowState;this.flowState=ue(this.skill,this.challenge),e!==this.flowState&&this.logger.info("info_flow_state_changed",{name:this.firstName,from:a("flow_states."+e),to:a("flow_states."+this.flowState)})}equip(e){e.type==="item_weapon"?this.inventory.weapon=e:e.type==="item_armor"&&(this.inventory.armor=e),this.recalculateStats()}addPotion(e){e.type==="item_potion"&&this.inventory.potions.push(e)}applyBuff(e){this.activeBuffs.push(e),this.recalculateStats()}updateBuffs(){const e=this.activeBuffs.filter(t=>t.stats.duration!==void 0&&t.stats.duration<=1);this.activeBuffs=this.activeBuffs.map(t=>(t.stats.duration&&(t.stats.duration-=1),t)).filter(t=>t.stats.duration===void 0||t.stats.duration>0),e.length>0&&this.recalculateStats()}recalculateStats(){const e=this.hp/this.maxHp;let t=M.power,s=M.maxHp;this.inventory.weapon&&(t+=this.inventory.weapon.stats.power||0,s+=this.inventory.weapon.stats.maxHp||0),this.inventory.armor&&(t+=this.inventory.armor.stats.power||0,s+=this.inventory.armor.stats.maxHp||0),this.activeBuffs.forEach(i=>{t+=i.stats.power||0,s+=i.stats.maxHp||0}),this.power=t,this.maxHp=s,this.hp=Math.round(this.maxHp*e)}toJSON(){return{hp:this.hp,maxHp:this.maxHp,power:this.power,traits:this.traits,inventory:this.inventory,activeBuffs:this.activeBuffs,skill:this.skill,challengeHistory:this.challengeHistory,flowState:this.flowState,roomHistory:this.roomHistory,lootHistory:this.lootHistory,boredomCounter:this.boredomCounter,firstName:this.firstName,lastName:this.lastName}}static fromJSON(e){const t=e.traits,s=new C(t);return s.hp=e.hp,s.maxHp=e.maxHp,s.power=e.power,s.inventory=e.inventory,s.activeBuffs=e.activeBuffs,s.skill=e.skill,s.challengeHistory=e.challengeHistory,s.flowState=e.flowState,s.roomHistory=e.roomHistory,s.lootHistory=e.lootHistory,s.boredomCounter=e.boredomCounter,s.firstName=e.firstName,s.lastName=e.lastName,s}}const pe=99,ge=10,P=10,K=32,_e=18,ve=8;var I=(o=>(o.WORKSHOP="workshop",o.ROOM_DECK_SIZE_INCREASE="room_deck_size_increase",o.HAND_SIZE_INCREASE="hand_size_increase",o.ADVENTURER_TRAITS="ADVENTURER_TRAITS",o.BP_MULTIPLIER="BP_MULTIPLIER",o.WORKSHOP_ACCESS="WORKSHOP_ACCESS",o.BP_MULTIPLIER_2="BP_MULTIPLIER_2",o))(I||{});const ee=[{feature:"workshop",runThreshold:2,title:()=>a("unlocks.workshop.title"),description:()=>a("unlocks.workshop.description")},{feature:"room_deck_size_increase",runThreshold:3,title:()=>a("unlocks.room_deck_size_increase.title"),description:()=>a("unlocks.room_deck_size_increase.description")},{feature:"hand_size_increase",runThreshold:4,title:()=>a("unlocks.hand_size_increase.title"),description:()=>a("unlocks.hand_size_increase.description")},{feature:"ADVENTURER_TRAITS",runThreshold:5,title:()=>a("unlocks.adventurer_traits.title"),description:()=>a("unlocks.adventurer_traits.description")},{feature:"BP_MULTIPLIER",runThreshold:8,title:()=>a("unlocks.bp_multiplier.title"),description:()=>a("unlocks.bp_multiplier.description")},{feature:"WORKSHOP_ACCESS",runThreshold:13,title:()=>a("unlocks.workshop_access.title"),description:()=>a("unlocks.workshop_access.description")},{feature:"BP_MULTIPLIER_2",runThreshold:21,title:()=>a("unlocks.bp_multiplier_2.title"),description:()=>a("unlocks.bp_multiplier_2.description")}],te=10;function se(o,e){var d,f,m,u;const{traits:t,inventory:s,hp:i,maxHp:n}=o;let r=(e.rarity==="uncommon"?2:e.rarity==="rare"?3:1)*5;const l=((d=s.weapon)==null?void 0:d.stats.power)||0,c=((f=s.armor)==null?void 0:f.stats.maxHp)||0;switch(e.type){case"item_weapon":const h=(e.stats.power||0)-l;if(h<=0&&e.id!==((m=s.weapon)==null?void 0:m.id))return-1;r+=h*(t.offense/10),h>0&&(r+=h*(o.skill/10));const p=e.stats.maxHp||0;p<0&&(r+=p*(100-t.resilience)/20);break;case"item_armor":const v=(e.stats.maxHp||0)-c;if(v<=0&&e.id!==((u=s.armor)==null?void 0:u.id))return-1;r+=v*(100-t.offense)/10,v>0&&(r+=v*(o.skill/10));const g=e.stats.power||0;g>0&&(r+=g*(t.offense/15));const y=e.stats.power||0;y<0&&(r+=y*(t.resilience/10));break;case"item_potion":const w=i/n;r+=10*(100-t.resilience)/100,w<.7&&(r+=20*(1-w)),r+=5*(o.skill/100),s.potions.length>=pe&&(r*=.1);break}return r}function be(o,e,t){t.debug(`--- Adventurer Loot Decision --- (Offense: ${o.traits.offense}, Resilience: ${o.traits.resilience}, Skill: ${o.skill})`);const s=e.map(r=>({item:r,score:se(o,r)})).filter(r=>r.score>0);if(s.sort((r,l)=>l.score-r.score),s.length===0||s[0].score<ge)return{choice:null,reason:a("game_engine.adventurer_declines_offer")};const i=s[0].item;t.debug(`Adventurer chooses: ${a("items_and_rooms."+i.id)} (Score: ${s[0].score.toFixed(1)})`);const n=a("game_engine.adventurer_accepts_offer",{itemName:a("items_and_rooms."+i.id)});return{choice:i,reason:n}}function we(o,e){const{flowState:t,hp:s,maxHp:i,inventory:n,traits:r}=o,l=s/i;if(n.potions.length===0)return"attack";let c=.5;switch(t){case b.Anxiety:case b.Worry:c=.8;break;case b.Arousal:case b.Flow:c=.6;break;case b.Control:case b.Relaxation:c=.4;break;case b.Boredom:case b.Apathy:c=.2;break}return c-=r.resilience/200,l<Math.max(.1,c)?"use_potion":"attack"}function ye(o,e,t){if(e){o.lootHistory.push(e.id),o.lootHistory.filter(n=>n===e.id).length>2&&(o.modifyChallenge(o.challenge-te),o.logger.info("info_repetitive_choice",{name:a("items_and_rooms."+e.id)}));const i=se(o,e);i>60?(o.modifySkill(10),o.modifyChallenge(o.challenge+5)):i>30?(o.modifySkill(5),o.modifyChallenge(o.challenge+2)):o.modifySkill(2)}else t.length>0?o.modifyChallenge(o.challenge-5):o.modifyChallenge(o.challenge-10);o.updateFlowState()}function Se(o,e){o.roomHistory.push(e.id),o.roomHistory.filter(i=>i===e.id).length>2&&(o.modifyChallenge(o.challenge-te),o.logger.info("info_deja_vu",{name:a("items_and_rooms."+e.id)}));let s=0;switch(e.type){case"room_enemy":s=5;break;case"room_boss":s=15;break;case"room_trap":s=10;break;case"room_healing":s=-15;break}o.modifyChallenge(o.challenge+s),o.updateFlowState()}function ke(o){o.modifySkill(-2),o.updateFlowState()}function q(o,e){switch(e){case"hit":o.modifySkill(.5);break;case"miss":o.modifySkill(-.5);break;case"take_damage":o.modifyChallenge(o.challenge+1);break}o.updateFlowState()}function xe(o,e,t,s){let i;return e>.7?(i=a("game_engine.too_close_for_comfort"),o.modifyChallenge(o.challenge+10),o.modifySkill(-3)):e>.4?(i=a("game_engine.great_battle"),o.modifyChallenge(o.challenge+5),o.modifySkill(5)):t>3&&o.traits.offense>60?(i=a("game_engine.easy_fight"),o.modifyChallenge(o.challenge-10)):(i=a("game_engine.worthy_challenge"),o.modifyChallenge(o.challenge-2),o.modifySkill(2)),t===s&&o.modifySkill(1*t),o.updateFlowState(),i}const _=E.getInstance();class Ee{constructor(e,t,s){this.gameState=null,this.isLoading=!0,this.error=null,this._allItems=[],this._allRooms=[],this._allNames={firstNames:[],lastNames:[]},this._listeners={},this.init=async()=>{await this._loadGameData()},this.startNewGame=i=>{this.metaManager.incrementAdventurers();const n={offense:k.nextInt(10,90),resilience:k.nextInt(10,90),skill:0};_.loadEntries([]);const r=new C(n,this._allNames),l=(i==null?void 0:i.items)||this._allItems.filter(g=>g.cost===null).map(g=>g.id),c=F(l,this._allItems,K),d=this._getHandSize(),f=c.slice(0,d),m=c.slice(d),u=(i==null?void 0:i.rooms)||this._allRooms.filter(g=>g.cost===null).map(g=>g.id),h=j(u,this._allRooms,this._getRoomDeckSize()),p=h.slice(0,d),v=h.slice(d);_.info("info_new_adventurer",{fullName:`${r.firstName} ${r.lastName}`,id:this.metaManager.metaState.adventurers.toString()}),this.gameState={phase:"DESIGNER_CHOOSING_ROOM",designer:{balancePoints:0},adventurer:r,unlockedDeck:l,availableDeck:m,hand:f,unlockedRoomDeck:u,availableRoomDeck:v,roomHand:p,handSize:d,shopItems:[],offeredLoot:[],offeredRooms:[],feedback:a("game_engine.new_adventurer"),run:1,room:1,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null},_.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),_.debug(`Deck size: ${c.length}, Hand size: ${d}, Room Deck size: ${h.length}, Room Hand size: ${p.length}`),this._emit("state-change",this.gameState)},this.continueGame=()=>{const i=this.gameSaver.load();i?(this.gameState=i,this._emit("state-change",this.gameState),this.gameState.phase==="AWAITING_ENCOUNTER_RESULT"&&this.gameState.encounterPayload&&this._emit("show-encounter",this.gameState.encounterPayload)):this.startNewGame()},this.startNewRun=i=>{if(!this.gameState)return;const n=i||this.gameState.run+1;this.metaManager.updateRun(n);const r=this._getHandSize(),l=F(this.gameState.unlockedDeck,this._allItems,K),c=l.slice(0,r),d=l.slice(r),f=j(this.gameState.unlockedRoomDeck,this._allRooms,this._getRoomDeckSize()),m=f.slice(0,r),u=f.slice(r),h=new C(this.gameState.adventurer.traits,this._allNames);h.skill=this.gameState.adventurer.skill,h.challengeHistory=[...this.gameState.adventurer.challengeHistory],h.flowState=this.gameState.adventurer.flowState,_.info("info_adventurer_returns"),_.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),this.gameState={...this.gameState,adventurer:h,phase:"DESIGNER_CHOOSING_ROOM",availableDeck:d,hand:c,availableRoomDeck:u,roomHand:m,handSize:r,room:1,run:n,feedback:a("game_engine.adventurer_returns"),runEnded:{isOver:!1,reason:"",success:!1,decision:null}},this._emit("state-change",this.gameState)},this.presentOffer=i=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_LOOT"||!this.gameState.hand)return;const n=this.gameState.hand.filter(w=>i.includes(w.instanceId));this.gameState.offeredLoot=n;const r=this.gameState.adventurer,{choice:l,reason:c}=be(r,this.gameState.offeredLoot,_),d=r.flowState;ye(r,l,this.gameState.offeredLoot),d!==r.flowState&&_.info("info_flow_state_changed_metrics",{event:"flow_state_changed",flowState:r.flowState}),l&&(_.info("info_item_chosen",{name:r.firstName,item:a("items_and_rooms."+l.id)}),_.info("info_item_chosen_metrics",{event:"item_chosen",item:l}));let f=this.gameState.hand,m=this.gameState.availableDeck;f.forEach(w=>w.justDrafted=!1);let u=f.filter(w=>!i.includes(w.instanceId));const h=this.gameState.handSize-u.length,p=m.slice(0,h);p.forEach(w=>{w.draftedRoom=this.gameState.room,w.justDrafted=!0});const v=m.slice(h);u.push(...p),l&&(l.type==="item_potion"?r.addPotion(l):l.type==="item_buff"?r.applyBuff(l):r.equip(l));const g=this.gameState.room+1,y=this.gameState.designer.balancePoints+this._getBpPerRoom();this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",adventurer:r,feedback:c,availableDeck:v,hand:u,room:g,designer:{balancePoints:y}},this._emit("state-change",this.gameState)},this.runEncounter=i=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_ROOM")return;this.gameState.offeredRooms=i;const n=k.nextInt(0,this.gameState.offeredRooms.length-1),r=this.gameState.offeredRooms[n];_.info("info_room_encountered_metrics",{event:"room_encountered",room:r});const{log:l,finalAdventurer:c,feedback:d}=this._generateEncounterLog(this.gameState.adventurer,r),f={room:r,log:l,finalAdventurer:c,feedback:d};this.gameState={...this.gameState,phase:"AWAITING_ENCOUNTER_RESULT",encounterPayload:f},this._emit("state-change",this.gameState),this._emit("show-encounter",f)},this.continueEncounter=()=>{!this.gameState||this.gameState.phase!=="AWAITING_ENCOUNTER_RESULT"||this._postEncounterUpdate()},this._postEncounterUpdate=()=>{if(!this.gameState)return;const i=C.fromJSON(this.gameState.encounterPayload.finalAdventurer),n=this.gameState.encounterPayload.feedback;i.updateBuffs(),this.gameState.designer.balancePoints+=this._getBpPerRoom();let r=this.gameState.roomHand,l=this.gameState.availableRoomDeck;r.forEach(h=>h.justDrafted=!1);const c=this.gameState.offeredRooms.map(h=>h.instanceId);let d=r.filter(h=>!c.includes(h.instanceId));const f=this.gameState.handSize-d.length,m=l.slice(0,f);m.forEach(h=>{h.draftedRoom=this.gameState.room,h.justDrafted=!0});const u=l.slice(f);if(d.push(...m),this.gameState.adventurer=i,i.hp<=0){this._endRun(a("game_engine.adventurer_fell",{room:this.gameState.room,run:this.gameState.run}));return}if(i.boredomCounter>2){const h=i.flowState===b.Boredom?a("game_engine.adventurer_bored",{room:this.gameState.room,run:this.gameState.run}):a("game_engine.adventurer_apathy",{room:this.gameState.room,run:this.gameState.run});this._endRun(h);return}this.gameState.hand&&this.gameState.hand.length===0?(_.warn("warn_empty_hand"),n.push(a("game_engine.empty_hand")),this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",room:this.gameState.room+1,designer:{balancePoints:this.gameState.designer.balancePoints+this._getBpPerRoom()},feedback:n,encounterPayload:void 0,roomHand:d,availableRoomDeck:u}):this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_LOOT",feedback:n,encounterPayload:void 0,roomHand:d,availableRoomDeck:u},this._emit("state-change",this.gameState)},this.forceEndRun=()=>{this.gameState&&(this.gameState.adventurer.modifyChallenge(-20),this.gameState.adventurer.updateFlowState(),this._endRun(a("game_engine.no_more_rooms"),!0))},this.enterWorkshop=()=>{if(!this.gameState)return;if(_.info("info_entering_workshop",{name:this.gameState.adventurer.firstName}),!this.metaManager.acls.has(I.WORKSHOP)){_.info("info_workshop_not_unlocked"),this.startNewRun();return}const i=this.gameState.run+1,n=this._allItems.filter(c=>c.cost!==null).filter(c=>!this.gameState.unlockedDeck.includes(c.id)),r=this._allRooms.filter(c=>c.cost!==null).filter(c=>!this.gameState.unlockedRoomDeck.includes(c.id)),l=[...n,...r];this.gameState={...this.gameState,phase:"SHOP",shopReturnPhase:this.gameState.phase,run:i,room:0,shopItems:Q(l).slice(0,4),runEnded:{isOver:!1,reason:"",success:!1,decision:null},feedback:a("game_engine.welcome_to_workshop")},this._emit("state-change",this.gameState)},this.exitWorkshop=()=>{this.gameState&&this.startNewRun()},this.purchaseItem=i=>{if(!this.gameState)return;const n=this._allItems.find(p=>p.id===i),r=this._allRooms.find(p=>p.id===i),l=n||r;if(!l||l.cost===null||this.gameState.designer.balancePoints<l.cost)return;let c=this.gameState.unlockedDeck,d=this.gameState.unlockedRoomDeck,f=this.gameState.availableDeck,m=this.gameState.availableRoomDeck;n?(c=[...this.gameState.unlockedDeck,i],this.isWorkshopAccessUnlocked()&&(f=[n,...this.gameState.availableDeck])):r&&(d=[...this.gameState.unlockedRoomDeck,i],this.isWorkshopAccessUnlocked()&&(m=[r,...this.gameState.availableRoomDeck]));const u=this.gameState.designer.balancePoints-l.cost,h=this.gameState.shopItems.filter(p=>p.id!==i);_.info("info_item_purchased",{name:this.gameState.adventurer.firstName,item:a("items_and_rooms."+l.id)}),_.info("info_item_purchased_metrics",{event:"item_purchased",item:l}),this.gameState={...this.gameState,designer:{balancePoints:u},unlockedDeck:c,unlockedRoomDeck:d,availableDeck:f,availableRoomDeck:m,shopItems:h},this._emit("state-change",this.gameState)},this.quitGame=(i=!0)=>{i&&this.gameSaver.clear(),this.showMenu()},this.showMenu=()=>{this.gameState={...this.gameState||this._getInitialGameState(),phase:"MENU"},this._emit("state-change",this.gameState)},this._getBpPerRoom=()=>this.metaManager.acls.has(I.BP_MULTIPLIER_2)?P*4:this.metaManager.acls.has(I.BP_MULTIPLIER)?P*2:P,this.saveGame=()=>{this.gameState&&this.gameState.phase!=="MENU"&&this.gameState.phase!=="RUN_OVER"&&this.gameSaver.save(this.gameState)},this.metaManager=e,this.dataLoader=t,this.gameSaver=s}on(e,t){this._listeners[e]||(this._listeners[e]=[]),this._listeners[e].push(t)}_emit(e,...t){e==="state-change"&&this.saveGame();const s=this._listeners[e];s&&s.forEach(i=>i(...t))}_createAdventurerSnapshot(e){return{firstName:e.firstName,lastName:e.lastName,hp:e.hp,maxHp:e.maxHp,power:e.power,flowState:e.flowState,inventory:JSON.parse(JSON.stringify(e.inventory))}}_generateEncounterLog(e,t){var l;const s=[],i=[],n=C.fromJSON(e.toJSON());_.info("info_encounter",{name:n.firstName,roomName:a("items_and_rooms."+t.id)});const r=n.flowState;switch(Se(n,t),r!==n.flowState&&_.info("info_flow_state_changed_metrics",{event:"flow_state_changed",flowState:n.flowState}),s.push({messageKey:"log_messages.info_encounter",replacements:{name:n.firstName,roomName:a("items_and_rooms."+t.id)},adventurer:this._createAdventurerSnapshot(n)}),t.type){case"room_enemy":case"room_boss":{const c={enemyCount:t.units??1,enemyPower:t.stats.attack||5,enemyHp:t.stats.hp||10};let d=0;const f=n.hp;for(let v=0;v<c.enemyCount;v++){let g=c.enemyHp;_.info("info_encounter_enemy",{name:n.firstName,current:v+1,total:c.enemyCount});const y=t.entity_id?a("entities."+t.entity_id):a("items_and_rooms."+t.id),w={currentHp:g,maxHp:c.enemyHp,power:c.enemyPower,name:y,count:v+1,total:c.enemyCount};for(s.push({messageKey:"log_messages.info_encounter_enemy",replacements:{name:n.firstName,current:v+1,total:c.enemyCount},adventurer:this._createAdventurerSnapshot(n),enemy:w});g>0&&n.hp>0;){if(we(n)==="use_potion"){const S=n.inventory.potions.shift();if(S){const x=S.stats.hp||0;n.hp=Math.min(n.maxHp,n.hp+x),_.info("info_adventurer_drinks_potion",{name:n.firstName,potionName:a("items_and_rooms."+S.id)}),i.push(a("game_engine.adventurer_drinks_potion",{potionName:a("items_and_rooms."+S.id)})),s.push({messageKey:"log_messages.info_adventurer_drinks_potion",replacements:{name:n.firstName,potionName:a("items_and_rooms."+S.id)},adventurer:this._createAdventurerSnapshot(n),enemy:{...w,currentHp:g}})}}else{const S=Math.min(.95,.75+n.traits.skill/500+n.traits.offense/1e3);if(k.nextFloat()<S){const x=n.power;g-=x,_.debug(`Adventurer hits for ${x} damage.`);const A=n.flowState;q(n,"hit"),A!==n.flowState&&(_.info("info_flow_state_changed_metrics",{event:"flow_state_changed",flowState:n.flowState}),s.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:n.firstName,from:a(`flow_states.${A}`),to:a(`flow_states.${n.flowState}`)},adventurer:this._createAdventurerSnapshot(n),enemy:{...w,currentHp:g}})),s.push({messageKey:"log_messages.info_adventurer_hit",replacements:{damage:x},adventurer:this._createAdventurerSnapshot(n),enemy:{...w,currentHp:g},animations:[{target:"adventurer",animation:"attack"},{target:"enemy",animation:"shake"}]})}else{_.debug("Adventurer misses.");const x=n.flowState;q(n,"miss"),x!==n.flowState&&(_.info("info_flow_state_changed_metrics",{event:"flow_state_changed",flowState:n.flowState}),s.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:n.firstName,from:a(`flow_states.${x}`),to:a(`flow_states.${n.flowState}`)},adventurer:this._createAdventurerSnapshot(n),enemy:{...w,currentHp:g}})),s.push({messageKey:"log_messages.info_adventurer_miss",adventurer:this._createAdventurerSnapshot(n),enemy:{...w,currentHp:g},animations:[{target:"adventurer",animation:"attack"}]})}}if(g<=0){_.info("info_enemy_defeated"),d++,s.push({messageKey:"log_messages.info_enemy_defeated",adventurer:this._createAdventurerSnapshot(n),enemy:{...w,currentHp:0},animations:[{target:"enemy",animation:"defeat"}]});break}const L=Math.max(.4,.75-n.traits.skill/500-(100-n.traits.offense)/1e3);if(k.nextFloat()<L){const S=(((l=n.inventory.armor)==null?void 0:l.stats.maxHp)||0)/10,x=Math.max(1,c.enemyPower-S);n.hp-=x,_.debug(`Enemy hits for ${x} damage.`);const A=n.flowState;q(n,"take_damage"),A!==n.flowState&&(_.info("info_flow_state_changed_metrics",{event:"flow_state_changed",flowState:n.flowState}),s.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:n.firstName,from:a(`flow_states.${A}`),to:a(`flow_states.${n.flowState}`)},adventurer:this._createAdventurerSnapshot(n),enemy:{...w,currentHp:g}})),s.push({messageKey:"log_messages.info_enemy_hit",replacements:{damage:x},adventurer:this._createAdventurerSnapshot(n),enemy:{...w,currentHp:g},animations:[{target:"enemy",animation:"attack"},{target:"adventurer",animation:"shake"}]})}else _.debug("Enemy misses."),s.push({messageKey:"log_messages.info_enemy_miss",adventurer:this._createAdventurerSnapshot(n),enemy:{...w,currentHp:g},animations:[{target:"enemy",animation:"attack"}]})}if(n.hp<=0){_.warn("info_adventurer_defeated",{name:n.firstName}),s.push({messageKey:"log_messages.info_adventurer_defeated",replacements:{name:n.firstName},adventurer:this._createAdventurerSnapshot(n),enemy:{...w,currentHp:g},animations:[{target:"adventurer",animation:"defeat"}]});break}}const m=f-n.hp,u=m/n.maxHp;_.debug(`hpLost: ${m}, hpLostRatio: ${u.toFixed(2)}`);const h=n.flowState,p=xe(n,u,d,c.enemyCount);h!==n.flowState&&_.info("info_flow_state_changed_metrics",{event:"flow_state_changed",flowState:n.flowState}),i.push(p);break}case"room_healing":{const c=t.stats.hp||0;n.hp=Math.min(n.maxHp,n.hp+c),_.info("info_healing_room",{name:n.firstName,healingRoomName:a("items_and_rooms."+t.id),healing:c}),i.push(a("game_engine.healing_room",{name:a("items_and_rooms."+t.id),healing:c})),s.push({messageKey:"log_messages.info_healing_room",replacements:{name:n.firstName,healingRoomName:a("items_and_rooms."+t.id),healing:c},adventurer:this._createAdventurerSnapshot(n)});break}case"room_trap":{const c=t.stats.attack||0;n.hp-=c;const d=n.flowState;ke(n),d!==n.flowState&&_.info("info_flow_state_changed_metrics",{event:"flow_state_changed",flowState:n.flowState}),_.info("info_trap_room",{name:n.firstName,trapName:a("items_and_rooms."+t.id),damage:c}),i.push(a("game_engine.trap_room",{name:a("items_and_rooms."+t.id),damage:c})),s.push({messageKey:"log_messages.info_trap_room",replacements:{name:n.firstName,trapName:a("items_and_rooms."+t.id),damage:c},adventurer:this._createAdventurerSnapshot(n)});break}}return{log:s,finalAdventurer:n,feedback:i}}_endRun(e,t=!1){if(!this.gameState)return;this.metaManager.updateRun(this.gameState.run);const s=this.metaManager.checkForUnlocks(this.gameState.run);_.debug(`Run ended with ${this.gameState.designer.balancePoints} BP.`),_.info("info_run_end_metrics",{event:"run_end",bp:this.gameState.designer.balancePoints}),_.error("info_game_over",{reason:e});const i=this._getAdventurerEndRunDecision();this.gameState={...this.gameState,phase:"RUN_OVER",runEnded:{isOver:!0,reason:e,success:t,decision:i},newlyUnlocked:s},this._emit("state-change",this.gameState)}_getAdventurerEndRunDecision(){if(!this.gameState)return"retire";const{flowState:e,traits:t,skill:s}=this.gameState.adventurer,{resilience:i,offense:n}=t,r=Math.min(s/100,1);if(e===b.Flow)return"continue";let l=.55;switch(e){case b.Anxiety:l+=.25-i/400;break;case b.Arousal:l-=.1-n/1e3;break;case b.Worry:l+=.2;break;case b.Control:l-=.15;break;case b.Relaxation:l+=.1;break;case b.Boredom:l+=.3;break;case b.Apathy:l+=.4;break}return l-=r*.1,l=Math.max(.05,Math.min(.95,l)),k.nextFloat()<l?"retire":"continue"}handleEndOfRun(e){if(this.gameState){if(_.info("info_adventurer_decision",{name:this.gameState.adventurer.firstName,decision:e}),e==="retire"){this.quitGame(!0);return}this.enterWorkshop()}}_getInitialGameState(){const e={offense:k.nextInt(10,90),resilience:k.nextInt(10,90),skill:0},t=new C(e,this._allNames);return{phase:"MENU",designer:{balancePoints:0},adventurer:t,unlockedDeck:[],availableDeck:[],hand:[],unlockedRoomDeck:[],availableRoomDeck:[],roomHand:[],handSize:this._getHandSize(),shopItems:[],offeredLoot:[],offeredRooms:[],feedback:"",run:0,room:0,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null}}_getHandSize(){return this.metaManager.acls.has(I.HAND_SIZE_INCREASE)?12:ve}_getRoomDeckSize(){return this.metaManager.acls.has(I.ROOM_DECK_SIZE_INCREASE)?36:_e}isWorkshopAccessUnlocked(){return this.metaManager.acls.has(I.WORKSHOP_ACCESS)}isWorkshopUnlocked(){return this.metaManager.acls.has(I.WORKSHOP)}hasSaveGame(){return this.gameSaver.hasSaveGame()}async _loadGameData(){try{this._allItems=await this.dataLoader.loadJson("game/items.json"),this._allRooms=await this.dataLoader.loadJson("game/rooms.json"),this._allNames=await this.dataLoader.loadJson("game/names.json")}catch(e){this.error=e.message||a("global.unknown_error"),this._emit("error",null)}finally{this.isLoading=!1,this._emit("state-change",this.gameState)}}}class Ie extends HTMLElement{constructor(){super(),this.isDesktop=!0,this.attachShadow({mode:"open"}),this.onclick=t=>{window.matchMedia("(pointer: coarse)").matches&&t.target===this&&this.hide()};const e=document.createElement("style");e.textContent=`
  ...
  <div class="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-6">
    ...
    `}}customElements.define("choice-card",Ze);const z=4;class Ve extends HTMLElement{constructor(){super(),this._choices=[],this._deckType="item",this.engine=null,this._disabled=!1,this._selectedIds=[],this._initialRender=!0,this._offerImpossible=!1,this._roomSelectionImpossible=!1,this.addEventListener("card-select",e=>{const{instanceId:t}=e.detail;this.handleSelect(t)}),this.addEventListener("click",e=>{if(e.target.id==="present-offer-button"&&this.engine)if(this._deckType==="item")this.engine.presentOffer(this._selectedIds);else if(this._roomSelectionImpossible)this.engine.forceEndRun();else{const s=this._choices.filter(i=>this._selectedIds.includes(i.instanceId));this.engine.runEncounter(s)}})}set choices(e){this._choices=e,this._initialRender=!0,this.render()}get choices(){return this._choices}set deckType(e){this._deckType=e,this.render()}get deckType(){return this._deckType}set disabled(e){this._disabled=e,this.render()}get disabled(){return this._disabled}set offerImpossible(e){this._offerImpossible=e,this.render()}get offerImpossible(){return this._offerImpossible}set roomSelectionImpossible(e){this._roomSelectionImpossible=e,this.render()}get roomSelectionImpossible(){return this._roomSelectionImpossible}connectedCallback(){this.render()}handleSelect(e){if(this._disabled)return;const t=this._choices.find(i=>i.instanceId===e);if(!t)return;const s=this._selectedIds.includes(e);if(this._deckType==="room"){const i=t.type==="room_boss";if(s)this._selectedIds=this._selectedIds.filter(n=>n!==e);else{const r=this._choices.filter(l=>this._selectedIds.includes(l.instanceId)).some(l=>l.type==="room_boss");i&&this._selectedIds.length===0?this._selectedIds.push(e):!i&&!r&&this._selectedIds.length<3&&this._selectedIds.push(e)}}else{const n=this._choices.filter(l=>l.id===t.id).map(l=>l.instanceId);n.some(l=>this._selectedIds.includes(l))?this._selectedIds=this._selectedIds.filter(l=>!n.includes(l)):this._selectedIds.length<z&&this._selectedIds.push(e)}this.render()}render(){if(!this._choices)return;const e=this._choices.filter(u=>u.justDrafted&&this._initialRender);if(e.length>0&&this._initialRender){this._initialRender=!1;const u=e.map(h=>{const p=document.createElement("choice-card");return p.item=h,p.isSelectable=!1,p.outerHTML}).join("");N.show(a("choice_panel.new_items_title"),`<div class="grid grid-cols-1 md:grid-cols-3 gap-4 cards-container">${u}</div>`,[{text:a("global.continue"),value:void 0}]).then(()=>{this._choices.forEach(h=>h.justDrafted=!1),this.render()});return}const t={item_weapon:0,item_armor:1,item_potion:2,item_buff:3},s={room_enemy:0,room_trap:1,room_healing:2,room_boss:3},i=["attack","hp","power","maxHp"],n=[...this._choices].sort((u,h)=>{var y,w;const p=this._deckType==="item"?t:s,v=u.type,g=h.type;if(v in p&&g in p){const T=p[v]-p[g];if(T!==0)return T}for(const T of i){const L=((y=u.stats)==null?void 0:y[T])??null,S=((w=h.stats)==null?void 0:w[T])??null;if(L!==null&&S!==null){if(L!==S)return L-S}else{if(L!==null)return-1;if(S!==null)return 1}}return 0}),r=this._deckType==="room";let l;if(r)l=n;else{const u=new Map;n.forEach(h=>{const p=h;u.has(p.id)?u.get(p.id).count++:u.set(p.id,{choice:p,count:1})}),l=Array.from(u.values()).map(h=>({...h.choice,stackCount:h.count}))}a(r?"choice_panel.title_room":"choice_panel.title");let c=a(r?"choice_panel.begin_encounter":"choice_panel.present_offer");this._offerImpossible?c=a("choice_panel.continue_without_loot"):this._roomSelectionImpossible&&(c=a("choice_panel.roll_credits"));let d=!1,f=c;this._offerImpossible||this._roomSelectionImpossible?d=!0:r?this._choices.filter(p=>this._selectedIds.includes(p.instanceId)).some(p=>p.type==="room_boss")?(d=this._selectedIds.length===1,f=`${c} (1/1)`):(d=this._selectedIds.length===3,f=`${c} (${this._selectedIds.length}/3)`):(d=this._selectedIds.length>=2&&this._selectedIds.length<=z,f=`${c} (${this._selectedIds.length}/${z})`),this.innerHTML=`
        <div class="p-2">
    ...
    `;const m=this.querySelector("#loot-card-container");m&&l.forEach(u=>{const h=document.createElement("choice-card");h.item=u,"stackCount"in u&&(h.stackCount=u.stackCount),h.isSelected=this._selectedIds.includes(u.instanceId);let p=this._disabled;if(this._offerImpossible)p=!0;else if(r){const v=this._choices.filter(y=>this._selectedIds.includes(y.instanceId)),g=v.some(y=>y.type==="room_boss");h.isSelected?p=!1:(g||u.type==="room_boss"&&v.length>0||v.length>=3)&&(p=!0)}else{const v=new Map(this._choices.map(w=>[w.instanceId,w.id])),g=this._selectedIds.map(w=>v.get(w));p=!h.isSelected&&g.includes(u.id)||this._disabled}h.isDisabled=p,h.isNewlyDrafted=u.justDrafted&&this._initialRender||!1,m.appendChild(h)}),setTimeout(()=>{this._initialRender=!1},0)}}customElements.define("choice-panel",Ve);class Je extends HTMLElement{constructor(){super(),this._items=[],this._balancePoints=0,this.engine=null,this.addEventListener("click",e=>{const t=e.target,s=t.dataset.itemId;s&&this.engine&&this.engine.purchaseItem(s),t.id==="start-run-button"&&this.engine&&this.engine.startNewRun()})}set items(e){this._items=e,this.render()}set balancePoints(e){this._balancePoints=e,this.render()}connectedCallback(){this.render()}async render(){this.innerHTML=`
    ...
    `;const e=this.querySelector("#item-cards");if(e){e.innerHTML="";for(const t of this._items){const s=document.createElement("choice-card");s.item=t,s.purchaseInfo={cost:t.cost||0,canAfford:this._balancePoints>=(t.cost||0)},e.appendChild(s)}}}}customElements.define("workshop-screen",Je);class Ye extends HTMLElement{constructor(){super(),this.engine=null,this.metaManager=null,this.addEventListener("click",async e=>{if(!this.engine||!this.metaManager)return;const t=e.target;t.id==="new-game-button"?(this.metaManager.metaState.adventurers>0||this.metaManager.metaState.highestRun>0,this.engine.hasSaveGame()?await G.show(a("menu.new_game"),a("menu.new_game_confirm"))&&this.engine.startNewGame():this.engine.startNewGame()):t.id==="continue-game-button"?this.engine.continueGame():t.id==="reset-game-button"&&await G.show(a("menu.reset_save"),a("menu.reset_save_confirm"))&&(this.metaManager.reset(),this.engine.quitGame(!0),this.render())})}connectedCallback(){this.render()}render(){if(!this.metaManager||!this.engine)return;const e=this.metaManager.metaState,t=this.engine.hasSaveGame();let s="";if(t){const i=e.adventurers||0;s=`
      ...
      <div class="window" style="width: 400px;">
        ...
        <div class="status-bar">
          ...
          <p class="status-bar-field">build 161</p>
        </div>
      </div>
    `}}customElements.define("menu-screen",Ye);const Qe=3e3,Xe=900;class ne extends HTMLElement{constructor(){super(),this.onDismiss=()=>{},this.payload=null,this.currentEventIndex=0,this.battleSpeed=Xe,this.modalState="reveal"}connectedCallback(){if(!this.payload)return;this.innerHTML=`
    ...
    `}updateProgressBar(){if(!this.payload)return;const e=this.currentEventIndex/(this.payload.log.length-1);this.querySelector("#progress-container progress").value=e*100}appendLog(e){const t=this.querySelector("#event-log"),s=document.createElement("li");s.textContent=e,t.appendChild(s),t.scrollTop=t.scrollHeight}dismiss(e){clearTimeout(this.battleTimeout),this.querySelector("#progress-container").classList.add("hidden"),this.querySelector("#slider-container").classList.add("hidden"),this.remove(),this.onDismiss({skipped:e})}static show(e){return new Promise(t=>{const s=document.createElement("encounter-modal");s.payload=e,s.onDismiss=t,document.body.appendChild(s)})}}customElements.define("encounter-modal",ne);const et=Object.freeze(Object.defineProperty({__proto__:null,EncounterModal:ne},Symbol.toStringTag,{value:"Module"})),$=document.getElementById("app");if(!$)throw new Error("Could not find app element to mount to");async function tt(){$.innerHTML="<div>Initializing...</div>";const o=new Me;await le(o);const e=new Ae,t=new He(e),s=new Ne(e),i=new Ee(t,o,s);i.on("state-change",n=>{if(i.isLoading){$.innerHTML=`<div>${a("global.loading_game_data")}</div>`;return}if(i.error){$.innerHTML=`
            ...
            `;return}Le($,n,i),O.initializeTooltipIcons()}),i.on("show-encounter",async n=>{const{EncounterModal:r}=await oe(async()=>{const{EncounterModal:l}=await Promise.resolve().then(()=>et);return{EncounterModal:l}},void 0);await r.show(n),i.continueEncounter()}),$.innerHTML=`<div>${a("global.initializing")}</div>`,document.body.addEventListener("mouseover",n=>O.handleMouseEnter(n)),document.body.addEventListener("click",n=>O.handleClick(n)),await i.init(),i.showMenu()}tt().catch(o=>{console.error(o),$&&($.innerHTML=`
      <div class="min-h-screen flex items-center justify-center p-4">
          <div class="bg-brand-surface p-8 rounded-xl shadow-2xl text-center border border-brand-secondary">
