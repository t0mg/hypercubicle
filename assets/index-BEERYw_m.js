(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(i){if(i.ep)return;i.ep=!0;const a=t(i);fetch(i.href,a)}})();var b=(n=>(n[n.Arousal=0]="Arousal",n[n.Flow=1]="Flow",n[n.Control=2]="Control",n[n.Relaxation=3]="Relaxation",n[n.Boredom=4]="Boredom",n[n.Apathy=5]="Apathy",n[n.Worry=6]="Worry",n[n.Anxiety=7]="Anxiety",n))(b||{});let J={};async function V(n,e){try{J=await e.loadJson(`locales/${n}.json`)}catch(t){console.warn(`Failed to load ${n} translations:`,t),n!=="en"&&await V("en",e)}}function ie(){return typeof navigator<"u"&&navigator.language?navigator.language.split("-")[0]:"en"}function o(n,e={}){let s=n.split(".").reduce((i,a)=>i?i[a]:void 0,J);if(!s)return console.warn(`Translation not found for key: ${n}`),n;for(const i in e)s=s.replace(`{${i}}`,String(e[i]));return s}async function oe(n){const e=ie();await V(e,n)}class k{constructor(){this.entries=[],this.listeners=[],this.muted=!1}static getInstance(){return k.instance||(k.instance=new k),k.instance}on(e){this.listeners.push(e)}log(e,t="INFO",s){const i=o(`log_messages.${e}`,s),a={message:i,level:t,timestamp:Date.now(),data:s};this.muted||(this.entries.push(a),t!=="DEBUG"&&console.log(`[${t}] ${i}`)),this.listeners.forEach(r=>r(a))}debug(e){const t={message:e,level:"DEBUG",timestamp:Date.now()};this.muted||this.entries.push(t),this.listeners.forEach(s=>s(t))}info(e,t){this.log(e,"INFO",t)}warn(e,t){this.log(e,"WARN",t)}error(e,t){this.log(e,"ERROR",t)}toJSON(){return{entries:this.entries}}loadEntries(e){this.entries=e||[]}static fromJSON(e){const t=k.getInstance();return t.loadEntries(e.entries),t}}class ae{constructor(e){this.seed=e}setSeed(e){this.seed=e}nextFloat(){let e=this.seed+=1831565813;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}nextInt(e,t){return Math.floor(this.nextFloat()*(t-e+1))+e}}const y=new ae(Date.now()),Q=n=>`${n}_${y.nextFloat().toString(36).substr(2,9)}`,re=(n,e)=>y.nextInt(n,e),Y=n=>{const e=[...n];for(let t=e.length-1;t>0;t--){const s=y.nextInt(0,t);[e[t],e[s]]=[e[s],e[t]]}return e},X=(n,e,t,s)=>{const i=e.filter(d=>n.includes(d.id)),a=[],r={common:.6,uncommon:.3,rare:.1,legendary:0},l={common:0,uncommon:0,rare:0,legendary:0},c={common:0,uncommon:0,rare:0,legendary:0};Object.keys(r).forEach(d=>{c[d]=Math.floor(t*r[d])});let u=Object.values(c).reduce((d,g)=>d+g,0);for(;u<t;)c.common+=1,u+=1;i.filter(d=>d.cost!==null).forEach(d=>{a.push(s(d)),l[d.rarity]+=1}),Object.keys(r).forEach((d,g)=>{const h=i.filter(p=>p.rarity===d);for(;l[d]<c[d]&&h.length!==0;){const p=y.nextInt(0,h.length-1),f=h[p];a.push(s(f)),l[d]+=1}});const m=i.filter(d=>d.rarity==="common");for(;a.length<t&&m.length>0;){const d=y.nextInt(0,m.length-1),g=m[d];a.push(s(g))}return Y(a)},U=(n,e,t)=>X(n,e,t,s=>({...s,instanceId:Q(s.id)})),F=(n,e,t)=>X(n,e,t,i=>{const a={...i,instanceId:Q(i.id)};return a.type==="room_enemy"&&a.stats.minUnits&&a.stats.maxUnits&&(a.units=re(a.stats.minUnits,a.stats.maxUnits)),a}),le=n=>n.roomHand.length<3&&!n.roomHand.some(e=>e.type==="room_boss"),ce=n=>[...new Set(n.hand.map(t=>t.id))].length<2&&n.hand.length>0;function de(n,e){const t=Math.max(0,Math.min(100,n)),s=Math.max(0,Math.min(100,e));return s>66?t<33?b.Anxiety:t<87?b.Arousal:b.Flow:s>33?t<33?b.Worry:t<67?b.Apathy:b.Control:t<67?b.Boredom:b.Relaxation}const L={hp:100,maxHp:100,power:5},he=3;class T{constructor(e){this.hp=L.hp,this.maxHp=L.maxHp,this.power=L.power,this.skill=e.skill,this.challengeHistory=[50],this.flowState=b.Boredom,this.traits=e,this.inventory={weapon:null,armor:null,potions:[]},this.activeBuffs=[],this.logger=k.getInstance(),this.roomHistory=[],this.lootHistory=[],this.boredomCounter=0}get challenge(){return this.challengeHistory.length===0?50:this.challengeHistory.reduce((t,s)=>t+s,0)/this.challengeHistory.length}modifySkill(e){const t=this.skill;this.skill=Math.max(0,Math.min(100,this.skill+e)),t.toFixed(1)!==this.skill.toFixed(1)&&this.logger.debug(`Skill changed from ${t.toFixed(1)} to ${this.skill.toFixed(1)}`),this.updateFlowState()}modifyChallenge(e){const t=this.challenge,s=Math.max(0,Math.min(100,e));this.challengeHistory.push(s),this.challengeHistory.length>he&&this.challengeHistory.shift(),this.logger.debug(`Challenge changed from ${t.toFixed(1)} to ${this.challenge.toFixed(1)} (new value: ${s})`),this.updateFlowState()}updateFlowState(){const e=this.flowState;this.flowState=de(this.skill,this.challenge),e!==this.flowState&&this.logger.info("info_flow_state_changed",{from:o("flow_states."+b[e]),to:o("flow_states."+b[this.flowState])})}equip(e){e.type==="item_weapon"?this.inventory.weapon=e:e.type==="item_armor"&&(this.inventory.armor=e),this.recalculateStats()}addPotion(e){e.type==="item_potion"&&this.inventory.potions.push(e)}applyBuff(e){this.activeBuffs.push(e),this.recalculateStats()}updateBuffs(){const e=this.activeBuffs.filter(t=>t.stats.duration!==void 0&&t.stats.duration<=1);this.activeBuffs=this.activeBuffs.map(t=>(t.stats.duration&&(t.stats.duration-=1),t)).filter(t=>t.stats.duration===void 0||t.stats.duration>0),e.length>0&&this.recalculateStats()}recalculateStats(){const e=this.hp/this.maxHp;let t=L.power,s=L.maxHp;this.inventory.weapon&&(t+=this.inventory.weapon.stats.power||0,s+=this.inventory.weapon.stats.maxHp||0),this.inventory.armor&&(t+=this.inventory.armor.stats.power||0,s+=this.inventory.armor.stats.maxHp||0),this.activeBuffs.forEach(i=>{t+=i.stats.power||0,s+=i.stats.maxHp||0}),this.power=t,this.maxHp=s,this.hp=Math.round(this.maxHp*e)}toJSON(){return{hp:this.hp,maxHp:this.maxHp,power:this.power,traits:this.traits,inventory:this.inventory,activeBuffs:this.activeBuffs,skill:this.skill,challengeHistory:this.challengeHistory,flowState:this.flowState,roomHistory:this.roomHistory,lootHistory:this.lootHistory,boredomCounter:this.boredomCounter}}static fromJSON(e,t){const s=e.traits,i=new T(s);return i.hp=e.hp,i.maxHp=e.maxHp,i.power=e.power,i.inventory=e.inventory,i.activeBuffs=e.activeBuffs,i.skill=e.skill,i.challengeHistory=e.challengeHistory,i.flowState=e.flowState,i.roomHistory=e.roomHistory,i.lootHistory=e.lootHistory,i.boredomCounter=e.boredomCounter,i}}const me=99,ue=10,N=10,j=32,pe=18,ge=8;var w=(n=>(n.WORKSHOP="workshop",n.ROOM_DECK_SIZE_INCREASE="room_deck_size_increase",n.HAND_SIZE_INCREASE="hand_size_increase",n.ADVENTURER_TRAITS="ADVENTURER_TRAITS",n.BP_MULTIPLIER="BP_MULTIPLIER",n.WORKSHOP_ACCESS="WORKSHOP_ACCESS",n.BP_MULTIPLIER_2="BP_MULTIPLIER_2",n))(w||{});const ee=[{feature:"workshop",runThreshold:2,title:()=>o("unlocks.workshop.title"),description:()=>o("unlocks.workshop.description")},{feature:"room_deck_size_increase",runThreshold:3,title:()=>o("unlocks.room_deck_size_increase.title"),description:()=>o("unlocks.room_deck_size_increase.description")},{feature:"hand_size_increase",runThreshold:4,title:()=>o("unlocks.hand_size_increase.title"),description:()=>o("unlocks.hand_size_increase.description")},{feature:"ADVENTURER_TRAITS",runThreshold:5,title:()=>o("unlocks.adventurer_traits.title"),description:()=>o("unlocks.adventurer_traits.description")},{feature:"BP_MULTIPLIER",runThreshold:8,title:()=>o("unlocks.bp_multiplier.title"),description:()=>o("unlocks.bp_multiplier.description")},{feature:"WORKSHOP_ACCESS",runThreshold:13,title:()=>o("unlocks.workshop_access.title"),description:()=>o("unlocks.workshop_access.description")},{feature:"BP_MULTIPLIER_2",runThreshold:21,title:()=>o("unlocks.bp_multiplier_2.title"),description:()=>o("unlocks.bp_multiplier_2.description")}],te=10;function se(n,e){var u,m,d,g;const{traits:t,inventory:s,hp:i,maxHp:a}=n;let r=(e.rarity==="uncommon"?2:e.rarity==="rare"?3:1)*5;const l=((u=s.weapon)==null?void 0:u.stats.power)||0,c=((m=s.armor)==null?void 0:m.stats.maxHp)||0;switch(e.type){case"item_weapon":const h=(e.stats.power||0)-l;if(h<=0&&e.id!==((d=s.weapon)==null?void 0:d.id))return-1;r+=h*(t.offense/10),h>0&&(r+=h*(n.skill/10));const p=e.stats.maxHp||0;p<0&&(r+=p*(100-t.resilience)/20);break;case"item_armor":const f=(e.stats.maxHp||0)-c;if(f<=0&&e.id!==((g=s.armor)==null?void 0:g.id))return-1;r+=f*(100-t.offense)/10,f>0&&(r+=f*(n.skill/10));const _=e.stats.power||0;_>0&&(r+=_*(t.offense/15));const v=e.stats.power||0;v<0&&(r+=v*(t.resilience/10));break;case"item_potion":const S=i/a;r+=10*(100-t.resilience)/100,S<.7&&(r+=20*(1-S)),r+=5*(n.skill/100),s.potions.length>=me&&(r*=.1);break}return r}function fe(n,e,t){t.debug(`--- Adventurer Loot Decision --- (Offense: ${n.traits.offense}, Resilience: ${n.traits.resilience}, Skill: ${n.skill})`);const s=e.map(r=>({item:r,score:se(n,r)})).filter(r=>r.score>0);if(s.sort((r,l)=>l.score-r.score),s.length===0||s[0].score<ue)return{choice:null,reason:o("game_engine.adventurer_declines_offer")};const i=s[0].item;t.debug(`Adventurer chooses: ${o("items_and_rooms."+i.id)} (Score: ${s[0].score.toFixed(1)})`);const a=o("game_engine.adventurer_accepts_offer",{itemName:o("items_and_rooms."+i.id)});return{choice:i,reason:a}}function _e(n,e){const{flowState:t,hp:s,maxHp:i,inventory:a,traits:r}=n,l=s/i;if(a.potions.length===0)return"attack";let c=.5;switch(t){case b.Anxiety:case b.Worry:c=.8;break;case b.Arousal:case b.Flow:c=.6;break;case b.Control:case b.Relaxation:c=.4;break;case b.Boredom:case b.Apathy:c=.2;break}return c-=r.resilience/200,l<Math.max(.1,c)?"use_potion":"attack"}function ve(n,e,t){if(e){n.lootHistory.push(e.id),n.lootHistory.filter(a=>a===e.id).length>2&&(n.modifyChallenge(n.challenge-te),n.logger.info("info_repetitive_choice",{name:o("items_and_rooms."+e.id)}));const i=se(n,e);i>60?(n.modifySkill(10),n.modifyChallenge(n.challenge+5)):i>30?(n.modifySkill(5),n.modifyChallenge(n.challenge+2)):n.modifySkill(2)}else t.length>0?n.modifyChallenge(n.challenge-5):n.modifyChallenge(n.challenge-10);n.updateFlowState()}function be(n,e){n.roomHistory.push(e.id),n.roomHistory.filter(i=>i===e.id).length>2&&(n.modifyChallenge(n.challenge-te),n.logger.info("info_deja_vu",{name:o("items_and_rooms."+e.id)}));let s=0;switch(e.type){case"room_enemy":s=5;break;case"room_boss":s=15;break;case"room_trap":s=10;break;case"room_healing":s=-15;break}n.modifyChallenge(n.challenge+s),n.updateFlowState()}function Se(n){n.modifySkill(-2),n.updateFlowState()}function P(n,e){switch(e){case"hit":n.modifySkill(.5);break;case"miss":n.modifySkill(-.5);break;case"take_damage":n.modifyChallenge(n.challenge+1);break}n.updateFlowState()}function ye(n,e,t,s){let i;return e>.7?(i=o("game_engine.too_close_for_comfort"),n.modifyChallenge(n.challenge+10),n.modifySkill(-3)):e>.4?(i=o("game_engine.great_battle"),n.modifyChallenge(n.challenge+5),n.modifySkill(5)):t>3&&n.traits.offense>60?(i=o("game_engine.easy_fight"),n.modifyChallenge(n.challenge-10)):(i=o("game_engine.worthy_challenge"),n.modifyChallenge(n.challenge-2),n.modifySkill(2)),t===s&&n.modifySkill(1*t),n.updateFlowState(),i}class we{constructor(e,t,s){this.gameState=null,this.isLoading=!0,this.error=null,this._allItems=[],this._allRooms=[],this._listeners={},this.init=async()=>{await this._loadGameData()},this.startNewGame=i=>{this.metaManager.incrementAdventurers();const a={offense:y.nextInt(10,90),resilience:y.nextInt(10,90),skill:0},r=k.getInstance();r.loadEntries([]);const l=new T(a),c=(i==null?void 0:i.items)||this._allItems.filter(v=>v.cost===null).map(v=>v.id),u=U(c,this._allItems,j),m=this._getHandSize(),d=u.slice(0,m),g=u.slice(m),h=(i==null?void 0:i.rooms)||this._allRooms.filter(v=>v.cost===null).map(v=>v.id),p=F(h,this._allRooms,this._getRoomDeckSize()),f=p.slice(0,m),_=p.slice(m);r.info("info_new_adventurer"),this.gameState={phase:"DESIGNER_CHOOSING_ROOM",designer:{balancePoints:0},adventurer:l,unlockedDeck:c,availableDeck:g,hand:d,unlockedRoomDeck:h,availableRoomDeck:_,roomHand:f,handSize:m,shopItems:[],offeredLoot:[],offeredRooms:[],feedback:o("game_engine.new_adventurer"),logger:r,run:1,room:1,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null},this.gameState.logger.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),this.gameState.logger.debug(`Deck size: ${u.length}, Hand size: ${m}, Room Deck size: ${p.length}, Room Hand size: ${f.length}`),this._emit("state-change",this.gameState)},this.continueGame=()=>{const i=this.gameSaver.load();i?(this.gameState=i,this._emit("state-change",this.gameState)):this.startNewGame()},this.startNewRun=i=>{if(!this.gameState)return;const a=i||this.gameState.run+1;this.metaManager.updateRun(a);const r=this._getHandSize(),l=U(this.gameState.unlockedDeck,this._allItems,j),c=l.slice(0,r),u=l.slice(r),m=F(this.gameState.unlockedRoomDeck,this._allRooms,this._getRoomDeckSize()),d=m.slice(0,r),g=m.slice(r),h=new T(this.gameState.adventurer.traits);h.skill=this.gameState.adventurer.skill,h.challengeHistory=[...this.gameState.adventurer.challengeHistory],h.flowState=this.gameState.adventurer.flowState,this.gameState.logger.info("info_adventurer_returns"),this.gameState.logger.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),this.gameState={...this.gameState,adventurer:h,phase:"DESIGNER_CHOOSING_ROOM",availableDeck:u,hand:c,availableRoomDeck:g,roomHand:d,handSize:r,room:1,run:a,feedback:o("game_engine.adventurer_returns"),runEnded:{isOver:!1,reason:"",success:!1,decision:null}},this._emit("state-change",this.gameState)},this.presentOffer=i=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_LOOT"||!this.gameState.hand)return;const a=this.gameState.hand.filter(v=>i.includes(v.instanceId));this.gameState.offeredLoot=a;const r=this.gameState.adventurer,{choice:l,reason:c}=fe(r,this.gameState.offeredLoot,this.gameState.logger);ve(r,l,this.gameState.offeredLoot),l&&this.gameState.logger.info("info_item_chosen",{item:o("items_and_rooms."+l.id)});let u=this.gameState.hand,m=this.gameState.availableDeck;u.forEach(v=>v.justDrafted=!1);let d=u.filter(v=>!i.includes(v.instanceId));const g=this.gameState.handSize-d.length,h=m.slice(0,g);h.forEach(v=>{v.draftedRoom=this.gameState.room,v.justDrafted=!0});const p=m.slice(g);d.push(...h),l&&(l.type==="item_potion"?r.addPotion(l):l.type==="item_buff"?r.applyBuff(l):r.equip(l));const f=this.gameState.room+1,_=this.gameState.designer.balancePoints+this._getBpPerRoom();this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",adventurer:r,feedback:c,availableDeck:p,hand:d,room:f,designer:{balancePoints:_}},this._emit("state-change",this.gameState)},this.runEncounter=i=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_ROOM")return;this.gameState.offeredRooms=i;let a=this.gameState.adventurer,r=[];const l=y.nextInt(0,this.gameState.offeredRooms.length-1),c=this.gameState.offeredRooms[l];switch(a.roomHistory.push(c.id),be(a,c),this.gameState.logger.info("info_encounter",{name:o("items_and_rooms."+c.id)}),c.type){case"room_enemy":case"room_boss":const _={enemyCount:c.units??1,enemyPower:c.stats.attack||5,enemyHp:c.stats.hp||10},v=this._simulateEncounter(a,this.gameState.room,_);a=v.newAdventurer,r=v.feedback;break;case"room_healing":const S=c.stats.hp||0;a.hp=Math.min(a.maxHp,a.hp+S),r.push(o("game_engine.healing_room",{name:o("items_and_rooms."+c.id),healing:S})),this.gameState.logger.info("info_healing_room",{name:o("items_and_rooms."+c.id),healing:S});break;case"room_trap":const x=c.stats.attack||0;a.hp-=x,Se(a),r.push(o("game_engine.trap_room",{name:o("items_and_rooms."+c.id),damage:x})),this.gameState.logger.info("info_trap_room",{name:o("items_and_rooms."+c.id),damage:x});break}a.updateBuffs(),this.gameState.designer.balancePoints+=this._getBpPerRoom();let u=this.gameState.roomHand,m=this.gameState.availableRoomDeck;u.forEach(_=>_.justDrafted=!1);const d=this.gameState.offeredRooms.map(_=>_.instanceId);let g=u.filter(_=>!d.includes(_.instanceId));const h=this.gameState.handSize-g.length,p=m.slice(0,h);p.forEach(_=>{_.draftedRoom=this.gameState.room,_.justDrafted=!0});const f=m.slice(h);if(g.push(...p),this.gameState.adventurer=a,a.hp<=0){this._endRun(o("game_engine.adventurer_fell",{room:this.gameState.room,run:this.gameState.run}));return}if(a.boredomCounter>2){const _=a.flowState===b.Boredom?o("game_engine.adventurer_bored",{room:this.gameState.room,run:this.gameState.run}):o("game_engine.adventurer_apathy",{room:this.gameState.room,run:this.gameState.run});this._endRun(_);return}this.gameState.hand&&this.gameState.hand.length===0?(this.gameState.logger.warn("warn_empty_hand"),r.push(o("game_engine.empty_hand")),this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",room:this.gameState.room+1,designer:{balancePoints:this.gameState.designer.balancePoints+this._getBpPerRoom()},feedback:r,encounter:void 0,roomHand:g,availableRoomDeck:f}):this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_LOOT",feedback:r,encounter:void 0,roomHand:g,availableRoomDeck:f},this._emit("state-change",this.gameState)},this.forceEndRun=()=>{this.gameState&&(this.gameState.adventurer.modifyChallenge(-20),this.gameState.adventurer.updateFlowState(),this._endRun(o("game_engine.no_more_rooms"),!0))},this.enterWorkshop=()=>{if(!this.gameState)return;if(this.gameState.logger.info("info_entering_workshop"),!this.metaManager.acls.has(w.WORKSHOP)){this.gameState.logger.info("info_workshop_not_unlocked"),this.startNewRun();return}const i=this.gameState.run+1,a=this._allItems.filter(c=>c.cost!==null).filter(c=>!this.gameState.unlockedDeck.includes(c.id)),r=this._allRooms.filter(c=>c.cost!==null).filter(c=>!this.gameState.unlockedRoomDeck.includes(c.id)),l=[...a,...r];this.gameState={...this.gameState,phase:"SHOP",shopReturnPhase:this.gameState.phase,run:i,room:0,shopItems:Y(l).slice(0,4),runEnded:{isOver:!1,reason:"",success:!1,decision:null},feedback:o("game_engine.welcome_to_workshop")},this._emit("state-change",this.gameState)},this.exitWorkshop=()=>{this.gameState&&this.startNewRun()},this.purchaseItem=i=>{if(!this.gameState)return;const a=this._allItems.find(p=>p.id===i),r=this._allRooms.find(p=>p.id===i),l=a||r;if(!l||l.cost===null||this.gameState.designer.balancePoints<l.cost)return;let c=this.gameState.unlockedDeck,u=this.gameState.unlockedRoomDeck,m=this.gameState.availableDeck,d=this.gameState.availableRoomDeck;a?(c=[...this.gameState.unlockedDeck,i],this.isWorkshopAccessUnlocked()&&(m=[a,...this.gameState.availableDeck])):r&&(u=[...this.gameState.unlockedRoomDeck,i],this.isWorkshopAccessUnlocked()&&(d=[r,...this.gameState.availableRoomDeck]));const g=this.gameState.designer.balancePoints-l.cost,h=this.gameState.shopItems.filter(p=>p.id!==i);this.gameState.logger.info("info_item_purchased",{item:o("items_and_rooms."+l.id)}),this.gameState={...this.gameState,designer:{balancePoints:g},unlockedDeck:c,unlockedRoomDeck:u,availableDeck:m,availableRoomDeck:d,shopItems:h},this._emit("state-change",this.gameState)},this.quitGame=(i=!0)=>{i&&this.gameSaver.clear(),this.showMenu()},this.showMenu=()=>{this.gameState={...this.gameState||this._getInitialGameState(),phase:"MENU"},this._emit("state-change",this.gameState)},this._getBpPerRoom=()=>this.metaManager.acls.has(w.BP_MULTIPLIER_2)?N*4:this.metaManager.acls.has(w.BP_MULTIPLIER)?N*2:N,this.saveGame=()=>{this.gameState&&this.gameState.phase!=="MENU"&&this.gameState.phase!=="RUN_OVER"&&this.gameSaver.save(this.gameState)},this.metaManager=e,this.dataLoader=t,this.gameSaver=s}on(e,t){this._listeners[e]||(this._listeners[e]=[]),this._listeners[e].push(t)}_emit(e,t){e==="state-change"&&this.saveGame();const s=this._listeners[e];s&&s.forEach(i=>i(t))}_simulateEncounter(e,t,s){var d,g,h,p,f,_,v,S,x,D,G;(d=this.gameState)==null||d.logger.debug(`--- Encounter: Room ${t} - ${s.enemyCount} enemies (Power: ${s.enemyPower}, HP: ${s.enemyHp}) ---`);const i=[];let a=0,r=0;const l=e.hp;for(let A=0;A<s.enemyCount;A++){(g=this.gameState)==null||g.logger.info("info_encounter_enemy",{current:A+1,total:s.enemyCount});let O=s.enemyHp;for(;O>0&&e.hp>0;){if(_e(e)==="use_potion"){const E=e.inventory.potions.shift();if(E){const I=E.stats.hp||0;e.hp=Math.min(e.maxHp,e.hp+I),i.push(o("game_engine.adventurer_drinks_potion",{potionName:o("items_and_rooms."+E.id)})),(h=this.gameState)==null||h.logger.info("info_adventurer_drinks_potion",{potionName:o("items_and_rooms."+E.id)})}}else{const E=Math.min(.95,.75+e.traits.skill/500+e.traits.offense/1e3);if(y.nextFloat()<E){const I=e.power;O-=I,(p=this.gameState)==null||p.logger.debug(`Adventurer hits for ${I} damage.`),P(e,"hit")}else(f=this.gameState)==null||f.logger.debug("Adventurer misses."),P(e,"miss")}if(O<=0){(_=this.gameState)==null||_.logger.info("info_enemy_defeated"),r++;break}const ne=Math.max(.4,.75-e.traits.skill/500-(100-e.traits.offense)/1e3);if(y.nextFloat()<ne){const E=(((v=e.inventory.armor)==null?void 0:v.stats.maxHp)||0)/10,I=Math.max(1,s.enemyPower-E);a+=I,e.hp-=I,(S=this.gameState)==null||S.logger.debug(`Enemy hits for ${I} damage.`),P(e,"take_damage")}else(x=this.gameState)==null||x.logger.debug("Enemy misses.")}if(e.hp<=0){(D=this.gameState)==null||D.logger.warn("info_adventurer_defeated");break}}const c=l-e.hp,u=c/e.maxHp;(G=this.gameState)==null||G.logger.debug(`hpLost: ${c}, hpLostRatio: ${u.toFixed(2)}`);const m=ye(e,u,r,s.enemyCount);return i.push(m),{newAdventurer:e,feedback:i,totalDamageTaken:a}}_endRun(e,t=!1){if(!this.gameState)return;this.metaManager.updateRun(this.gameState.run);const s=this.metaManager.checkForUnlocks(this.gameState.run);this.gameState.logger.debug(`Run ended with ${this.gameState.designer.balancePoints} BP.`),this.gameState.logger.error("info_game_over",{reason:e});const i=this._getAdventurerEndRunDecision();this.gameState={...this.gameState,phase:"RUN_OVER",runEnded:{isOver:!0,reason:e,success:t,decision:i},newlyUnlocked:s},this._emit("state-change",this.gameState)}_getAdventurerEndRunDecision(){if(!this.gameState)return"retire";const{flowState:e,traits:t,skill:s}=this.gameState.adventurer,{resilience:i,offense:a}=t,r=Math.min(s/100,1);if(e===b.Flow)return"continue";let l=.55;switch(e){case b.Anxiety:l+=.25-i/400;break;case b.Arousal:l-=.1-a/1e3;break;case b.Worry:l+=.2;break;case b.Control:l-=.15;break;case b.Relaxation:l+=.1;break;case b.Boredom:l+=.3;break;case b.Apathy:l+=.4;break}return l-=r*.1,l=Math.max(.05,Math.min(.95,l)),y.nextFloat()<l?"retire":"continue"}handleEndOfRun(e){if(this.gameState){if(this.gameState.logger.info("info_adventurer_decision",{decision:e}),e==="retire"){this.quitGame(!0);return}this.enterWorkshop()}}_getInitialGameState(){const e={offense:y.nextInt(10,90),resilience:y.nextInt(10,90),skill:0},t=k.getInstance(),s=new T(e);return{phase:"MENU",designer:{balancePoints:0},adventurer:s,unlockedDeck:[],availableDeck:[],hand:[],unlockedRoomDeck:[],availableRoomDeck:[],roomHand:[],handSize:this._getHandSize(),shopItems:[],offeredLoot:[],offeredRooms:[],feedback:"",logger:t,run:0,room:0,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null}}_getHandSize(){return this.metaManager.acls.has(w.HAND_SIZE_INCREASE)?12:ge}_getRoomDeckSize(){return this.metaManager.acls.has(w.ROOM_DECK_SIZE_INCREASE)?36:pe}isWorkshopAccessUnlocked(){return this.metaManager.acls.has(w.WORKSHOP_ACCESS)}isWorkshopUnlocked(){return this.metaManager.acls.has(w.WORKSHOP)}hasSaveGame(){return this.gameSaver.hasSaveGame()}async _loadGameData(){try{this._allItems=await this.dataLoader.loadJson("game/items.json"),this._allRooms=await this.dataLoader.loadJson("game/rooms.json")}catch(e){this.error=e.message||o("global.unknown_error"),this._emit("error",null)}finally{this.isLoading=!1,this._emit("state-change",this.gameState)}}}class H{constructor(e,t,s,i){this.resolve=i;const a=document.createElement("div");a.dataset.testid="info-modal-overlay",Object.assign(a.style,{position:"fixed",top:"0",left:"0",right:"0",bottom:"0",backgroundColor:"rgba(0, 0, 0, 0.4)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:"1000"}),a.addEventListener("click",f=>{if(f.target===a){const _=s.find(v=>typeof v.value=="boolean"&&v.value===!1);_&&this.dismiss(_.value)}});const r=document.createElement("div");this.element=r,r.className="window",r.style.width="min(90vw, 800px)",r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true"),r.setAttribute("aria-labelledby","info-modal-title");const l=document.createElement("div");l.className="title-bar";const c=document.createElement("div");c.id="info-modal-title",c.className="title-bar-text",c.textContent=e,l.appendChild(c),r.appendChild(l);const u=document.createElement("div");u.className="window-body text-center p-4";const m=document.createElement("div");m.innerHTML=t,u.appendChild(m);const d=document.createElement("div");d.className="flex justify-center gap-2 mt-4",s.forEach(f=>{const _=document.createElement("button");_.textContent=f.text,_.addEventListener("click",()=>{this.dismiss(f.value)}),d.appendChild(_)}),u.appendChild(d),r.appendChild(u),a.appendChild(r),document.body.appendChild(a),this.handleKeydown=f=>{if(f.key==="Escape"){const _=s.find(v=>typeof v.value=="boolean"&&v.value===!1);_&&this.dismiss(_.value)}},document.addEventListener("keydown",this.handleKeydown);const g=r.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'),h=g[0],p=g[g.length-1];h==null||h.focus(),r.addEventListener("keydown",f=>{f.key==="Tab"&&(f.shiftKey?document.activeElement===h&&(p.focus(),f.preventDefault()):document.activeElement===p&&(h.focus(),f.preventDefault()))})}dismiss(e){this.element.parentElement.remove(),document.removeEventListener("keydown",this.handleKeydown),this.resolve(e)}static show(e,t,s){return new Promise(i=>{new H(e,t,s,i)})}static showInfo(e,t,s=o("global.continue")){const i=[{text:s,value:void 0}];return H.show(e,t,i)}}class z{static show(e,t){const s=[{text:o("global.cancel"),value:!1,variant:"secondary"},{text:o("global.confirm"),value:!0,variant:"primary"}];return H.show(e,t,s)}}const ke=`<div class="w-full p-4 md:p-6 lg:p-8">
  <div class="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-6">
    ...
    `;const e=this.querySelector("#item-cards");if(e){e.innerHTML="";for(const t of this._items){const s=document.createElement("choice-card");s.item=t,s.purchaseInfo={cost:t.cost||0,canAfford:this._balancePoints>=(t.cost||0)},e.appendChild(s)}}}}customElements.define("workshop-screen",Ke);class Ze extends HTMLElement{constructor(){super(),this.engine=null,this.metaManager=null,this.addEventListener("click",async e=>{if(!this.engine||!this.metaManager)return;const t=e.target;t.id==="new-game-button"?(this.metaManager.metaState.adventurers>0||this.metaManager.metaState.highestRun>0,this.engine.hasSaveGame()?await z.show(o("menu.new_game"),o("menu.new_game_confirm"))&&this.engine.startNewGame():this.engine.startNewGame()):t.id==="continue-game-button"?this.engine.continueGame():t.id==="reset-game-button"&&await z.show(o("menu.reset_save"),o("menu.reset_save_confirm"))&&(this.metaManager.reset(),this.engine.quitGame(!0),this.render())})}connectedCallback(){this.render()}render(){if(!this.metaManager||!this.engine)return;const e=this.metaManager.metaState,t=this.engine.hasSaveGame();let s="";if(t){const i=e.adventurers||0;s=`
      ...
      <div class="window" style="width: 400px;">
        ...
        <div class="status-bar">
          ...
          <p class="status-bar-field">build 123</p>
        </div>
      </div>
    `}}customElements.define("menu-screen",Ze);class Je extends HTMLElement{constructor(){super(),this.isDesktop=!0,this.attachShadow({mode:"open"}),this.onclick=t=>{window.matchMedia("(pointer: coarse)").matches&&t.target===this&&this.hide()};const e=document.createElement("style");e.textContent=`
        ...
        `,this.contentContainer=document.createElement("div"),this.contentContainer.className="content-container",this.titleElement=document.createElement("h3"),this.bodyElement=document.createElement("div"),this.contentContainer.appendChild(this.titleElement),this.contentContainer.appendChild(this.bodyElement),this.shadowRoot.appendChild(e),this.shadowRoot.appendChild(this.contentContainer)}show(e,t,s){this.titleElement.textContent=e.title,this.bodyElement.innerHTML=e.body,this.isDesktop=!window.matchMedia("(pointer: coarse)").matches,this.classList.add("show")}hide(){this.classList.remove("show")}}customElements.define("tooltip-box",Je);class ${constructor(){this.showTimeout=null,this.hideTimeout=null,this.desktopTooltipActive=!1,this.tooltipBox=document.createElement("tooltip-box"),document.body.appendChild(this.tooltipBox)}static getInstance(){return $.instance||($.instance=new $),$.instance}handleMouseEnter(e){if(this.isTouchDevice())return;const t=e.target,s=this.findTooltipKey(t);this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=null),s&&this.activeToolipKey!==s&&(this.showTimeout=window.setTimeout(()=>{t.addEventListener("mouseleave",this.handleMouseLeave.bind(this),{once:!0}),this.activeToolipKey=s;const i=this.getTooltipContent(s);i&&(this.tooltipBox.show(i,e.clientX,e.clientY),this.desktopTooltipActive=!0)},300))}handleMouseLeave(){this.isTouchDevice()||(this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=null),this.tooltipBox.hide(),this.activeToolipKey="",this.desktopTooltipActive=!1)}handleClick(e){const t=e.target;if(t.classList.contains("tooltip-icon")){const s=this.findTooltipKey(t.parentElement);if(s){const i=this.getTooltipContent(s);i&&this.tooltipBox.show(i,0,0)}}}isTouchDevice(){return"ontouchstart"in window||navigator.maxTouchPoints>0}findTooltipKey(e){return e?e.getAttribute("data-tooltip-key")||this.findTooltipKey(e.parentElement):null}getTooltipContent(e){const t=o(`tooltips.${e}.body`);if(t.includes("tooltips."))return null;let s=o(`tooltips.${e}.title`);return s.includes("tooltips.")&&(s=o("global.information")),{title:s,body:t}}}const Z=$.getInstance(),C=document.getElementById("app");if(!C)throw new Error("Could not find app element to mount to");async function Ve(){C.innerHTML="<div>Initializing...</div>";const n=new Le;await oe(n);const e=new He,t=new $e(e),s=new Te(e),i=new we(t,n,s);i.on("state-change",a=>{if(i.isLoading){C.innerHTML=`<div>${o("global.loading_game_data")}</div>`;return}if(i.error){C.innerHTML=`
            ...
            `;return}Ce(C,a,i),Re()}),C.innerHTML=`<div>${o("global.initializing")}</div>`,document.body.addEventListener("mouseover",a=>Z.handleMouseEnter(a)),document.body.addEventListener("click",a=>Z.handleClick(a)),await i.init(),i.showMenu()}Ve().catch(n=>{console.error(n),C&&(C.innerHTML=`
      <div class="min-h-screen flex items-center justify-center p-4">
          <div class="bg-brand-surface p-8 rounded-xl shadow-2xl text-center border border-brand-secondary">
