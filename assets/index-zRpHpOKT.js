(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();const le="modulepreload",ce=function(o){return"/hypercubicle/"+o},K={},de=function(e,t,n){let s=Promise.resolve();if(t&&t.length>0){let i=function(c){return Promise.all(c.map(u=>Promise.resolve(u).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),d=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=i(t.map(c=>{if(c=ce(c),c in K)return;K[c]=!0;const u=c.endsWith(".css"),h=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${h}`))return;const m=document.createElement("link");if(m.rel=u?"stylesheet":le,u||(m.as="script"),m.crossOrigin="",m.href=c,d&&m.setAttribute("nonce",d),document.head.appendChild(m),u)return new Promise((f,g)=>{m.addEventListener("load",f),m.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return s.then(i=>{for(const l of i||[])l.status==="rejected"&&r(l.reason);return e().catch(r)})};var v=(o=>(o.Arousal="arousal",o.Flow="flow",o.Control="control",o.Relaxation="relaxation",o.Boredom="boredom",o.Apathy="apathy",o.Worry="worry",o.Anxiety="anxiety",o))(v||{});let X={};async function Q(o,e){try{X=await e.loadJson(`locales/${o}.json`)}catch(t){console.warn(`Failed to load ${o} translations:`,t),o!=="en"&&await Q("en",e)}}function he(){return typeof navigator<"u"&&navigator.language?navigator.language.split("-")[0]:"en"}function a(o,e={}){let n=o.split(".").reduce((s,r)=>s?s[r]:void 0,X);if(!n)return console.warn(`Translation not found for key: ${o}`),o;for(const s in e)n=n.replace(`{${s}}`,String(e[s]));return n}async function ue(o){const e=he();await Q(e,o)}class E{constructor(){this.entries=[],this.listeners=[],this.muted=!1}static getInstance(){return E.instance||(E.instance=new E),E.instance}on(e){this.listeners.push(e)}log(e,t="INFO",n){const s=a(`log_messages.${e}`,n),r={message:s,level:t,timestamp:Date.now(),data:n};this.muted||(this.entries.push(r),t!=="DEBUG"&&console.log(`[${t}] ${s}`)),this.listeners.forEach(i=>i(r))}debug(e){const t={message:e,level:"DEBUG",timestamp:Date.now()};this.muted||this.entries.push(t),this.listeners.forEach(n=>n(t))}metric(e){const t={message:"metric",level:"DEBUG",timestamp:Date.now(),data:e};this.listeners.forEach(n=>n(t))}info(e,t){this.log(e,"INFO",t)}warn(e,t){this.log(e,"WARN",t)}error(e,t){this.log(e,"ERROR",t)}toJSON(){return{entries:this.entries}}loadEntries(e){this.entries=e||[]}static fromJSON(e){const t=E.getInstance();return t.loadEntries(e.entries),t}}class me{constructor(e){this.seed=e}setSeed(e){this.seed=e}nextFloat(){let e=this.seed+=1831565813;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}nextInt(e,t){return Math.floor(this.nextFloat()*(t-e+1))+e}}const x=new me(Date.now()),ee=o=>`${o}_${x.nextFloat().toString(36).substr(2,9)}`,fe=(o,e)=>x.nextInt(o,e),te=o=>{const e=[...o];for(let t=e.length-1;t>0;t--){const n=x.nextInt(0,t);[e[t],e[n]]=[e[n],e[t]]}return e},se=(o,e,t,n)=>{const s=e.filter(h=>o.includes(h.id)),r=[],i={common:.6,uncommon:.3,rare:.1,legendary:0},l={common:0,uncommon:0,rare:0,legendary:0},d={common:0,uncommon:0,rare:0,legendary:0};Object.keys(i).forEach(h=>{d[h]=Math.floor(t*i[h])});let c=Object.values(d).reduce((h,m)=>h+m,0);for(;c<t;)d.common+=1,c+=1;s.filter(h=>h.cost!==null).forEach(h=>{r.push(n(h)),l[h.rarity]+=1}),Object.keys(i).forEach((h,m)=>{const f=s.filter(g=>g.rarity===h);for(;l[h]<d[h]&&f.length!==0;){const g=x.nextInt(0,f.length-1),p=f[g];r.push(n(p)),l[h]+=1}});const u=s.filter(h=>h.rarity==="common");for(;r.length<t&&u.length>0;){const h=x.nextInt(0,u.length-1),m=u[h];r.push(n(m))}return te(r)},W=(o,e,t)=>se(o,e,t,n=>({...n,instanceId:ee(n.id)})),V=(o,e,t)=>se(o,e,t,s=>{const r={...s,instanceId:ee(s.id)};return r.type==="room_enemy"&&r.stats.minUnits&&r.stats.maxUnits&&(r.units=fe(r.stats.minUnits,r.stats.maxUnits)),r}),pe=o=>o.roomHand.length<3&&!o.roomHand.some(e=>e.type==="room_boss"),ge=o=>[...new Set(o.hand.map(t=>t.id))].length<2&&o.hand.length>0;function ne(o,e){const t=Math.max(0,Math.min(100,o)),n=Math.max(0,Math.min(100,e));return n>66?t<33?v.Anxiety:t<87?v.Arousal:v.Flow:n>33?t<33?v.Worry:t<67?v.Apathy:v.Control:t<67?v.Boredom:v.Relaxation}const M={hp:100,maxHp:100,power:5},_e=3;class I{constructor(e,t){this.hp=M.hp,this.maxHp=M.maxHp,this.power=M.power,this.skill=e.skill,this.challengeHistory=[50],this.flowState=v.Boredom,this.traits=e,this.inventory={weapon:null,armor:null,potions:[]},this.activeBuffs=[],this.logger=E.getInstance(),this.roomHistory=[],this.lootHistory=[],this.boredomCounter=0,this.firstName=t?t.firstNames[Math.floor(Math.random()*t.firstNames.length)]:"Testy",this.lastName=t?t.lastNames[Math.floor(Math.random()*t.lastNames.length)]:"McTest"}get challenge(){return this.challengeHistory.length===0?50:this.challengeHistory.reduce((t,n)=>t+n,0)/this.challengeHistory.length}modifySkill(e){const t=this.skill;this.skill=Math.max(0,Math.min(100,this.skill+e)),t.toFixed(1)!==this.skill.toFixed(1)&&this.logger.debug(`Skill changed from ${t.toFixed(1)} to ${this.skill.toFixed(1)}`),this.updateFlowState()}modifyChallenge(e){const t=this.challenge,n=Math.max(0,Math.min(100,e));this.challengeHistory.push(n),this.challengeHistory.length>_e&&this.challengeHistory.shift(),this.logger.debug(`Challenge changed from ${t.toFixed(1)} to ${this.challenge.toFixed(1)} (new value: ${n})`),this.updateFlowState()}updateFlowState(){const e=this.flowState;this.flowState=ne(this.skill,this.challenge),e!==this.flowState&&this.logger.info("info_flow_state_changed",{name:this.firstName,from:a("flow_states."+e),to:a("flow_states."+this.flowState)})}equip(e){e.type==="item_weapon"?this.inventory.weapon=e:e.type==="item_armor"&&(this.inventory.armor=e),this.recalculateStats()}addPotion(e){e.type==="item_potion"&&this.inventory.potions.push(e)}applyBuff(e){this.activeBuffs.push(e),this.recalculateStats()}updateBuffs(){const e=this.activeBuffs.filter(t=>t.stats.duration!==void 0&&t.stats.duration<=1);this.activeBuffs=this.activeBuffs.map(t=>(t.stats.duration&&(t.stats.duration-=1),t)).filter(t=>t.stats.duration===void 0||t.stats.duration>0),e.length>0&&this.recalculateStats()}recalculateStats(){const e=this.hp/this.maxHp;let t=M.power,n=M.maxHp;this.inventory.weapon&&(t+=this.inventory.weapon.stats.power||0,n+=this.inventory.weapon.stats.maxHp||0),this.inventory.armor&&(t+=this.inventory.armor.stats.power||0,n+=this.inventory.armor.stats.maxHp||0),this.activeBuffs.forEach(s=>{t+=s.stats.power||0,n+=s.stats.maxHp||0}),this.power=t,this.maxHp=n,this.hp=Math.round(this.maxHp*e)}toJSON(){return{hp:this.hp,maxHp:this.maxHp,power:this.power,traits:this.traits,inventory:this.inventory,activeBuffs:this.activeBuffs,skill:this.skill,challengeHistory:this.challengeHistory,flowState:this.flowState,roomHistory:this.roomHistory,lootHistory:this.lootHistory,boredomCounter:this.boredomCounter,firstName:this.firstName,lastName:this.lastName}}static fromJSON(e){const t=e.traits,n=new I(t);return n.hp=e.hp,n.maxHp=e.maxHp,n.power=e.power,n.inventory=e.inventory,n.activeBuffs=e.activeBuffs,n.skill=e.skill,n.challengeHistory=e.challengeHistory,n.flowState=e.flowState,n.roomHistory=e.roomHistory,n.lootHistory=e.lootHistory,n.boredomCounter=e.boredomCounter,n.firstName=e.firstName,n.lastName=e.lastName,n}}class H{constructor(){this._path=["start"],this._linkLabels={},this._nodes={id:"start",label:"Start",children:[]},this._currentNode=this._nodes}addRoomSelection(e,t){e.forEach(n=>{this._currentNode.children.push({id:n.instanceId,label:`Floor ${this._path.length}: ${a("items_and_rooms."+n.id)}`,children:[]})}),this._currentNode=this._currentNode.children.find(n=>n.id===t.instanceId),this._path.push(t.instanceId)}generateChartData(){return{nodes:this._nodes,path:this._path,linkLabels:this._linkLabels}}toJSON(){return{nodes:this._nodes,path:this._path,linkLabels:this._linkLabels,currentNodePath:this._getNodePath(this._nodes,this._currentNode)}}_getNodePath(e,t){const n=[];function s(r){if(r.id===t.id)return n.push(r.id),!0;for(const i of r.children)if(s(i))return n.push(r.id),!0;return!1}return s(e),n.reverse()}static fromJSON(e){const t=new H;t._nodes=e.nodes,t._path=e.path,t._linkLabels=e.linkLabels;let n=t._nodes;for(let s=1;s<e.currentNodePath.length;s++)n=n.children.find(r=>r.id===e.currentNodePath[s]);return t._currentNode=n,t}}const ve=99,ye=10,q=10,Z=32,be=18,we=8;var C=(o=>(o.WORKSHOP="workshop",o.ROOM_DECK_SIZE_INCREASE="room_deck_size_increase",o.HAND_SIZE_INCREASE="hand_size_increase",o.ADVENTURER_TRAITS="ADVENTURER_TRAITS",o.BP_MULTIPLIER="BP_MULTIPLIER",o.WORKSHOP_ACCESS="WORKSHOP_ACCESS",o.BP_MULTIPLIER_2="BP_MULTIPLIER_2",o))(C||{});const ie=[{feature:"workshop",runThreshold:2,title:()=>a("unlocks.workshop.title"),description:()=>a("unlocks.workshop.description")},{feature:"room_deck_size_increase",runThreshold:3,title:()=>a("unlocks.room_deck_size_increase.title"),description:()=>a("unlocks.room_deck_size_increase.description")},{feature:"hand_size_increase",runThreshold:4,title:()=>a("unlocks.hand_size_increase.title"),description:()=>a("unlocks.hand_size_increase.description")},{feature:"ADVENTURER_TRAITS",runThreshold:5,title:()=>a("unlocks.adventurer_traits.title"),description:()=>a("unlocks.adventurer_traits.description")},{feature:"BP_MULTIPLIER",runThreshold:8,title:()=>a("unlocks.bp_multiplier.title"),description:()=>a("unlocks.bp_multiplier.description")},{feature:"WORKSHOP_ACCESS",runThreshold:13,title:()=>a("unlocks.workshop_access.title"),description:()=>a("unlocks.workshop_access.description")},{feature:"BP_MULTIPLIER_2",runThreshold:21,title:()=>a("unlocks.bp_multiplier_2.title"),description:()=>a("unlocks.bp_multiplier_2.description")}],oe=10;function ae(o,e){var c,u,h,m;const{traits:t,inventory:n,hp:s,maxHp:r}=o;let i=(e.rarity==="uncommon"?2:e.rarity==="rare"?3:1)*5;const l=((c=n.weapon)==null?void 0:c.stats.power)||0,d=((u=n.armor)==null?void 0:u.stats.maxHp)||0;switch(e.type){case"item_weapon":const f=(e.stats.power||0)-l;if(f<=0&&e.id!==((h=n.weapon)==null?void 0:h.id))return-1;i+=f*(t.offense/10),f>0&&(i+=f*(o.skill/10));const g=e.stats.maxHp||0;g<0&&(i+=g*(100-t.resilience)/20);break;case"item_armor":const p=(e.stats.maxHp||0)-d;if(p<=0&&e.id!==((m=n.armor)==null?void 0:m.id))return-1;i+=p*(100-t.offense)/10,p>0&&(i+=p*(o.skill/10));const y=e.stats.power||0;y>0&&(i+=y*(t.offense/15));const b=e.stats.power||0;b<0&&(i+=b*(t.resilience/10));break;case"item_potion":const w=s/r;i+=10*(100-t.resilience)/100,w<.7&&(i+=20*(1-w)),i+=5*(o.skill/100),n.potions.length>=ve&&(i*=.1);break}return i}function Se(o,e,t){t.debug(`--- Adventurer Loot Decision --- (Offense: ${o.traits.offense}, Resilience: ${o.traits.resilience}, Skill: ${o.skill})`);const n=e.map(r=>({item:r,score:ae(o,r)})).filter(r=>r.score>0);if(n.sort((r,i)=>i.score-r.score),n.length===0||n[0].score<ye)return null;const s=n[0].item;return t.debug(`Adventurer chooses: ${a("items_and_rooms."+s.id)} (Score: ${n[0].score.toFixed(1)})`),s}function xe(o,e){const{flowState:t,hp:n,maxHp:s,inventory:r,traits:i}=o,l=n/s;if(r.potions.length===0)return"attack";let d=.5;switch(t){case v.Anxiety:case v.Worry:d=.8;break;case v.Arousal:case v.Flow:d=.6;break;case v.Control:case v.Relaxation:d=.4;break;case v.Boredom:case v.Apathy:d=.2;break}return d-=i.resilience/200,l<Math.max(.1,d)?"use_potion":"attack"}function ke(o,e,t){if(e){o.lootHistory.push(e.id),o.lootHistory.filter(r=>r===e.id).length>2&&(o.modifyChallenge(o.challenge-oe),o.logger.info("info_repetitive_choice",{name:a("items_and_rooms."+e.id)}));const s=ae(o,e);s>60?(o.modifySkill(10),o.modifyChallenge(o.challenge+5)):s>30?(o.modifySkill(5),o.modifyChallenge(o.challenge+2)):o.modifySkill(2)}else t.length>0?o.modifyChallenge(o.challenge-5):o.modifyChallenge(o.challenge-10);o.updateFlowState()}function Ee(o,e){o.roomHistory.push(e.id),o.roomHistory.filter(s=>s===e.id).length>2&&(o.modifyChallenge(o.challenge-oe),o.logger.info("info_deja_vu",{name:a("items_and_rooms."+e.id)}));let n=0;switch(e.type){case"room_enemy":n=5;break;case"room_boss":n=15;break;case"room_trap":n=10;break;case"room_healing":n=-15;break}o.modifyChallenge(o.challenge+n),o.updateFlowState()}function Ce(o){o.modifySkill(-2),o.updateFlowState()}function G(o,e){switch(e){case"hit":o.modifySkill(.5);break;case"miss":o.modifySkill(-.5);break;case"take_damage":o.modifyChallenge(o.challenge+1);break}o.updateFlowState()}function Ie(o,e,t,n){let s;return e>.7?(s=a("game_engine.too_close_for_comfort"),o.modifyChallenge(o.challenge+10),o.modifySkill(-3)):e>.4?(s=a("game_engine.great_battle"),o.modifyChallenge(o.challenge+5),o.modifySkill(5)):t>3&&o.traits.offense>60?(s=a("game_engine.easy_fight"),o.modifyChallenge(o.challenge-10)):(s=a("game_engine.worthy_challenge"),o.modifyChallenge(o.challenge-2),o.modifySkill(2)),t===n&&o.modifySkill(1*t),o.updateFlowState(),s}const _=E.getInstance();class $e{constructor(e,t,n){this.gameState=null,this.isLoading=!0,this.error=null,this._allItems=[],this._allRooms=[],this._allNames={firstNames:[],lastNames:[]},this._listeners={},this.init=async()=>{await this._loadGameData()},this.startNewGame=s=>{this.dungeonHistory=new H,this.metaManager.incrementAdventurers();const r={offense:x.nextInt(10,90),resilience:x.nextInt(10,90),skill:0};_.loadEntries([]);const i=new I(r,this._allNames),l=(s==null?void 0:s.items)||this._allItems.filter(y=>y.cost===null).map(y=>y.id),d=W(l,this._allItems,Z),c=this._getHandSize(),u=d.slice(0,c),h=d.slice(c),m=(s==null?void 0:s.rooms)||this._allRooms.filter(y=>y.cost===null).map(y=>y.id),f=V(m,this._allRooms,this._getRoomDeckSize()),g=f.slice(0,c),p=f.slice(c);this.gameState={phase:"DESIGNER_CHOOSING_ROOM",designer:{balancePoints:0},adventurer:i,unlockedDeck:l,availableDeck:h,hand:u,unlockedRoomDeck:m,availableRoomDeck:p,roomHand:g,handSize:c,shopItems:[],offeredLoot:[],offeredRooms:[],run:1,room:1,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null},_.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),_.debug(`Deck size: ${d.length}, Hand size: ${c}, Room Deck size: ${f.length}, Room Hand size: ${g.length}`),_.info("info_designer_choosing_room",{name:i.firstName}),this._emit("state-change",this.gameState)},this.continueGame=()=>{const s=this.gameSaver.load();if(s){const[r,i]=s;this.gameState=r,i&&(this.dungeonHistory=i),this._emit("state-change",this.gameState),this.gameState.phase==="AWAITING_ENCOUNTER_RESULT"&&this.gameState.encounterPayload&&this._emit("show-encounter",this.gameState.encounterPayload)}else this.startNewGame()},this.startNewRun=s=>{if(!this.gameState)return;this.dungeonHistory=new H;const r=s||this.gameState.run+1;this.metaManager.updateRun(r);const i=this._getHandSize(),l=W(this.gameState.unlockedDeck,this._allItems,Z),d=l.slice(0,i),c=l.slice(i),u=V(this.gameState.unlockedRoomDeck,this._allRooms,this._getRoomDeckSize()),h=u.slice(0,i),m=u.slice(i),f=new I(this.gameState.adventurer.traits,this._allNames);f.skill=this.gameState.adventurer.skill,f.challengeHistory=[...this.gameState.adventurer.challengeHistory],f.flowState=this.gameState.adventurer.flowState,_.info("info_adventurer_returns",{name:f.firstName}),_.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),this.gameState={...this.gameState,adventurer:f,phase:"DESIGNER_CHOOSING_ROOM",availableDeck:c,hand:d,availableRoomDeck:m,roomHand:h,handSize:i,room:1,run:r,runEnded:{isOver:!1,reason:"",success:!1,decision:null}},_.info("info_designer_choosing_room",{name:f.firstName}),this._emit("state-change",this.gameState)},this.presentOffer=s=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_LOOT"||!this.gameState.hand)return;const r=this.gameState.hand.filter(w=>s.includes(w.instanceId));this.gameState.offeredLoot=r;const i=this.gameState.adventurer,l=Se(i,this.gameState.offeredLoot,_),d=this.gameState.offeredLoot.map(w=>a("items_and_rooms."+w.id)).join(", ");_.info("info_loot_chosen",{name:i.firstName,items:d});const c=i.flowState;ke(i,l,this.gameState.offeredLoot),c!==i.flowState&&_.metric({event:"flow_state_changed",flowState:i.flowState}),l?(_.info("info_item_chosen",{name:i.firstName,item:a("items_and_rooms."+l.id)}),_.metric({event:"item_chosen",item:l})):_.info("info_loot_declined",{name:i.firstName});let u=this.gameState.hand,h=this.gameState.availableDeck;u.forEach(w=>w.justDrafted=!1);let m=u.filter(w=>!s.includes(w.instanceId));const f=this.gameState.handSize-m.length,g=h.slice(0,f);g.forEach(w=>{w.draftedRoom=this.gameState.room,w.justDrafted=!0});const p=h.slice(f);m.push(...g),l&&(l.type==="item_potion"?i.addPotion(l):l.type==="item_buff"?i.applyBuff(l):i.equip(l));const y=this.gameState.room+1,b=this.gameState.designer.balancePoints+this._getBpPerRoom();this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",adventurer:i,availableDeck:p,hand:m,room:y,designer:{balancePoints:b}},_.info("info_designer_choosing_room",{name:i.firstName}),this._emit("state-change",this.gameState)},this.runEncounter=s=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_ROOM")return;this.gameState.offeredRooms=s;const r=x.nextInt(0,this.gameState.offeredRooms.length-1),i=this.gameState.offeredRooms[r];if(this.dungeonHistory.addRoomSelection(s,i),this.gameState.offeredRooms.length===1&&i.type==="room_boss")_.info("info_boss_room_chosen",{name:this.gameState.adventurer.firstName,chosenRoom:a("items_and_rooms."+i.id)});else{const u=this.gameState.offeredRooms.map(h=>a("items_and_rooms."+h.id)).join(", ");_.info("info_room_chosen",{name:this.gameState.adventurer.firstName,rooms:u})}_.metric({event:"room_encountered",room:i});const{log:l,finalAdventurer:d}=this._generateEncounterLog(this.gameState.adventurer,i),c={room:i,log:l,finalAdventurer:d};this.gameState={...this.gameState,phase:"AWAITING_ENCOUNTER_RESULT",encounterPayload:c},this._emit("state-change",this.gameState),this._emit("show-encounter",c)},this.continueEncounter=()=>{!this.gameState||this.gameState.phase!=="AWAITING_ENCOUNTER_RESULT"||this._postEncounterUpdate()},this._postEncounterUpdate=()=>{if(!this.gameState)return;const s=I.fromJSON(this.gameState.encounterPayload.finalAdventurer);s.updateBuffs(),this.gameState.designer.balancePoints+=this._getBpPerRoom();let r=this.gameState.roomHand,i=this.gameState.availableRoomDeck;r.forEach(m=>m.justDrafted=!1);const l=this.gameState.offeredRooms.map(m=>m.instanceId);let d=r.filter(m=>!l.includes(m.instanceId));const c=this.gameState.handSize-d.length,u=i.slice(0,c);u.forEach(m=>{m.draftedRoom=this.gameState.room,m.justDrafted=!0});const h=i.slice(c);if(d.push(...u),this.gameState.adventurer=s,s.hp<=0){this._endRun(a("game_engine.adventurer_fell",{room:this.gameState.room,run:this.gameState.run}));return}if(s.boredomCounter>2){const m=s.flowState===v.Boredom?a("game_engine.adventurer_bored",{room:this.gameState.room,run:this.gameState.run}):a("game_engine.adventurer_apathy",{room:this.gameState.room,run:this.gameState.run});this._endRun(m);return}this.gameState.hand&&this.gameState.hand.length===0?(_.warn("warn_empty_hand",{name:s.firstName}),this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",room:this.gameState.room+1,designer:{balancePoints:this.gameState.designer.balancePoints+this._getBpPerRoom()},encounterPayload:void 0,roomHand:d,availableRoomDeck:h},_.info("info_designer_choosing_room",{name:s.firstName})):(this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_LOOT",encounterPayload:void 0,roomHand:d,availableRoomDeck:h},_.info("info_designer_choosing_loot",{name:s.firstName})),this._emit("state-change",this.gameState)},this.forceEndRun=()=>{this.gameState&&(this.gameState.adventurer.modifyChallenge(-20),this.gameState.adventurer.updateFlowState(),this._endRun(a("game_engine.no_more_rooms"),!0))},this.enterWorkshop=()=>{if(!this.gameState)return;if(!this.metaManager.acls.has(C.WORKSHOP)){_.debug("Workshop not unlocked, starting new run directly."),this.startNewRun();return}_.info("info_entering_workshop",{name:this.gameState.adventurer.firstName});const s=this.gameState.run+1,r=this._allItems.filter(d=>d.cost!==null).filter(d=>!this.gameState.unlockedDeck.includes(d.id)),i=this._allRooms.filter(d=>d.cost!==null).filter(d=>!this.gameState.unlockedRoomDeck.includes(d.id)),l=[...r,...i];this.gameState={...this.gameState,phase:"SHOP",shopReturnPhase:this.gameState.phase,run:s,room:0,shopItems:te(l).slice(0,4),runEnded:{isOver:!1,reason:"",success:!1,decision:null}},_.info("info_welcome_to_workshop"),this._emit("state-change",this.gameState)},this.exitWorkshop=()=>{this.gameState&&this.startNewRun()},this.purchaseItem=s=>{if(!this.gameState)return;const r=this._allItems.find(g=>g.id===s),i=this._allRooms.find(g=>g.id===s),l=r||i;if(!l||l.cost===null||this.gameState.designer.balancePoints<l.cost)return;let d=this.gameState.unlockedDeck,c=this.gameState.unlockedRoomDeck,u=this.gameState.availableDeck,h=this.gameState.availableRoomDeck;r?(d=[...this.gameState.unlockedDeck,s],this.isWorkshopAccessUnlocked()&&(u=[r,...this.gameState.availableDeck])):i&&(c=[...this.gameState.unlockedRoomDeck,s],this.isWorkshopAccessUnlocked()&&(h=[i,...this.gameState.availableRoomDeck]));const m=this.gameState.designer.balancePoints-l.cost,f=this.gameState.shopItems.filter(g=>g.id!==s);_.info("info_item_purchased",{name:this.gameState.adventurer.firstName,item:a("items_and_rooms."+l.id)}),_.metric({event:"item_purchased",item:l}),this.gameState={...this.gameState,designer:{balancePoints:m},unlockedDeck:d,unlockedRoomDeck:c,availableDeck:u,availableRoomDeck:h,shopItems:f},this._emit("state-change",this.gameState)},this.quitGame=(s=!0)=>{s&&this.gameSaver.clear(),this.showMenu()},this.showMenu=()=>{this.gameState={...this.gameState||this._getInitialGameState(),phase:"MENU"},this._emit("state-change",this.gameState)},this._getBpPerRoom=()=>this.metaManager.acls.has(C.BP_MULTIPLIER_2)?q*4:this.metaManager.acls.has(C.BP_MULTIPLIER)?q*2:q,this.saveGame=()=>{this.gameState&&this.gameState.phase!=="MENU"&&this.gameState.phase!=="RUN_OVER"&&this.gameSaver.save({...this.gameState,dungeonHistory:this.dungeonHistory})},this.metaManager=e,this.dataLoader=t,this.gameSaver=n,this.dungeonHistory=new H}on(e,t){this._listeners[e]||(this._listeners[e]=[]),this._listeners[e].push(t)}_emit(e,...t){e==="state-change"&&this.saveGame();const n=this._listeners[e];n&&n.forEach(s=>s(...t))}_createAdventurerSnapshot(e){return{firstName:e.firstName,lastName:e.lastName,hp:e.hp,maxHp:e.maxHp,power:e.power,flowState:e.flowState,inventory:JSON.parse(JSON.stringify(e.inventory))}}_generateEncounterLog(e,t){var i;const n=[],s=I.fromJSON(e.toJSON());_.info("info_encounter",{name:s.firstName,roomName:a("items_and_rooms."+t.id)});const r=s.flowState;switch(Ee(s,t),r!==s.flowState&&_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_encounter",replacements:{name:s.firstName,roomName:a("items_and_rooms."+t.id)},adventurer:this._createAdventurerSnapshot(s)}),t.type){case"room_enemy":case"room_boss":{const l={enemyCount:t.units??1,enemyPower:t.stats.attack||5,enemyHp:t.stats.hp||10};let d=0;const c=s.hp;for(let g=0;g<l.enemyCount;g++){let p=l.enemyHp;_.info("info_encounter_enemy",{name:s.firstName,enemyName:t.entity_id?a("entities."+t.entity_id):a("items_and_rooms."+t.id),current:g+1,total:l.enemyCount});const y=t.entity_id?a("entities."+t.entity_id):a("items_and_rooms."+t.id),b={currentHp:p,maxHp:l.enemyHp,power:l.enemyPower,name:y,count:g+1,total:l.enemyCount};for(n.push({messageKey:"log_messages.info_encounter_enemy",replacements:{name:s.firstName,enemyName:t.entity_id?a("entities."+t.entity_id):a("items_and_rooms."+t.id),current:g+1,total:l.enemyCount},adventurer:this._createAdventurerSnapshot(s),enemy:b});p>0&&s.hp>0;){if(xe(s)==="use_potion"){const S=s.inventory.potions.shift();if(S){const k=S.stats.hp||0;s.hp=Math.min(s.maxHp,s.hp+k),_.info("info_adventurer_drinks_potion",{name:s.firstName,potionName:a("items_and_rooms."+S.id)}),n.push({messageKey:"log_messages.info_adventurer_drinks_potion",replacements:{name:s.firstName,potionName:a("items_and_rooms."+S.id)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p}})}}else{const S=Math.min(.95,.75+s.traits.skill/500+s.traits.offense/1e3);if(x.nextFloat()<S){const k=s.power;p-=k,_.debug(`Adventurer hits for ${k} damage.`);const A=s.flowState;G(s,"hit"),A!==s.flowState&&(_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:s.firstName,from:a(`flow_states.${A}`),to:a(`flow_states.${s.flowState}`)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p}})),n.push({messageKey:"log_messages.info_adventurer_hit",replacements:{name:s.firstName,damage:k},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p},animations:[{target:"adventurer",animation:"attack"},{target:"enemy",animation:"shake"}]})}else{_.debug("Adventurer misses.");const k=s.flowState;G(s,"miss"),k!==s.flowState&&(_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:s.firstName,from:a(`flow_states.${k}`),to:a(`flow_states.${s.flowState}`)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p}})),n.push({messageKey:"log_messages.info_adventurer_miss",replacements:{name:s.firstName},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p},animations:[{target:"adventurer",animation:"attack"}]})}}if(p<=0){_.info("info_enemy_defeated",{enemyName:b.name}),d++,n.push({messageKey:"log_messages.info_enemy_defeated",replacements:{enemyName:b.name},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:0},animations:[{target:"enemy",animation:"defeat"}]});break}const R=Math.max(.4,.75-s.traits.skill/500-(100-s.traits.offense)/1e3);if(x.nextFloat()<R){const S=(((i=s.inventory.armor)==null?void 0:i.stats.maxHp)||0)/10,k=Math.max(1,l.enemyPower-S);s.hp-=k,_.debug(`Enemy hits for ${k} damage.`);const A=s.flowState;G(s,"take_damage"),A!==s.flowState&&(_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:s.firstName,from:a(`flow_states.${A}`),to:a(`flow_states.${s.flowState}`)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p}})),n.push({messageKey:"log_messages.info_enemy_hit",replacements:{damage:k,enemyName:b.name},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p},animations:[{target:"enemy",animation:"attack"},{target:"adventurer",animation:"shake"}]})}else _.debug("Enemy misses."),n.push({messageKey:"log_messages.info_enemy_miss",replacements:{enemyName:b.name},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p},animations:[{target:"enemy",animation:"attack"}]})}if(s.hp<=0){_.warn("info_adventurer_defeated",{name:s.firstName}),n.push({messageKey:"log_messages.info_adventurer_defeated",replacements:{name:s.firstName},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:p},animations:[{target:"adventurer",animation:"defeat"}]});break}}const u=c-s.hp,h=u/s.maxHp;_.debug(`hpLost: ${u}, hpLostRatio: ${h.toFixed(2)}`);const m=s.flowState,f=Ie(s,h,d,l.enemyCount);m!==s.flowState&&_.metric({event:"flow_state_changed",flowState:s.flowState}),_.info("info_battle_outcome",{outcome:f});break}case"room_healing":{const l=t.stats.hp||0;s.hp=Math.min(s.maxHp,s.hp+l),_.info("info_healing_room",{name:s.firstName,healingRoomName:a("items_and_rooms."+t.id),healing:l}),n.push({messageKey:"log_messages.info_healing_room",replacements:{name:s.firstName,healingRoomName:a("items_and_rooms."+t.id),healing:l},adventurer:this._createAdventurerSnapshot(s)});break}case"room_trap":{const l=t.stats.attack||0;s.hp-=l;const d=s.flowState;Ce(s),d!==s.flowState&&_.metric({event:"flow_state_changed",flowState:s.flowState}),_.info("info_trap_room",{name:s.firstName,trapName:a("items_and_rooms."+t.id),damage:l}),n.push({messageKey:"log_messages.info_trap_room",replacements:{name:s.firstName,trapName:a("items_and_rooms."+t.id),damage:l},adventurer:this._createAdventurerSnapshot(s)});break}}return{log:n,finalAdventurer:s}}_endRun(e,t=!1){if(!this.gameState)return;this.metaManager.updateRun(this.gameState.run);const n=this.metaManager.checkForUnlocks(this.gameState.run);_.debug(`Run ended with ${this.gameState.designer.balancePoints} BP.`),_.metric({event:"run_end",bp:this.gameState.designer.balancePoints}),_.error("info_game_over",{reason:e});const s=this._getAdventurerEndRunDecision();this.gameState={...this.gameState,phase:"RUN_OVER",runEnded:{isOver:!0,reason:e,success:t,decision:s},newlyUnlocked:n},this._emit("state-change",this.gameState)}_getAdventurerEndRunDecision(){if(!this.gameState)return"retire";const{flowState:e,traits:t,skill:n}=this.gameState.adventurer,{resilience:s,offense:r}=t,i=Math.min(n/100,1);if(e===v.Flow)return"continue";let l=.55;switch(e){case v.Anxiety:l+=.25-s/400;break;case v.Arousal:l-=.1-r/1e3;break;case v.Worry:l+=.2;break;case v.Control:l-=.15;break;case v.Relaxation:l+=.1;break;case v.Boredom:l+=.3;break;case v.Apathy:l+=.4;break}return l-=i*.1,l=Math.max(.05,Math.min(.95,l)),x.nextFloat()<l?"retire":"continue"}handleEndOfRun(e){if(this.gameState){if(_.info("info_adventurer_decision",{name:this.gameState.adventurer.firstName,decision:e}),e==="retire"){this.quitGame(!0);return}this.enterWorkshop()}}_getInitialGameState(){const e={offense:x.nextInt(10,90),resilience:x.nextInt(10,90),skill:0},t=new I(e,this._allNames);return{phase:"MENU",designer:{balancePoints:0},adventurer:t,unlockedDeck:[],availableDeck:[],hand:[],unlockedRoomDeck:[],availableRoomDeck:[],roomHand:[],handSize:this._getHandSize(),shopItems:[],offeredLoot:[],offeredRooms:[],run:0,room:0,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null}}_getHandSize(){return this.metaManager.acls.has(C.HAND_SIZE_INCREASE)?12:we}_getRoomDeckSize(){return this.metaManager.acls.has(C.ROOM_DECK_SIZE_INCREASE)?36:be}isWorkshopAccessUnlocked(){return this.metaManager.acls.has(C.WORKSHOP_ACCESS)}isWorkshopUnlocked(){return this.metaManager.acls.has(C.WORKSHOP)}getDungeonChartData(){return this.dungeonHistory.generateChartData()}hasSaveGame(){return this.gameSaver.hasSaveGame()}async _loadGameData(){try{this._allItems=await this.dataLoader.loadJson("game/items.json"),this._allRooms=await this.dataLoader.loadJson("game/rooms.json"),this._allNames=await this.dataLoader.loadJson("game/names.json")}catch(e){this.error=e.message||a("global.unknown_error"),this._emit("error",null)}finally{this.isLoading=!1,this._emit("state-change",this.gameState)}}}class D{constructor(e,t,n,s){this.resolve=s;const r=document.createElement("div");r.dataset.testid="info-modal-overlay",Object.assign(r.style,{position:"fixed",top:"0",left:"0",right:"0",bottom:"0",backgroundColor:"rgba(0, 0, 0, 0.4)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:"1000"}),r.addEventListener("click",p=>{if(p.target===r){const y=n.find(b=>typeof b.value=="boolean"&&b.value===!1);y&&this.dismiss(y.value)}});const i=document.createElement("div");this.element=i,i.className="window",i.style.width="min(90vw, 800px)",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-labelledby","info-modal-title");const l=document.createElement("div");l.className="title-bar";const d=document.createElement("div");d.id="info-modal-title",d.className="title-bar-text",d.textContent=e,l.appendChild(d),i.appendChild(l);const c=document.createElement("div");c.className="window-body text-center p-4";const u=document.createElement("div");u.innerHTML=t,c.appendChild(u);const h=document.createElement("div");h.className="flex justify-end gap-2 mt-4",n.forEach(p=>{const y=document.createElement("button");y.textContent=p.text,y.addEventListener("click",()=>{this.dismiss(p.value)}),h.appendChild(y)}),c.appendChild(h),i.appendChild(c),r.appendChild(i),document.body.appendChild(r),document.body.style.overflow="hidden",this.handleKeydown=p=>{if(p.key==="Escape"){const y=n.find(b=>typeof b.value=="boolean"&&b.value===!1);y&&this.dismiss(y.value)}},document.addEventListener("keydown",this.handleKeydown);const m=i.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'),f=m[0],g=m[m.length-1];f==null||f.focus(),i.addEventListener("keydown",p=>{p.key==="Tab"&&(p.shiftKey?document.activeElement===f&&(g.focus(),p.preventDefault()):document.activeElement===g&&(f.focus(),p.preventDefault()))})}dismiss(e){this.element.parentElement.remove(),document.removeEventListener("keydown",this.handleKeydown),document.body.style.overflow="",this.resolve(e)}static show(e,t,n){return new Promise(s=>{new D(e,t,n,s)})}static showInfo(e,t,n=a("global.continue")){const s=[{text:n,value:void 0}];return D.show(e,t,s)}}class j{static show(e,t){const n=[{text:a("global.cancel"),value:!1,variant:"secondary"},{text:a("global.confirm"),value:!0,variant:"primary"}];return D.show(e,t,n)}}class Re extends HTMLElement{constructor(){super(),this.isDesktop=!0,this.attachShadow({mode:"open"}),this.onclick=t=>{window.matchMedia("(pointer: coarse)").matches&&t.target===this&&this.hide()};const e=document.createElement("style");e.textContent=`
  ...
  <div class="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-6">
    ...
    `,this._canvas=this.querySelector("canvas"),this._ctx=this._canvas.getContext("2d"),this.render()}attributeChangedCallback(e,t,n){t!==n&&(e==="skill"&&(this._skill=parseFloat(n)),e==="challenge"&&(this._challenge=parseFloat(n)),this.render())}render(){if(!this._ctx||!this._canvas)return;this._backgroundRendered||this._renderBackground();const e=this.querySelector("#flow-chart-dot"),t=Math.max(0,Math.min(100,this._skill)),n=100-Math.max(0,Math.min(100,this._challenge));e.style.left=`${t}%`,e.style.top=`${n}%`}_renderBackground(){if(!this._ctx||!this._canvas)return;const e=this._ctx;for(let t=0;t<100;t++)for(let n=0;n<100;n++){const s=ne(t,100-n);e.fillStyle=this.getFlowStateCanvasColor(s),e.fillRect(t,n,1,1)}e.font='12px "Pixelated MS Sans Serif"',e.fillStyle="black",e.strokeStyle="white",e.lineWidth=2,e.textAlign="center",e.strokeText("Skill",50,95),e.fillText("Skill",50,95),e.save(),e.translate(12,50),e.rotate(-Math.PI/2),e.strokeText("Challenge",0,0),e.fillText("Challenge",0,0),e.restore(),this._backgroundRendered=!0}getFlowStateCanvasColor(e){switch(e){case v.Apathy:return"rgba(239, 68, 68, 0.2)";case v.Boredom:return"rgba(239, 68, 68, 0.6)";case v.Anxiety:return"rgba(249, 115, 22, 0.6)";case v.Worry:return"rgba(249, 115, 22, 0.2)";case v.Arousal:return"rgba(59, 130, 246, 0.8)";case v.Control:return"rgba(59, 130, 246, 0.4)";case v.Relaxation:return"rgba(59, 130, 246, 0.2)";case v.Flow:return"#eab308";default:return"#000000"}}}customElements.define("flow-chart",Ke);class We extends HTMLElement{constructor(){super(),this.state="initial",this.decision=null,this.engine=null,this.newlyUnlocked=[],this.addEventListener("click",e=>{const t=e.composedPath()[0];t.id==="continue-run-button"&&this.engine?this.engine.handleEndOfRun("continue"):t.id==="retire-run-button"&&this.engine&&this.engine.handleEndOfRun("retire")})}static get observedAttributes(){return["workshop-unlocked"]}async initialize(e,t,n){this.decision=e,this.newlyUnlocked=t,this.engine=n,this.render(),await this.startFlow()}async startFlow(){this.newlyUnlocked.length>0?await this.renderUnlock():(this.state="unlock-revealed",this.revealDecision())}async renderUnlock(){const e=ie.find(s=>s.feature===this.newlyUnlocked[0]);if(!e)return;const t=a("unlocks.title"),n=`
        ...
        `}updateDecision(e){const t=this.querySelector("#decision-container"),n=this.querySelector("#button-container");if(!t||!n||this.state!=="decision-revealed")return;let s="",r="";const i=e?"animate-fade-in-up":"",l=this.hasAttribute("workshop-unlocked");this.decision==="continue"?(s=`
                <h3 class="${i}" style="color: var(--color-stat-positive);">${a("run_ended_screen.continue_quote")}</h3>
                <p class="${i}" style="animation-delay: 0.5s;">${a("run_ended_screen.continue_decision")}</p>
            `,r=`
            ...
            <div class="status-bar">
                ...
                <button id="dungeon-chart-btn">${a("global.dungeon_chart_button")}</button>
            </div>
        `,(t=this.querySelector("#enter-workshop-btn"))==null||t.addEventListener("click",()=>{var s;(s=this.engine)==null||s.enterWorkshop()}),(n=this.querySelector("#dungeon-chart-btn"))==null||n.addEventListener("click",async()=>{var r;D.show(a("global.dungeon_chart_title"),'<fieldset><dungeon-chart class="h-[50vh]"></dungeon-chart></fieldset>',[{text:a("global.close"),value:!1}]);const s=document.querySelector("dungeon-chart");s&&(s.data=(r=this.engine)==null?void 0:r.getDungeonChartData())})}}customElements.define("game-stats",Ve);class Ze extends HTMLElement{constructor(){super(),this._logger=null,this._traits=null,this._renderedLogCount=0}set logger(e){this._logger=e,this._logger.on(t=>this.render()),this.render()}set traits(e){this._traits=e,this.render()}connectedCallback(){this.render()}_getLogColor(e){switch(e){case"DEBUG":return"text-blue-400";case"INFO":return"";case"WARN":return"text-yellow-500";case"ERROR":return"text-red-500";default:return""}}_appendEntry(e,t){const n=this.querySelector("#log-container");if(n){const s=document.createElement("p");s.className=this._getLogColor(e.level),s.textContent=`[${t.toString().padStart(3,"0")}] ${e.message}`,n.appendChild(s)}}render(){if(!this._traits||!this._logger){this.innerHTML="",this._renderedLogCount=0;return}const e=this.querySelector("#log-container"),t=this._logger.entries;if(!e||t.length<this._renderedLogCount){const s=t.map((r,i)=>`<p class="${this._getLogColor(r.level)}">[${i.toString().padStart(3,"0")}] ${r.message}</p>`).join("");this.innerHTML=`
    ...
    `};class Ye extends HTMLElement{constructor(){super(),this._item=null,this._isSelected=!1,this._isDisabled=!1,this._isNewlyDrafted=!1,this._stackCount=1,this._isSelectable=!0,this._purchaseInfo=null,this.addEventListener("click",e=>{if(!this._isSelectable)return;const t=e.target;if(t.tagName!=="INPUT"&&t.tagName!=="LABEL"&&!this._purchaseInfo){const n=this.querySelector('input[type="checkbox"]');n&&!n.disabled&&(n.checked=!n.checked,n.dispatchEvent(new Event("change",{bubbles:!0})))}}),this.addEventListener("change",e=>{if(!this._isSelectable)return;e.target.type==="checkbox"&&!this._isDisabled&&this._item&&this.dispatchEvent(new CustomEvent("card-select",{bubbles:!0,composed:!0,detail:{instanceId:this._item.instanceId}}))}),this.addEventListener("animationend",e=>{e.animationName==="newly-drafted-animation"&&this.classList.remove("animate-newly-drafted")})}set item(e){this._item=e,this.render()}get item(){return this._item}set stackCount(e){this._stackCount=e,this.render()}get stackCount(){return this._stackCount}set isSelectable(e){this._isSelectable=e,this.render()}get isSelectable(){return this._isSelectable}set purchaseInfo(e){this._purchaseInfo=e,this.render()}get purchaseInfo(){return this._purchaseInfo}set isSelected(e){this._isSelected=e,this.render()}get isSelected(){return this._isSelected}set isDisabled(e){this._isDisabled=e,this.render()}get isDisabled(){return this._isDisabled}set isNewlyDrafted(e){this._isNewlyDrafted!==e&&(this._isNewlyDrafted=e,this._isNewlyDrafted&&this.classList.add("animate-newly-drafted"))}get isNewlyDrafted(){return this._isNewlyDrafted}connectedCallback(){this.render()}render(){if(!this._item)return;const e=Je[this._item.rarity]||"text-gray-400",t="relative transition-all duration-200",n=`card-checkbox-${this._item.instanceId}`;let s="";this._isSelectable&&(this._isDisabled?s="opacity-50 cursor-not-allowed":s="cursor-pointer");const r=this.classList.contains("animate-newly-drafted")?" animate-newly-drafted":"";this.className=`${t} ${s} ${r}`;let i=a("items_and_rooms."+this._item.id),l="";if("stats"in this._item){const c=this._item,u=this._item;switch(this._item.type){case"item_weapon":case"item_potion":case"item_armor":case"item_buff":l=`
          ...
          `;break;case"room_healing":l=`
            ${u.stats.hp?N(a("global.health"),u.stats.hp,!0):""}
          `;break;case"room_enemy":case"room_boss":case"room_trap":l=`
            ${u.stats.attack?N(a("global.attack"),u.stats.attack,!1,u.units):""}
            ${u.stats.hp?N(a("global.health"),u.stats.hp,!1,u.units):""}
          `,u.units>1&&(i=a("choice_panel.multiple_enemies_title",{name:i,count:u.units}));break}}this._stackCount>1&&(i=a("choice_panel.stacked_items_title",{name:i,count:this._stackCount}));const d=this._isSelected?"selected":"";this.innerHTML=`
    ...
    `;const e=this.querySelector("#item-cards");if(e){e.innerHTML="";for(const t of this._items){const n=document.createElement("choice-card");n.item=t,n.purchaseInfo={cost:t.cost||0,canAfford:this._balancePoints>=(t.cost||0)},e.appendChild(n)}}}}customElements.define("workshop-screen",Qe);class et extends HTMLElement{constructor(){super(),this.engine=null,this.metaManager=null,this.addEventListener("click",async e=>{if(!this.engine||!this.metaManager)return;const t=e.target;t.id==="new-game-button"?(this.metaManager.metaState.adventurers>0||this.metaManager.metaState.highestRun>0,this.engine.hasSaveGame()?await j.show(a("menu.new_game"),a("menu.new_game_confirm"))&&this.engine.startNewGame():this.engine.startNewGame()):t.id==="continue-game-button"?this.engine.continueGame():t.id==="reset-game-button"&&await j.show(a("menu.reset_save"),a("menu.reset_save_confirm"))&&(this.metaManager.reset(),this.engine.quitGame(!0),this.render())})}connectedCallback(){this.render()}render(){if(!this.metaManager||!this.engine)return;const e=this.metaManager.metaState,t=this.engine.hasSaveGame();let n="";if(t){const s=e.adventurers||0;n=`
      ...
      <div class="window" style="width: 400px;">
        ...
        <div class="status-bar">
          ...
          <p class="status-bar-field">build 187</p>
        </div>
      </div>
...
.connector-label {
  ...
  user-select: none;
    ...
    `,this.shadowRoot.appendChild(e)}_createSVGElement(e,t={}){const n=document.createElementNS("http://www.w3.org/2000/svg",e);for(const s in t)n.setAttribute(s,t[s]);return n}_prepareTree(e,t=0,n=null){const s=e,r=n;if(s.depth=t,s.parent=r,this._maxDepth=Math.max(this._maxDepth,t),this._allNodes.push(s),!s.children||s.children.length===0)return s.leafCount=1,1;let i=0;for(const l of s.children)i+=this._prepareTree(l,t+1,s);return s.leafCount=i,i}_calculatePositions(e,t,n){const r=this._maxDepth*(O+U)-e.depth*(O+U),i=t+(n-t)/2-L/2;if(this._positions.set(e.id,{x:i,y:r}),!e.children||e.children.length===0)return;let l=t;for(const d of e.children){const c=(n-t)*d.leafCount/e.leafCount;this._calculatePositions(d,l,l+c),l+=c}}_drawConnector(e,t){const n=this._positions.get(e.id),s=this._positions.get(t.id),r=this._data.path.includes(t.id)&&this._data.path.includes(e.id),i=n.x+L/2,l=n.y,d=s.x+L/2,c=s.y+O,u=l-U/2,h=this._createSVGElement("g"),m=this._createSVGElement("path",{d:`M ${i} ${l} V ${u} H ${d} V ${c}`,stroke:r?"var(--path-connector-color)":"var(--connector-color)","stroke-width":r?"2.5":"1.5",fill:"none"});h.appendChild(m);const f=this._data.linkLabels[t.id];if(f){const g=this._createSVGElement("text",{class:"connector-label",x:d+"",y:u+"",dy:"-4px"});g.textContent=f,r&&(g.style.fill="var(--path-connector-color)",g.style.fontWeight="700"),h.appendChild(g)}r?this._groupEl.appendChild(h):this._groupEl.prepend(h)}_drawNode(e){const t=this._positions.get(e.id),n=this._data.path.includes(e.id),s=this._createSVGElement("g"),r=this._createSVGElement("rect",{x:t.x,y:t.y,width:L+"",height:O+"",fill:n?"var(--path-node-bg)":"var(--node-bg)",stroke:n?"var(--path-node-border)":"var(--node-border)",class:"node-rect",filter:"url(#shadow)"});s.appendChild(r);const i=this._createSVGElement("text",{class:"node-text"}),l=e.label.split(" ");let d="";const c=[],u=L-20;for(let f=0;f<l.length;f++){const g=d+l[f]+" ",p=this._createSVGElement("text",{class:"node-text",style:"visibility: hidden;"});p.textContent=g,this._svgEl.appendChild(p);const y=p.getComputedTextLength();this._svgEl.removeChild(p),y>u&&f>0?(c.push(d),d=l[f]+" "):d=g}c.push(d);const h=16,m=t.y+O/2-(c.length-1)*h/2;i.setAttribute("y",m+""),c.forEach((f,g)=>{const p=this._createSVGElement("tspan",{x:t.x+L/2,dy:g===0?"0":`${h}px`});p.textContent=f.trim(),i.appendChild(p)}),s.appendChild(i),this._groupEl.appendChild(s)}_createDefs(){const e=this._createSVGElement("defs"),t=this._createSVGElement("filter",{id:"shadow",x:"-50%",y:"-50%",width:"200%",height:"200%"}),n=this._createSVGElement("feDropShadow",{dx:"2",dy:"2",stdDeviation:"3","flood-color":"var(--node-shadow)"});t.appendChild(n),e.appendChild(t),this._groupEl.parentElement.appendChild(e)}_getTouchDistance(e){const[t,n]=[e[0],e[1]];return Math.sqrt(Math.pow(n.clientX-t.clientX,2)+Math.pow(n.clientY-t.clientY,2))}_setupZoomAndPan(){let e=!1,t={x:0,y:0},n=0;const s=()=>{this._groupEl.setAttribute("transform",`translate(${this._transform.tx}, ${this._transform.ty}) scale(${this._transform.scale})`)};this._svgEl.addEventListener("wheel",i=>{i.preventDefault();const l=1.1,d=i.deltaY<0?l:1/l,c=this._svgEl.getBoundingClientRect(),u=i.clientX-c.left,h=i.clientY-c.top;this._transform.tx=u-(u-this._transform.tx)*d,this._transform.ty=h-(h-this._transform.ty)*d,this._transform.scale*=d,s()}),this._svgEl.addEventListener("mousedown",i=>{e=!0,t={x:i.clientX,y:i.clientY},this._svgEl.style.cursor="grabbing"}),this._svgEl.addEventListener("mousemove",i=>{if(!e)return;const l={x:i.clientX,y:i.clientY},d=l.x-t.x,c=l.y-t.y;this._transform.tx+=d,this._transform.ty+=c,t=l,s()});const r=()=>{e&&(e=!1,this._svgEl.style.cursor="grab")};this._svgEl.addEventListener("mouseup",r),this._svgEl.addEventListener("mouseleave",r),this._svgEl.addEventListener("touchstart",i=>{i.touches.length===1?(e=!0,t={x:i.touches[0].clientX,y:i.touches[0].clientY},this._svgEl.style.cursor="grabbing"):i.touches.length===2&&(n=this._getTouchDistance(i.touches))}),this._svgEl.addEventListener("touchmove",i=>{if(i.touches.length===1&&e){i.preventDefault();const l={x:i.touches[0].clientX,y:i.touches[0].clientY},d=l.x-t.x,c=l.y-t.y;this._transform.tx+=d,this._transform.ty+=c,t=l,s()}else if(i.touches.length===2){i.preventDefault();const l=this._getTouchDistance(i.touches),d=l/n,c=this._svgEl.getBoundingClientRect(),u=i.touches[0],h=i.touches[1],m=(u.clientX+h.clientX)/2-c.left,f=(u.clientY+h.clientY)/2-c.top;this._transform.tx=m-(m-this._transform.tx)*d,this._transform.ty=f-(f-this._transform.ty)*d,this._transform.scale*=d,n=l,s()}}),this._svgEl.addEventListener("touchend",i=>{i.touches.length<2&&r()})}_centerChart(){const e=this._groupEl.getBBox(),t=this.getBoundingClientRect();if(e.width===0||e.height===0)return;const n=80,s=t.width/(e.width+n),r=t.height/(e.height+n),i=Math.min(s,r,1);this._transform.scale=i,this._transform.tx=t.width/2-(e.x+e.width/2)*i,this._transform.ty=t.height/2-(e.y+e.height/2)*i,this._groupEl.setAttribute("transform",`translate(${this._transform.tx}, ${this._transform.ty}) scale(${this._transform.scale})`)}render(){if(this._svgEl&&this.shadowRoot.removeChild(this._svgEl),!this._data)return;this._svgEl=this._createSVGElement("svg"),this.shadowRoot.appendChild(this._svgEl),this._groupEl=this._createSVGElement("g"),this._svgEl.appendChild(this._groupEl),this._createDefs(),this._prepareTree(this._data.nodes);const e=this._data.nodes.leafCount*(L+it);this._calculatePositions(this._data.nodes,0,e);for(const t of this._allNodes)t.parent&&this._drawConnector(t.parent,t);for(const t of this._allNodes)this._drawNode(t);this._centerChart(),this._setupZoomAndPan()}}customElements.define("dungeon-chart",ot);const $=document.getElementById("app");if(!$)throw new Error("Could not find app element to mount to");async function at(){$.innerHTML="<div>Initializing...</div>";const o=new Pe;await ue(o);const e=new Oe,t=new Ae(e),n=new Me(e),s=new $e(t,o,n);s.on("state-change",r=>{if(s.isLoading){$.innerHTML=`<div>${a("global.loading_game_data")}</div>`;return}if(s.error){$.innerHTML=`
            ...
            `;return}Le($,r,s)}),s.on("show-encounter",async r=>{const{EncounterModal:i}=await de(async()=>{const{EncounterModal:l}=await Promise.resolve().then(()=>nt);return{EncounterModal:l}},void 0);await i.show(r),s.continueEncounter()}),$.innerHTML=`<div>${a("global.initializing")}</div>`,document.body.addEventListener("mouseover",r=>B.handleMouseEnter(r)),document.body.addEventListener("click",r=>B.handleClick(r)),await s.init(),s.showMenu()}at().catch(o=>{console.error(o),$&&($.innerHTML=`
      <div class="min-h-screen flex items-center justify-center p-4">
          <div class="bg-brand-surface p-8 rounded-xl shadow-2xl text-center border border-brand-secondary">
