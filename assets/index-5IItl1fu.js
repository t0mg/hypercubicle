(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();const re="modulepreload",le=function(i){return"/hypercubicle/"+i},j={},ce=function(e,t,n){let s=Promise.resolve();if(t&&t.length>0){let r=function(c){return Promise.all(c.map(m=>Promise.resolve(m).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),d=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=r(t.map(c=>{if(c=le(c),c in j)return;j[c]=!0;const m=c.endsWith(".css"),h=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${h}`))return;const u=document.createElement("link");if(u.rel=m?"stylesheet":re,m||(u.as="script"),u.crossOrigin="",u.href=c,d&&u.setAttribute("nonce",d),document.head.appendChild(u),m)return new Promise((p,g)=>{u.addEventListener("load",p),u.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return s.then(r=>{for(const l of r||[])l.status==="rejected"&&o(l.reason);return e().catch(o)})};var v=(i=>(i.Arousal="arousal",i.Flow="flow",i.Control="control",i.Relaxation="relaxation",i.Boredom="boredom",i.Apathy="apathy",i.Worry="worry",i.Anxiety="anxiety",i))(v||{});let Y={};async function X(i,e){try{Y=await e.loadJson(`locales/${i}.json`)}catch(t){console.warn(`Failed to load ${i} translations:`,t),i!=="en"&&await X("en",e)}}function de(){return typeof navigator<"u"&&navigator.language?navigator.language.split("-")[0]:"en"}function a(i,e={}){let n=i.split(".").reduce((s,o)=>s?s[o]:void 0,Y);if(!n)return console.warn(`Translation not found for key: ${i}`),i;for(const s in e)n=n.replace(`{${s}}`,String(e[s]));return n}async function he(i){const e=de();await X(e,i)}class E{constructor(){this.entries=[],this.listeners=[],this.muted=!1}static getInstance(){return E.instance||(E.instance=new E),E.instance}on(e){this.listeners.push(e)}log(e,t="INFO",n){const s=a(`log_messages.${e}`,n),o={message:s,level:t,timestamp:Date.now(),data:n};this.muted||(this.entries.push(o),t!=="DEBUG"&&console.log(`[${t}] ${s}`)),this.listeners.forEach(r=>r(o))}debug(e){const t={message:e,level:"DEBUG",timestamp:Date.now()};this.muted||this.entries.push(t),this.listeners.forEach(n=>n(t))}metric(e){const t={message:"metric",level:"DEBUG",timestamp:Date.now(),data:e};this.listeners.forEach(n=>n(t))}info(e,t){this.log(e,"INFO",t)}warn(e,t){this.log(e,"WARN",t)}error(e,t){this.log(e,"ERROR",t)}toJSON(){return{entries:this.entries}}loadEntries(e){this.entries=e||[]}static fromJSON(e){const t=E.getInstance();return t.loadEntries(e.entries),t}}class me{constructor(e){this.seed=e}setSeed(e){this.seed=e}nextFloat(){let e=this.seed+=1831565813;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}nextInt(e,t){return Math.floor(this.nextFloat()*(t-e+1))+e}}const x=new me(Date.now()),Q=i=>`${i}_${x.nextFloat().toString(36).substr(2,9)}`,ue=(i,e)=>x.nextInt(i,e),ee=i=>{const e=[...i];for(let t=e.length-1;t>0;t--){const n=x.nextInt(0,t);[e[t],e[n]]=[e[n],e[t]]}return e},te=(i,e,t,n)=>{const s=e.filter(h=>i.includes(h.id)),o=[],r={common:.6,uncommon:.3,rare:.1,legendary:0},l={common:0,uncommon:0,rare:0,legendary:0},d={common:0,uncommon:0,rare:0,legendary:0};Object.keys(r).forEach(h=>{d[h]=Math.floor(t*r[h])});let c=Object.values(d).reduce((h,u)=>h+u,0);for(;c<t;)d.common+=1,c+=1;s.filter(h=>h.cost!==null).forEach(h=>{o.push(n(h)),l[h.rarity]+=1}),Object.keys(r).forEach((h,u)=>{const p=s.filter(g=>g.rarity===h);for(;l[h]<d[h]&&p.length!==0;){const g=x.nextInt(0,p.length-1),f=p[g];o.push(n(f)),l[h]+=1}});const m=s.filter(h=>h.rarity==="common");for(;o.length<t&&m.length>0;){const h=x.nextInt(0,m.length-1),u=m[h];o.push(n(u))}return ee(o)},K=(i,e,t)=>te(i,e,t,n=>({...n,instanceId:Q(n.id)})),W=(i,e,t)=>te(i,e,t,s=>{const o={...s,instanceId:Q(s.id)};return o.type==="room_enemy"&&o.stats.minUnits&&o.stats.maxUnits&&(o.units=ue(o.stats.minUnits,o.stats.maxUnits)),o}),pe=i=>i.roomHand.length<3&&!i.roomHand.some(e=>e.type==="room_boss"),fe=i=>[...new Set(i.hand.map(t=>t.id))].length<2&&i.hand.length>0;function se(i,e){const t=Math.max(0,Math.min(100,i)),n=Math.max(0,Math.min(100,e));return n>66?t<33?v.Anxiety:t<87?v.Arousal:v.Flow:n>33?t<33?v.Worry:t<67?v.Apathy:v.Control:t<67?v.Boredom:v.Relaxation}const A={hp:100,maxHp:100,power:5},ge=3;class I{constructor(e,t){this.hp=A.hp,this.maxHp=A.maxHp,this.power=A.power,this.skill=e.skill,this.challengeHistory=[50],this.flowState=v.Boredom,this.traits=e,this.inventory={weapon:null,armor:null,potions:[]},this.activeBuffs=[],this.logger=E.getInstance(),this.roomHistory=[],this.lootHistory=[],this.boredomCounter=0,this.firstName=t?t.firstNames[Math.floor(Math.random()*t.firstNames.length)]:"Testy",this.lastName=t?t.lastNames[Math.floor(Math.random()*t.lastNames.length)]:"McTest"}get challenge(){return this.challengeHistory.length===0?50:this.challengeHistory.reduce((t,n)=>t+n,0)/this.challengeHistory.length}modifySkill(e){const t=this.skill;this.skill=Math.max(0,Math.min(100,this.skill+e)),t.toFixed(1)!==this.skill.toFixed(1)&&this.logger.debug(`Skill changed from ${t.toFixed(1)} to ${this.skill.toFixed(1)}`),this.updateFlowState()}modifyChallenge(e){const t=this.challenge,n=Math.max(0,Math.min(100,e));this.challengeHistory.push(n),this.challengeHistory.length>ge&&this.challengeHistory.shift(),this.logger.debug(`Challenge changed from ${t.toFixed(1)} to ${this.challenge.toFixed(1)} (new value: ${n})`),this.updateFlowState()}updateFlowState(){const e=this.flowState;this.flowState=se(this.skill,this.challenge),e!==this.flowState&&this.logger.info("info_flow_state_changed",{name:this.firstName,from:a("flow_states."+e),to:a("flow_states."+this.flowState)})}equip(e){e.type==="item_weapon"?this.inventory.weapon=e:e.type==="item_armor"&&(this.inventory.armor=e),this.recalculateStats()}addPotion(e){e.type==="item_potion"&&this.inventory.potions.push(e)}applyBuff(e){this.activeBuffs.push(e),this.recalculateStats()}updateBuffs(){const e=this.activeBuffs.filter(t=>t.stats.duration!==void 0&&t.stats.duration<=1);this.activeBuffs=this.activeBuffs.map(t=>(t.stats.duration&&(t.stats.duration-=1),t)).filter(t=>t.stats.duration===void 0||t.stats.duration>0),e.length>0&&this.recalculateStats()}recalculateStats(){const e=this.hp/this.maxHp;let t=A.power,n=A.maxHp;this.inventory.weapon&&(t+=this.inventory.weapon.stats.power||0,n+=this.inventory.weapon.stats.maxHp||0),this.inventory.armor&&(t+=this.inventory.armor.stats.power||0,n+=this.inventory.armor.stats.maxHp||0),this.activeBuffs.forEach(s=>{t+=s.stats.power||0,n+=s.stats.maxHp||0}),this.power=t,this.maxHp=n,this.hp=Math.round(this.maxHp*e)}toJSON(){return{hp:this.hp,maxHp:this.maxHp,power:this.power,traits:this.traits,inventory:this.inventory,activeBuffs:this.activeBuffs,skill:this.skill,challengeHistory:this.challengeHistory,flowState:this.flowState,roomHistory:this.roomHistory,lootHistory:this.lootHistory,boredomCounter:this.boredomCounter,firstName:this.firstName,lastName:this.lastName}}static fromJSON(e){const t=e.traits,n=new I(t);return n.hp=e.hp,n.maxHp=e.maxHp,n.power=e.power,n.inventory=e.inventory,n.activeBuffs=e.activeBuffs,n.skill=e.skill,n.challengeHistory=e.challengeHistory,n.flowState=e.flowState,n.roomHistory=e.roomHistory,n.lootHistory=e.lootHistory,n.boredomCounter=e.boredomCounter,n.firstName=e.firstName,n.lastName=e.lastName,n}}const _e=99,ve=10,B=10,V=32,ye=18,be=8;var C=(i=>(i.WORKSHOP="workshop",i.ROOM_DECK_SIZE_INCREASE="room_deck_size_increase",i.HAND_SIZE_INCREASE="hand_size_increase",i.ADVENTURER_TRAITS="ADVENTURER_TRAITS",i.BP_MULTIPLIER="BP_MULTIPLIER",i.WORKSHOP_ACCESS="WORKSHOP_ACCESS",i.BP_MULTIPLIER_2="BP_MULTIPLIER_2",i))(C||{});const ne=[{feature:"workshop",runThreshold:2,title:()=>a("unlocks.workshop.title"),description:()=>a("unlocks.workshop.description")},{feature:"room_deck_size_increase",runThreshold:3,title:()=>a("unlocks.room_deck_size_increase.title"),description:()=>a("unlocks.room_deck_size_increase.description")},{feature:"hand_size_increase",runThreshold:4,title:()=>a("unlocks.hand_size_increase.title"),description:()=>a("unlocks.hand_size_increase.description")},{feature:"ADVENTURER_TRAITS",runThreshold:5,title:()=>a("unlocks.adventurer_traits.title"),description:()=>a("unlocks.adventurer_traits.description")},{feature:"BP_MULTIPLIER",runThreshold:8,title:()=>a("unlocks.bp_multiplier.title"),description:()=>a("unlocks.bp_multiplier.description")},{feature:"WORKSHOP_ACCESS",runThreshold:13,title:()=>a("unlocks.workshop_access.title"),description:()=>a("unlocks.workshop_access.description")},{feature:"BP_MULTIPLIER_2",runThreshold:21,title:()=>a("unlocks.bp_multiplier_2.title"),description:()=>a("unlocks.bp_multiplier_2.description")}],ie=10;function ae(i,e){var c,m,h,u;const{traits:t,inventory:n,hp:s,maxHp:o}=i;let r=(e.rarity==="uncommon"?2:e.rarity==="rare"?3:1)*5;const l=((c=n.weapon)==null?void 0:c.stats.power)||0,d=((m=n.armor)==null?void 0:m.stats.maxHp)||0;switch(e.type){case"item_weapon":const p=(e.stats.power||0)-l;if(p<=0&&e.id!==((h=n.weapon)==null?void 0:h.id))return-1;r+=p*(t.offense/10),p>0&&(r+=p*(i.skill/10));const g=e.stats.maxHp||0;g<0&&(r+=g*(100-t.resilience)/20);break;case"item_armor":const f=(e.stats.maxHp||0)-d;if(f<=0&&e.id!==((u=n.armor)==null?void 0:u.id))return-1;r+=f*(100-t.offense)/10,f>0&&(r+=f*(i.skill/10));const y=e.stats.power||0;y>0&&(r+=y*(t.offense/15));const b=e.stats.power||0;b<0&&(r+=b*(t.resilience/10));break;case"item_potion":const w=s/o;r+=10*(100-t.resilience)/100,w<.7&&(r+=20*(1-w)),r+=5*(i.skill/100),n.potions.length>=_e&&(r*=.1);break}return r}function we(i,e,t){t.debug(`--- Adventurer Loot Decision --- (Offense: ${i.traits.offense}, Resilience: ${i.traits.resilience}, Skill: ${i.skill})`);const n=e.map(o=>({item:o,score:ae(i,o)})).filter(o=>o.score>0);if(n.sort((o,r)=>r.score-o.score),n.length===0||n[0].score<ve)return null;const s=n[0].item;return t.debug(`Adventurer chooses: ${a("items_and_rooms."+s.id)} (Score: ${n[0].score.toFixed(1)})`),s}function Se(i,e){const{flowState:t,hp:n,maxHp:s,inventory:o,traits:r}=i,l=n/s;if(o.potions.length===0)return"attack";let d=.5;switch(t){case v.Anxiety:case v.Worry:d=.8;break;case v.Arousal:case v.Flow:d=.6;break;case v.Control:case v.Relaxation:d=.4;break;case v.Boredom:case v.Apathy:d=.2;break}return d-=r.resilience/200,l<Math.max(.1,d)?"use_potion":"attack"}function xe(i,e,t){if(e){i.lootHistory.push(e.id),i.lootHistory.filter(o=>o===e.id).length>2&&(i.modifyChallenge(i.challenge-ie),i.logger.info("info_repetitive_choice",{name:a("items_and_rooms."+e.id)}));const s=ae(i,e);s>60?(i.modifySkill(10),i.modifyChallenge(i.challenge+5)):s>30?(i.modifySkill(5),i.modifyChallenge(i.challenge+2)):i.modifySkill(2)}else t.length>0?i.modifyChallenge(i.challenge-5):i.modifyChallenge(i.challenge-10);i.updateFlowState()}function ke(i,e){i.roomHistory.push(e.id),i.roomHistory.filter(s=>s===e.id).length>2&&(i.modifyChallenge(i.challenge-ie),i.logger.info("info_deja_vu",{name:a("items_and_rooms."+e.id)}));let n=0;switch(e.type){case"room_enemy":n=5;break;case"room_boss":n=15;break;case"room_trap":n=10;break;case"room_healing":n=-15;break}i.modifyChallenge(i.challenge+n),i.updateFlowState()}function Ee(i){i.modifySkill(-2),i.updateFlowState()}function q(i,e){switch(e){case"hit":i.modifySkill(.5);break;case"miss":i.modifySkill(-.5);break;case"take_damage":i.modifyChallenge(i.challenge+1);break}i.updateFlowState()}function Ce(i,e,t,n){let s;return e>.7?(s=a("game_engine.too_close_for_comfort"),i.modifyChallenge(i.challenge+10),i.modifySkill(-3)):e>.4?(s=a("game_engine.great_battle"),i.modifyChallenge(i.challenge+5),i.modifySkill(5)):t>3&&i.traits.offense>60?(s=a("game_engine.easy_fight"),i.modifyChallenge(i.challenge-10)):(s=a("game_engine.worthy_challenge"),i.modifyChallenge(i.challenge-2),i.modifySkill(2)),t===n&&i.modifySkill(1*t),i.updateFlowState(),s}const _=E.getInstance();class Ie{constructor(e,t,n){this.gameState=null,this.isLoading=!0,this.error=null,this._allItems=[],this._allRooms=[],this._allNames={firstNames:[],lastNames:[]},this._listeners={},this.init=async()=>{await this._loadGameData()},this.startNewGame=s=>{this.metaManager.incrementAdventurers();const o={offense:x.nextInt(10,90),resilience:x.nextInt(10,90),skill:0};_.loadEntries([]);const r=new I(o,this._allNames),l=(s==null?void 0:s.items)||this._allItems.filter(y=>y.cost===null).map(y=>y.id),d=K(l,this._allItems,V),c=this._getHandSize(),m=d.slice(0,c),h=d.slice(c),u=(s==null?void 0:s.rooms)||this._allRooms.filter(y=>y.cost===null).map(y=>y.id),p=W(u,this._allRooms,this._getRoomDeckSize()),g=p.slice(0,c),f=p.slice(c);this.gameState={phase:"DESIGNER_CHOOSING_ROOM",designer:{balancePoints:0},adventurer:r,unlockedDeck:l,availableDeck:h,hand:m,unlockedRoomDeck:u,availableRoomDeck:f,roomHand:g,handSize:c,shopItems:[],offeredLoot:[],offeredRooms:[],run:1,room:1,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null},_.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),_.debug(`Deck size: ${d.length}, Hand size: ${c}, Room Deck size: ${p.length}, Room Hand size: ${g.length}`),_.info("info_designer_choosing_room",{name:r.firstName}),this._emit("state-change",this.gameState)},this.continueGame=()=>{const s=this.gameSaver.load();s?(this.gameState=s,this._emit("state-change",this.gameState),this.gameState.phase==="AWAITING_ENCOUNTER_RESULT"&&this.gameState.encounterPayload&&this._emit("show-encounter",this.gameState.encounterPayload)):this.startNewGame()},this.startNewRun=s=>{if(!this.gameState)return;const o=s||this.gameState.run+1;this.metaManager.updateRun(o);const r=this._getHandSize(),l=K(this.gameState.unlockedDeck,this._allItems,V),d=l.slice(0,r),c=l.slice(r),m=W(this.gameState.unlockedRoomDeck,this._allRooms,this._getRoomDeckSize()),h=m.slice(0,r),u=m.slice(r),p=new I(this.gameState.adventurer.traits,this._allNames);p.skill=this.gameState.adventurer.skill,p.challengeHistory=[...this.gameState.adventurer.challengeHistory],p.flowState=this.gameState.adventurer.flowState,_.info("info_adventurer_returns",{name:p.firstName}),_.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),this.gameState={...this.gameState,adventurer:p,phase:"DESIGNER_CHOOSING_ROOM",availableDeck:c,hand:d,availableRoomDeck:u,roomHand:h,handSize:r,room:1,run:o,runEnded:{isOver:!1,reason:"",success:!1,decision:null}},_.info("info_designer_choosing_room",{name:p.firstName}),this._emit("state-change",this.gameState)},this.presentOffer=s=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_LOOT"||!this.gameState.hand)return;const o=this.gameState.hand.filter(w=>s.includes(w.instanceId));this.gameState.offeredLoot=o;const r=this.gameState.adventurer,l=we(r,this.gameState.offeredLoot,_),d=this.gameState.offeredLoot.map(w=>a("items_and_rooms."+w.id)).join(", ");_.info("info_loot_chosen",{name:r.firstName,items:d});const c=r.flowState;xe(r,l,this.gameState.offeredLoot),c!==r.flowState&&_.metric({event:"flow_state_changed",flowState:r.flowState}),l?(_.info("info_item_chosen",{name:r.firstName,item:a("items_and_rooms."+l.id)}),_.metric({event:"item_chosen",item:l})):_.info("info_loot_declined",{name:r.firstName});let m=this.gameState.hand,h=this.gameState.availableDeck;m.forEach(w=>w.justDrafted=!1);let u=m.filter(w=>!s.includes(w.instanceId));const p=this.gameState.handSize-u.length,g=h.slice(0,p);g.forEach(w=>{w.draftedRoom=this.gameState.room,w.justDrafted=!0});const f=h.slice(p);u.push(...g),l&&(l.type==="item_potion"?r.addPotion(l):l.type==="item_buff"?r.applyBuff(l):r.equip(l));const y=this.gameState.room+1,b=this.gameState.designer.balancePoints+this._getBpPerRoom();this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",adventurer:r,availableDeck:f,hand:u,room:y,designer:{balancePoints:b}},_.info("info_designer_choosing_room",{name:r.firstName}),this._emit("state-change",this.gameState)},this.runEncounter=s=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_ROOM")return;this.gameState.offeredRooms=s;const o=x.nextInt(0,this.gameState.offeredRooms.length-1),r=this.gameState.offeredRooms[o];if(this.gameState.offeredRooms.length===1&&r.type==="room_boss")_.info("info_boss_room_chosen",{name:this.gameState.adventurer.firstName,chosenRoom:a("items_and_rooms."+r.id)});else{const m=this.gameState.offeredRooms.map(h=>a("items_and_rooms."+h.id)).join(", ");_.info("info_room_chosen",{name:this.gameState.adventurer.firstName,rooms:m})}_.metric({event:"room_encountered",room:r});const{log:l,finalAdventurer:d}=this._generateEncounterLog(this.gameState.adventurer,r),c={room:r,log:l,finalAdventurer:d};this.gameState={...this.gameState,phase:"AWAITING_ENCOUNTER_RESULT",encounterPayload:c},this._emit("state-change",this.gameState),this._emit("show-encounter",c)},this.continueEncounter=()=>{!this.gameState||this.gameState.phase!=="AWAITING_ENCOUNTER_RESULT"||this._postEncounterUpdate()},this._postEncounterUpdate=()=>{if(!this.gameState)return;const s=I.fromJSON(this.gameState.encounterPayload.finalAdventurer);s.updateBuffs(),this.gameState.designer.balancePoints+=this._getBpPerRoom();let o=this.gameState.roomHand,r=this.gameState.availableRoomDeck;o.forEach(u=>u.justDrafted=!1);const l=this.gameState.offeredRooms.map(u=>u.instanceId);let d=o.filter(u=>!l.includes(u.instanceId));const c=this.gameState.handSize-d.length,m=r.slice(0,c);m.forEach(u=>{u.draftedRoom=this.gameState.room,u.justDrafted=!0});const h=r.slice(c);if(d.push(...m),this.gameState.adventurer=s,s.hp<=0){this._endRun(a("game_engine.adventurer_fell",{room:this.gameState.room,run:this.gameState.run}));return}if(s.boredomCounter>2){const u=s.flowState===v.Boredom?a("game_engine.adventurer_bored",{room:this.gameState.room,run:this.gameState.run}):a("game_engine.adventurer_apathy",{room:this.gameState.room,run:this.gameState.run});this._endRun(u);return}this.gameState.hand&&this.gameState.hand.length===0?(_.warn("warn_empty_hand",{name:s.firstName}),this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",room:this.gameState.room+1,designer:{balancePoints:this.gameState.designer.balancePoints+this._getBpPerRoom()},encounterPayload:void 0,roomHand:d,availableRoomDeck:h},_.info("info_designer_choosing_room",{name:s.firstName})):(this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_LOOT",encounterPayload:void 0,roomHand:d,availableRoomDeck:h},_.info("info_designer_choosing_loot",{name:s.firstName})),this._emit("state-change",this.gameState)},this.forceEndRun=()=>{this.gameState&&(this.gameState.adventurer.modifyChallenge(-20),this.gameState.adventurer.updateFlowState(),this._endRun(a("game_engine.no_more_rooms"),!0))},this.enterWorkshop=()=>{if(!this.gameState)return;if(!this.metaManager.acls.has(C.WORKSHOP)){_.debug("Workshop not unlocked, starting new run directly."),this.startNewRun();return}_.info("info_entering_workshop",{name:this.gameState.adventurer.firstName});const s=this.gameState.run+1,o=this._allItems.filter(d=>d.cost!==null).filter(d=>!this.gameState.unlockedDeck.includes(d.id)),r=this._allRooms.filter(d=>d.cost!==null).filter(d=>!this.gameState.unlockedRoomDeck.includes(d.id)),l=[...o,...r];this.gameState={...this.gameState,phase:"SHOP",shopReturnPhase:this.gameState.phase,run:s,room:0,shopItems:ee(l).slice(0,4),runEnded:{isOver:!1,reason:"",success:!1,decision:null}},_.info("info_welcome_to_workshop"),this._emit("state-change",this.gameState)},this.exitWorkshop=()=>{this.gameState&&this.startNewRun()},this.purchaseItem=s=>{if(!this.gameState)return;const o=this._allItems.find(g=>g.id===s),r=this._allRooms.find(g=>g.id===s),l=o||r;if(!l||l.cost===null||this.gameState.designer.balancePoints<l.cost)return;let d=this.gameState.unlockedDeck,c=this.gameState.unlockedRoomDeck,m=this.gameState.availableDeck,h=this.gameState.availableRoomDeck;o?(d=[...this.gameState.unlockedDeck,s],this.isWorkshopAccessUnlocked()&&(m=[o,...this.gameState.availableDeck])):r&&(c=[...this.gameState.unlockedRoomDeck,s],this.isWorkshopAccessUnlocked()&&(h=[r,...this.gameState.availableRoomDeck]));const u=this.gameState.designer.balancePoints-l.cost,p=this.gameState.shopItems.filter(g=>g.id!==s);_.info("info_item_purchased",{name:this.gameState.adventurer.firstName,item:a("items_and_rooms."+l.id)}),_.metric({event:"item_purchased",item:l}),this.gameState={...this.gameState,designer:{balancePoints:u},unlockedDeck:d,unlockedRoomDeck:c,availableDeck:m,availableRoomDeck:h,shopItems:p},this._emit("state-change",this.gameState)},this.quitGame=(s=!0)=>{s&&this.gameSaver.clear(),this.showMenu()},this.showMenu=()=>{this.gameState={...this.gameState||this._getInitialGameState(),phase:"MENU"},this._emit("state-change",this.gameState)},this._getBpPerRoom=()=>this.metaManager.acls.has(C.BP_MULTIPLIER_2)?B*4:this.metaManager.acls.has(C.BP_MULTIPLIER)?B*2:B,this.saveGame=()=>{this.gameState&&this.gameState.phase!=="MENU"&&this.gameState.phase!=="RUN_OVER"&&this.gameSaver.save(this.gameState)},this.metaManager=e,this.dataLoader=t,this.gameSaver=n}on(e,t){this._listeners[e]||(this._listeners[e]=[]),this._listeners[e].push(t)}_emit(e,...t){e==="state-change"&&this.saveGame();const n=this._listeners[e];n&&n.forEach(s=>s(...t))}_createAdventurerSnapshot(e){return{firstName:e.firstName,lastName:e.lastName,hp:e.hp,maxHp:e.maxHp,power:e.power,flowState:e.flowState,inventory:JSON.parse(JSON.stringify(e.inventory))}}_generateEncounterLog(e,t){var r;const n=[],s=I.fromJSON(e.toJSON());_.info("info_encounter",{name:s.firstName,roomName:a("items_and_rooms."+t.id)});const o=s.flowState;switch(ke(s,t),o!==s.flowState&&_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_encounter",replacements:{name:s.firstName,roomName:a("items_and_rooms."+t.id)},adventurer:this._createAdventurerSnapshot(s)}),t.type){case"room_enemy":case"room_boss":{const l={enemyCount:t.units??1,enemyPower:t.stats.attack||5,enemyHp:t.stats.hp||10};let d=0;const c=s.hp;for(let g=0;g<l.enemyCount;g++){let f=l.enemyHp;_.info("info_encounter_enemy",{name:s.firstName,enemyName:t.entity_id?a("entities."+t.entity_id):a("items_and_rooms."+t.id),current:g+1,total:l.enemyCount});const y=t.entity_id?a("entities."+t.entity_id):a("items_and_rooms."+t.id),b={currentHp:f,maxHp:l.enemyHp,power:l.enemyPower,name:y,count:g+1,total:l.enemyCount};for(n.push({messageKey:"log_messages.info_encounter_enemy",replacements:{name:s.firstName,enemyName:t.entity_id?a("entities."+t.entity_id):a("items_and_rooms."+t.id),current:g+1,total:l.enemyCount},adventurer:this._createAdventurerSnapshot(s),enemy:b});f>0&&s.hp>0;){if(Se(s)==="use_potion"){const S=s.inventory.potions.shift();if(S){const k=S.stats.hp||0;s.hp=Math.min(s.maxHp,s.hp+k),_.info("info_adventurer_drinks_potion",{name:s.firstName,potionName:a("items_and_rooms."+S.id)}),n.push({messageKey:"log_messages.info_adventurer_drinks_potion",replacements:{name:s.firstName,potionName:a("items_and_rooms."+S.id)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:f}})}}else{const S=Math.min(.95,.75+s.traits.skill/500+s.traits.offense/1e3);if(x.nextFloat()<S){const k=s.power;f-=k,_.debug(`Adventurer hits for ${k} damage.`);const H=s.flowState;q(s,"hit"),H!==s.flowState&&(_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:s.firstName,from:a(`flow_states.${H}`),to:a(`flow_states.${s.flowState}`)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:f}})),n.push({messageKey:"log_messages.info_adventurer_hit",replacements:{name:s.firstName,damage:k},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:f},animations:[{target:"adventurer",animation:"attack"},{target:"enemy",animation:"shake"}]})}else{_.debug("Adventurer misses.");const k=s.flowState;q(s,"miss"),k!==s.flowState&&(_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:s.firstName,from:a(`flow_states.${k}`),to:a(`flow_states.${s.flowState}`)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:f}})),n.push({messageKey:"log_messages.info_adventurer_miss",replacements:{name:s.firstName},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:f},animations:[{target:"adventurer",animation:"attack"}]})}}if(f<=0){_.info("info_enemy_defeated",{enemyName:b.name}),d++,n.push({messageKey:"log_messages.info_enemy_defeated",replacements:{enemyName:b.name},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:0},animations:[{target:"enemy",animation:"defeat"}]});break}const R=Math.max(.4,.75-s.traits.skill/500-(100-s.traits.offense)/1e3);if(x.nextFloat()<R){const S=(((r=s.inventory.armor)==null?void 0:r.stats.maxHp)||0)/10,k=Math.max(1,l.enemyPower-S);s.hp-=k,_.debug(`Enemy hits for ${k} damage.`);const H=s.flowState;q(s,"take_damage"),H!==s.flowState&&(_.metric({event:"flow_state_changed",flowState:s.flowState}),n.push({messageKey:"log_messages.info_flow_state_changed",replacements:{name:s.firstName,from:a(`flow_states.${H}`),to:a(`flow_states.${s.flowState}`)},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:f}})),n.push({messageKey:"log_messages.info_enemy_hit",replacements:{damage:k,enemyName:b.name},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:f},animations:[{target:"enemy",animation:"attack"},{target:"adventurer",animation:"shake"}]})}else _.debug("Enemy misses."),n.push({messageKey:"log_messages.info_enemy_miss",replacements:{enemyName:b.name},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:f},animations:[{target:"enemy",animation:"attack"}]})}if(s.hp<=0){_.warn("info_adventurer_defeated",{name:s.firstName}),n.push({messageKey:"log_messages.info_adventurer_defeated",replacements:{name:s.firstName},adventurer:this._createAdventurerSnapshot(s),enemy:{...b,currentHp:f},animations:[{target:"adventurer",animation:"defeat"}]});break}}const m=c-s.hp,h=m/s.maxHp;_.debug(`hpLost: ${m}, hpLostRatio: ${h.toFixed(2)}`);const u=s.flowState,p=Ce(s,h,d,l.enemyCount);u!==s.flowState&&_.metric({event:"flow_state_changed",flowState:s.flowState}),_.info("info_battle_outcome",{outcome:p});break}case"room_healing":{const l=t.stats.hp||0;s.hp=Math.min(s.maxHp,s.hp+l),_.info("info_healing_room",{name:s.firstName,healingRoomName:a("items_and_rooms."+t.id),healing:l}),n.push({messageKey:"log_messages.info_healing_room",replacements:{name:s.firstName,healingRoomName:a("items_and_rooms."+t.id),healing:l},adventurer:this._createAdventurerSnapshot(s)});break}case"room_trap":{const l=t.stats.attack||0;s.hp-=l;const d=s.flowState;Ee(s),d!==s.flowState&&_.metric({event:"flow_state_changed",flowState:s.flowState}),_.info("info_trap_room",{name:s.firstName,trapName:a("items_and_rooms."+t.id),damage:l}),n.push({messageKey:"log_messages.info_trap_room",replacements:{name:s.firstName,trapName:a("items_and_rooms."+t.id),damage:l},adventurer:this._createAdventurerSnapshot(s)});break}}return{log:n,finalAdventurer:s}}_endRun(e,t=!1){if(!this.gameState)return;this.metaManager.updateRun(this.gameState.run);const n=this.metaManager.checkForUnlocks(this.gameState.run);_.debug(`Run ended with ${this.gameState.designer.balancePoints} BP.`),_.metric({event:"run_end",bp:this.gameState.designer.balancePoints}),_.error("info_game_over",{reason:e});const s=this._getAdventurerEndRunDecision();this.gameState={...this.gameState,phase:"RUN_OVER",runEnded:{isOver:!0,reason:e,success:t,decision:s},newlyUnlocked:n},this._emit("state-change",this.gameState)}_getAdventurerEndRunDecision(){if(!this.gameState)return"retire";const{flowState:e,traits:t,skill:n}=this.gameState.adventurer,{resilience:s,offense:o}=t,r=Math.min(n/100,1);if(e===v.Flow)return"continue";let l=.55;switch(e){case v.Anxiety:l+=.25-s/400;break;case v.Arousal:l-=.1-o/1e3;break;case v.Worry:l+=.2;break;case v.Control:l-=.15;break;case v.Relaxation:l+=.1;break;case v.Boredom:l+=.3;break;case v.Apathy:l+=.4;break}return l-=r*.1,l=Math.max(.05,Math.min(.95,l)),x.nextFloat()<l?"retire":"continue"}handleEndOfRun(e){if(this.gameState){if(_.info("info_adventurer_decision",{name:this.gameState.adventurer.firstName,decision:e}),e==="retire"){this.quitGame(!0);return}this.enterWorkshop()}}_getInitialGameState(){const e={offense:x.nextInt(10,90),resilience:x.nextInt(10,90),skill:0},t=new I(e,this._allNames);return{phase:"MENU",designer:{balancePoints:0},adventurer:t,unlockedDeck:[],availableDeck:[],hand:[],unlockedRoomDeck:[],availableRoomDeck:[],roomHand:[],handSize:this._getHandSize(),shopItems:[],offeredLoot:[],offeredRooms:[],run:0,room:0,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null}}_getHandSize(){return this.metaManager.acls.has(C.HAND_SIZE_INCREASE)?12:be}_getRoomDeckSize(){return this.metaManager.acls.has(C.ROOM_DECK_SIZE_INCREASE)?36:ye}isWorkshopAccessUnlocked(){return this.metaManager.acls.has(C.WORKSHOP_ACCESS)}isWorkshopUnlocked(){return this.metaManager.acls.has(C.WORKSHOP)}hasSaveGame(){return this.gameSaver.hasSaveGame()}async _loadGameData(){try{this._allItems=await this.dataLoader.loadJson("game/items.json"),this._allRooms=await this.dataLoader.loadJson("game/rooms.json"),this._allNames=await this.dataLoader.loadJson("game/names.json")}catch(e){this.error=e.message||a("global.unknown_error"),this._emit("error",null)}finally{this.isLoading=!1,this._emit("state-change",this.gameState)}}}class D{constructor(e,t,n,s){this.resolve=s;const o=document.createElement("div");o.dataset.testid="info-modal-overlay",Object.assign(o.style,{position:"fixed",top:"0",left:"0",right:"0",bottom:"0",backgroundColor:"rgba(0, 0, 0, 0.4)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:"1000"}),o.addEventListener("click",f=>{if(f.target===o){const y=n.find(b=>typeof b.value=="boolean"&&b.value===!1);y&&this.dismiss(y.value)}});const r=document.createElement("div");this.element=r,r.className="window",r.style.width="min(90vw, 800px)",r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true"),r.setAttribute("aria-labelledby","info-modal-title");const l=document.createElement("div");l.className="title-bar";const d=document.createElement("div");d.id="info-modal-title",d.className="title-bar-text",d.textContent=e,l.appendChild(d),r.appendChild(l);const c=document.createElement("div");c.className="window-body text-center p-4";const m=document.createElement("div");m.innerHTML=t,c.appendChild(m);const h=document.createElement("div");h.className="flex justify-center gap-2 mt-4",n.forEach(f=>{const y=document.createElement("button");y.textContent=f.text,y.addEventListener("click",()=>{this.dismiss(f.value)}),h.appendChild(y)}),c.appendChild(h),r.appendChild(c),o.appendChild(r),document.body.appendChild(o),this.handleKeydown=f=>{if(f.key==="Escape"){const y=n.find(b=>typeof b.value=="boolean"&&b.value===!1);y&&this.dismiss(y.value)}},document.addEventListener("keydown",this.handleKeydown);const u=r.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'),p=u[0],g=u[u.length-1];p==null||p.focus(),r.addEventListener("keydown",f=>{f.key==="Tab"&&(f.shiftKey?document.activeElement===p&&(g.focus(),f.preventDefault()):document.activeElement===g&&(p.focus(),f.preventDefault()))})}dismiss(e){this.element.parentElement.remove(),document.removeEventListener("keydown",this.handleKeydown),this.resolve(e)}static show(e,t,n){return new Promise(s=>{new D(e,t,n,s)})}static showInfo(e,t,n=a("global.continue")){const s=[{text:n,value:void 0}];return D.show(e,t,s)}}class U{static show(e,t){const n=[{text:a("global.cancel"),value:!1,variant:"secondary"},{text:a("global.confirm"),value:!0,variant:"primary"}];return D.show(e,t,n)}}class $e extends HTMLElement{constructor(){super(),this.isDesktop=!0,this.attachShadow({mode:"open"}),this.onclick=t=>{window.matchMedia("(pointer: coarse)").matches&&t.target===this&&this.hide()};const e=document.createElement("style");e.textContent=`
  ...
  <div class="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div id="game-phase-panel" class="window-body"></div>
            ...
            <div class="flex gap-2">
                ...
                <div class="sunken-panel p-2 flex flex-col items-center justify-center" data-tooltip-key="adventurer_power">
                    <div class="flex items-center">${Be()} <span class="ml-1">${a("global.power")}</span></div>
    ...
    `,this._canvas=this.querySelector("canvas"),this._ctx=this._canvas.getContext("2d"),this.render()}attributeChangedCallback(e,t,n){t!==n&&(e==="skill"&&(this._skill=parseFloat(n)),e==="challenge"&&(this._challenge=parseFloat(n)),this.render())}render(){if(!this._ctx||!this._canvas)return;this._backgroundRendered||this._renderBackground();const e=this.querySelector("#flow-chart-dot"),t=Math.max(0,Math.min(100,this._skill)),n=100-Math.max(0,Math.min(100,this._challenge));e.style.left=`${t}%`,e.style.top=`${n}%`}_renderBackground(){if(!this._ctx||!this._canvas)return;const e=this._ctx;for(let t=0;t<100;t++)for(let n=0;n<100;n++){const s=se(t,100-n);e.fillStyle=this.getFlowStateCanvasColor(s),e.fillRect(t,n,1,1)}e.font='12px "Pixelated MS Sans Serif"',e.fillStyle="black",e.strokeStyle="white",e.lineWidth=2,e.textAlign="center",e.strokeText("Skill",50,95),e.fillText("Skill",50,95),e.save(),e.translate(12,50),e.rotate(-Math.PI/2),e.strokeText("Challenge",0,0),e.fillText("Challenge",0,0),e.restore(),this._backgroundRendered=!0}getFlowStateCanvasColor(e){switch(e){case v.Apathy:return"rgba(239, 68, 68, 0.2)";case v.Boredom:return"rgba(239, 68, 68, 0.6)";case v.Anxiety:return"rgba(249, 115, 22, 0.6)";case v.Worry:return"rgba(249, 115, 22, 0.2)";case v.Arousal:return"rgba(59, 130, 246, 0.8)";case v.Control:return"rgba(59, 130, 246, 0.4)";case v.Relaxation:return"rgba(59, 130, 246, 0.2)";case v.Flow:return"#eab308";default:return"#000000"}}}customElements.define("flow-chart",je);class Ke extends HTMLElement{constructor(){super(),this.state="initial",this.decision=null,this.engine=null,this.newlyUnlocked=[],this.addEventListener("click",e=>{const t=e.composedPath()[0];t.id==="continue-run-button"&&this.engine?this.engine.handleEndOfRun("continue"):t.id==="retire-run-button"&&this.engine&&this.engine.handleEndOfRun("retire")})}static get observedAttributes(){return["workshop-unlocked"]}async initialize(e,t,n){this.decision=e,this.newlyUnlocked=t,this.engine=n,this.render(),await this.startFlow()}async startFlow(){this.newlyUnlocked.length>0?await this.renderUnlock():(this.state="unlock-revealed",this.revealDecision())}async renderUnlock(){const e=ne.find(s=>s.feature===this.newlyUnlocked[0]);if(!e)return;const t=a("unlocks.title"),n=`
        ...
        `,(t=this.querySelector("#enter-workshop-btn"))==null||t.addEventListener("click",()=>{var n;(n=this.engine)==null||n.enterWorkshop()})}}customElements.define("game-stats",We);class Ve extends HTMLElement{constructor(){super(),this._logger=null,this._traits=null,this._renderedLogCount=0}set logger(e){this._logger=e,this._logger.on(t=>this.render()),this.render()}set traits(e){this._traits=e,this.render()}connectedCallback(){this.render()}_getLogColor(e){switch(e){case"DEBUG":return"text-blue-400";case"INFO":return"";case"WARN":return"text-yellow-500";case"ERROR":return"text-red-500";default:return""}}_appendEntry(e,t){const n=this.querySelector("#log-container");if(n){const s=document.createElement("p");s.className=this._getLogColor(e.level),s.textContent=`[${t.toString().padStart(3,"0")}] ${e.message}`,n.appendChild(s)}}render(){if(!this._traits||!this._logger){this.innerHTML="",this._renderedLogCount=0;return}const e=this.querySelector("#log-container"),t=this._logger.entries;if(!e||t.length<this._renderedLogCount){const s=t.map((o,r)=>`<p class="${this._getLogColor(o.level)}">[${r.toString().padStart(3,"0")}] ${o.message}</p>`).join("");this.innerHTML=`
        <pre class="m-2 mt-6 max-h-[100px] md:max-h-[280px] overflow-y-auto space-y-1" id="log-container">
            ${s}
        </pre>
      `,this._renderedLogCount=t.length}else if(t.length>this._renderedLogCount){for(let s=this._renderedLogCount;s<t.length;s++)this._appendEntry(t[s],s);this._renderedLogCount=t.length}const n=this.querySelector("#log-container");n&&(n.scrollTop=n.scrollHeight)}}customElements.define("log-panel",Ve);const Ze={common:"text-rarity-common",uncommon:"text-rarity-uncommon",rare:"text-rarity-rare",legendary:"text-rarity-legendary"},T=(i,e,t=!0,n=1)=>{const s=t?"text-green-600":"text-red-400",o=t&&e>0?"+":"";return`
    ...
    `};class Je extends HTMLElement{constructor(){super(),this._item=null,this._isSelected=!1,this._isDisabled=!1,this._isNewlyDrafted=!1,this._stackCount=1,this._isSelectable=!0,this._purchaseInfo=null,this.addEventListener("click",e=>{if(!this._isSelectable)return;const t=e.target;if(t.tagName!=="INPUT"&&t.tagName!=="LABEL"&&!this._purchaseInfo){const n=this.querySelector('input[type="checkbox"]');n&&!n.disabled&&(n.checked=!n.checked,n.dispatchEvent(new Event("change",{bubbles:!0})))}}),this.addEventListener("change",e=>{if(!this._isSelectable)return;e.target.type==="checkbox"&&!this._isDisabled&&this._item&&this.dispatchEvent(new CustomEvent("card-select",{bubbles:!0,composed:!0,detail:{instanceId:this._item.instanceId}}))}),this.addEventListener("animationend",e=>{e.animationName==="newly-drafted-animation"&&this.classList.remove("animate-newly-drafted")})}set item(e){this._item=e,this.render()}get item(){return this._item}set stackCount(e){this._stackCount=e,this.render()}get stackCount(){return this._stackCount}set isSelectable(e){this._isSelectable=e,this.render()}get isSelectable(){return this._isSelectable}set purchaseInfo(e){this._purchaseInfo=e,this.render()}get purchaseInfo(){return this._purchaseInfo}set isSelected(e){this._isSelected=e,this.render()}get isSelected(){return this._isSelected}set isDisabled(e){this._isDisabled=e,this.render()}get isDisabled(){return this._isDisabled}set isNewlyDrafted(e){this._isNewlyDrafted!==e&&(this._isNewlyDrafted=e,this._isNewlyDrafted&&this.classList.add("animate-newly-drafted"))}get isNewlyDrafted(){return this._isNewlyDrafted}connectedCallback(){this.render()}render(){if(!this._item)return;const e=Ze[this._item.rarity]||"text-gray-400",t="relative transition-all duration-200",n=`card-checkbox-${this._item.instanceId}`;let s="";this._isSelectable&&(this._isDisabled?s="opacity-50 cursor-not-allowed":s="cursor-pointer");const o=this.classList.contains("animate-newly-drafted")?" animate-newly-drafted":"";this.className=`${t} ${s} ${o}`;let r=a("items_and_rooms."+this._item.id),l="";if("stats"in this._item){const c=this._item,m=this._item;switch(this._item.type){case"item_weapon":case"item_potion":case"item_armor":case"item_buff":l=`
          ...
          `;break;case"room_healing":l=`
            ${m.stats.hp?T(a("global.health"),m.stats.hp,!0):""}
          `;break;case"room_enemy":case"room_boss":case"room_trap":l=`
            ${m.stats.attack?T(a("global.attack"),m.stats.attack,!1,m.units):""}
            ${m.stats.hp?T(a("global.health"),m.stats.hp,!1,m.units):""}
    ...
    `;const e=this.querySelector("#item-cards");if(e){e.innerHTML="";for(const t of this._items){const n=document.createElement("choice-card");n.item=t,n.purchaseInfo={cost:t.cost||0,canAfford:this._balancePoints>=(t.cost||0)},e.appendChild(n)}}}}customElements.define("workshop-screen",Xe);class Qe extends HTMLElement{constructor(){super(),this.engine=null,this.metaManager=null,this.addEventListener("click",async e=>{if(!this.engine||!this.metaManager)return;const t=e.target;t.id==="new-game-button"?(this.metaManager.metaState.adventurers>0||this.metaManager.metaState.highestRun>0,this.engine.hasSaveGame()?await U.show(a("menu.new_game"),a("menu.new_game_confirm"))&&this.engine.startNewGame():this.engine.startNewGame()):t.id==="continue-game-button"?this.engine.continueGame():t.id==="reset-game-button"&&await U.show(a("menu.reset_save"),a("menu.reset_save_confirm"))&&(this.metaManager.reset(),this.engine.quitGame(!0),this.render())})}connectedCallback(){this.render()}render(){if(!this.metaManager||!this.engine)return;const e=this.metaManager.metaState,t=this.engine.hasSaveGame();let n="";if(t){const s=e.adventurers||0;n=`
      ...
      <div class="window" style="width: 400px;">
        ...
        <div class="status-bar">
          ...
          <p class="status-bar-field">build 183</p>
        </div>
      </div>
    `}}customElements.define("menu-screen",Qe);const et=3e3,tt=900;class oe extends HTMLElement{constructor(){super(),this.onDismiss=()=>{},this.payload=null,this.currentEventIndex=0,this.battleSpeed=tt,this.modalState="reveal"}connectedCallback(){if(!this.payload)return;this.innerHTML=`
...
.connector-label {
  ...
  user-select: none;
    ...
    `,this.shadowRoot.appendChild(e)}_createSVGElement(e,t={}){const n=document.createElementNS("http://www.w3.org/2000/svg",e);for(const s in t)n.setAttribute(s,t[s]);return n}_prepareTree(e,t=0,n=null){const s=e,o=n;if(s.depth=t,s.parent=o,this._maxDepth=Math.max(this._maxDepth,t),this._allNodes.push(s),!s.children||s.children.length===0)return s.leafCount=1,1;let r=0;for(const l of s.children)r+=this._prepareTree(l,t+1,s);return s.leafCount=r,r}_calculatePositions(e,t,n){const o=this._maxDepth*(M+F)-e.depth*(M+F),r=t+(n-t)/2-L/2;if(this._positions.set(e.id,{x:r,y:o}),!e.children||e.children.length===0)return;let l=t;for(const d of e.children){const c=(n-t)*d.leafCount/e.leafCount;this._calculatePositions(d,l,l+c),l+=c}}_drawConnector(e,t){const n=this._positions.get(e.id),s=this._positions.get(t.id),o=this._data.path.includes(t.id)&&this._data.path.includes(e.id),r=n.x+L/2,l=n.y,d=s.x+L/2,c=s.y+M,m=l-F/2,h=this._createSVGElement("g"),u=this._createSVGElement("path",{d:`M ${r} ${l} V ${m} H ${d} V ${c}`,stroke:o?"var(--path-connector-color)":"var(--connector-color)","stroke-width":o?"2.5":"1.5",fill:"none"});h.appendChild(u);const p=this._data.linkLabels[t.id];if(p){const g=this._createSVGElement("text",{class:"connector-label",x:d+"",y:m+"",dy:"-4px"});g.textContent=p,o&&(g.style.fill="var(--path-connector-color)",g.style.fontWeight="700"),h.appendChild(g)}this._groupEl.prepend(h)}_drawNode(e){const t=this._positions.get(e.id),n=this._data.path.includes(e.id),s=this._createSVGElement("g"),o=this._createSVGElement("rect",{x:t.x,y:t.y,width:L+"",height:M+"",fill:n?"var(--path-node-bg)":"var(--node-bg)",stroke:n?"var(--path-node-border)":"var(--node-border)",class:"node-rect",filter:"url(#shadow)"});s.appendChild(o);const r=this._createSVGElement("text",{class:"node-text"}),l=e.label.split(" ");let d="";const c=[],m=L-20;for(let p=0;p<l.length;p++){const g=d+l[p]+" ",f=this._createSVGElement("text",{class:"node-text",style:"visibility: hidden;"});f.textContent=g,this._svgEl.appendChild(f);const y=f.getComputedTextLength();this._svgEl.removeChild(f),y>m&&p>0?(c.push(d),d=l[p]+" "):d=g}c.push(d);const h=16,u=t.y+M/2-(c.length-1)*h/2;r.setAttribute("y",u+""),c.forEach((p,g)=>{const f=this._createSVGElement("tspan",{x:t.x+L/2,dy:g===0?"0":`${h}px`});f.textContent=p.trim(),r.appendChild(f)}),s.appendChild(r),this._groupEl.appendChild(s)}_createDefs(){const e=this._createSVGElement("defs"),t=this._createSVGElement("filter",{id:"shadow",x:"-50%",y:"-50%",width:"200%",height:"200%"}),n=this._createSVGElement("feDropShadow",{dx:"2",dy:"2",stdDeviation:"3","flood-color":"var(--node-shadow)"});t.appendChild(n),e.appendChild(t),this._groupEl.parentElement.appendChild(e)}_setupZoomAndPan(){let e=!1,t={x:0,y:0};const n=()=>{this._groupEl.setAttribute("transform",`translate(${this._transform.tx}, ${this._transform.ty}) scale(${this._transform.scale})`)};this._svgEl.addEventListener("wheel",o=>{o.preventDefault();const r=1.1,l=o.deltaY<0?r:1/r,d=this._svgEl.getBoundingClientRect(),c=o.clientX-d.left,m=o.clientY-d.top;this._transform.tx=c-(c-this._transform.tx)*l,this._transform.ty=m-(m-this._transform.ty)*l,this._transform.scale*=l,n()}),this._svgEl.addEventListener("mousedown",o=>{e=!0,t={x:o.clientX,y:o.clientY},this._svgEl.style.cursor="grabbing"}),this._svgEl.addEventListener("mousemove",o=>{if(!e)return;const r={x:o.clientX,y:o.clientY},l=r.x-t.x,d=r.y-t.y;this._transform.tx+=l,this._transform.ty+=d,t=r,n()});const s=()=>{e&&(e=!1,this._svgEl.style.cursor="grab")};this._svgEl.addEventListener("mouseup",s),this._svgEl.addEventListener("mouseleave",s)}_centerChart(){const e=this._groupEl.getBBox(),t=this.getBoundingClientRect();if(e.width===0||e.height===0)return;const n=80,s=t.width/(e.width+n),o=t.height/(e.height+n),r=Math.min(s,o,1);this._transform.scale=r,this._transform.tx=t.width/2-(e.x+e.width/2)*r,this._transform.ty=t.height/2-(e.y+e.height/2)*r,this._groupEl.setAttribute("transform",`translate(${this._transform.tx}, ${this._transform.ty}) scale(${this._transform.scale})`)}render(){if(this._svgEl&&this.shadowRoot.removeChild(this._svgEl),!this._data)return;this._svgEl=this._createSVGElement("svg"),this.shadowRoot.appendChild(this._svgEl),this._groupEl=this._createSVGElement("g"),this._svgEl.appendChild(this._groupEl),this._createDefs(),this._prepareTree(this._data.nodes);const e=this._data.nodes.leafCount*(L+nt);this._calculatePositions(this._data.nodes,0,e);for(const t of this._allNodes)t.parent&&this._drawConnector(t.parent,t);for(const t of this._allNodes)this._drawNode(t);this._centerChart(),this._setupZoomAndPan()}}customElements.define("dungeon-chart",it);const $=document.getElementById("app");if(!$)throw new Error("Could not find app element to mount to");async function at(){$.innerHTML="<div>Initializing...</div>";const i=new Oe;await he(i);const e=new De,t=new Ae(e),n=new Me(e),s=new Ie(t,i,n);s.on("state-change",o=>{if(s.isLoading){$.innerHTML=`<div>${a("global.loading_game_data")}</div>`;return}if(s.error){$.innerHTML=`
            ...
            `;return}Te($,o,s)}),s.on("show-encounter",async o=>{const{EncounterModal:r}=await ce(async()=>{const{EncounterModal:l}=await Promise.resolve().then(()=>st);return{EncounterModal:l}},void 0);await r.show(o),s.continueEncounter()}),$.innerHTML=`<div>${a("global.initializing")}</div>`,document.body.addEventListener("mouseover",o=>P.handleMouseEnter(o)),document.body.addEventListener("click",o=>P.handleClick(o)),await s.init(),s.showMenu()}at().catch(i=>{console.error(i),$&&($.innerHTML=`
      <div class="min-h-screen flex items-center justify-center p-4">
          <div class="bg-brand-surface p-8 rounded-xl shadow-2xl text-center border border-brand-secondary">
