(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function t(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(i){if(i.ep)return;i.ep=!0;const a=t(i);fetch(i.href,a)}})();var f=(s=>(s[s.Arousal=0]="Arousal",s[s.Flow=1]="Flow",s[s.Control=2]="Control",s[s.Relaxation=3]="Relaxation",s[s.Boredom=4]="Boredom",s[s.Apathy=5]="Apathy",s[s.Worry=6]="Worry",s[s.Anxiety=7]="Anxiety",s))(f||{});class re{constructor(e){this.seed=e}setSeed(e){this.seed=e}nextFloat(){let e=this.seed+=1831565813;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}nextInt(e,t){return Math.floor(this.nextFloat()*(t-e+1))+e}}const y=new re(Date.now()),J=s=>`${s}_${y.nextFloat().toString(36).substr(2,9)}`,le=(s,e)=>y.nextInt(s,e),Q=s=>{const e=[...s];for(let t=e.length-1;t>0;t--){const n=y.nextInt(0,t);[e[t],e[n]]=[e[n],e[t]]}return e},Y=(s,e,t,n)=>{const i=e.filter(m=>s.includes(m.id)),a=[],r={Common:.6,Uncommon:.3,Rare:.1},l={Common:0,Uncommon:0,Rare:0},c={Common:0,Uncommon:0,Rare:0};Object.keys(r).forEach(m=>{c[m]=Math.floor(t*r[m])});let b=Object.values(c).reduce((m,g)=>m+g,0);for(;b<t;)c.Common+=1,b+=1;i.filter(m=>m.cost!==null).forEach(m=>{a.push(n(m)),l[m.rarity]+=1}),Object.keys(r).forEach((m,g)=>{const d=i.filter(h=>h.rarity===m);for(;l[m]<c[m]&&d.length!==0;){const h=y.nextInt(0,d.length-1),u=d[h];a.push(n(u)),l[m]+=1}});const p=i.filter(m=>m.rarity==="Common");for(;a.length<t&&p.length>0;){const m=y.nextInt(0,p.length-1),g=p[m];a.push(n(g))}return Q(a)},z=(s,e,t)=>Y(s,e,t,n=>({...n,instanceId:J(n.id)})),Z=(s,e,t)=>Y(s,e,t,i=>{const a={...i,instanceId:J(i.id)};return a.type==="enemy"&&a.stats.minUnits&&a.stats.maxUnits&&(a.units=le(a.stats.minUnits,a.stats.maxUnits)),a}),ce=s=>s.roomHand.length<3&&!s.roomHand.some(e=>e.type==="boss"),de=s=>[...new Set(s.hand.map(t=>t.id))].length<2&&s.hand.length>0;function he(s,e){const t=Math.max(0,Math.min(100,s)),n=Math.max(0,Math.min(100,e));return n>66?t<33?f.Anxiety:t<87?f.Arousal:f.Flow:n>33?t<33?f.Worry:t<67?f.Apathy:f.Control:t<67?f.Boredom:f.Relaxation}const T={hp:100,maxHp:100,power:5},me=3;class H{constructor(e,t){this.hp=T.hp,this.maxHp=T.maxHp,this.power=T.power,this.skill=e.skill,this.challengeHistory=[50],this.flowState=f.Boredom,this.traits=e,this.inventory={weapon:null,armor:null,potions:[]},this.activeBuffs=[],this.logger=t,this.roomHistory=[],this.lootHistory=[],this.boredomCounter=0}get challenge(){return this.challengeHistory.length===0?50:this.challengeHistory.reduce((t,n)=>t+n,0)/this.challengeHistory.length}modifySkill(e){const t=this.skill;this.skill=Math.max(0,Math.min(100,this.skill+e)),t.toFixed(1)!==this.skill.toFixed(1)&&this.logger.debug(`Skill changed from ${t.toFixed(1)} to ${this.skill.toFixed(1)}`),this.updateFlowState()}modifyChallenge(e){const t=this.challenge,n=Math.max(0,Math.min(100,e));this.challengeHistory.push(n),this.challengeHistory.length>me&&this.challengeHistory.shift(),this.logger.debug(`Challenge changed from ${t.toFixed(1)} to ${this.challenge.toFixed(1)} (new value: ${n})`),this.updateFlowState()}updateFlowState(){const e=this.flowState;this.flowState=he(this.skill,this.challenge),e!==this.flowState&&(this.logger.info(`Adventurer's state of mind changed from ${f[e]} to ${f[this.flowState]}`),this.logger.log(`Flow state changed to ${f[this.flowState]}`,"INFO",{event:"flow_state_changed",flowState:f[this.flowState]}))}equip(e){e.type==="Weapon"?this.inventory.weapon=e:e.type==="Armor"&&(this.inventory.armor=e),this.recalculateStats()}addPotion(e){e.type==="Potion"&&this.inventory.potions.push(e)}applyBuff(e){this.activeBuffs.push(e),this.recalculateStats()}updateBuffs(){const e=this.activeBuffs.filter(t=>t.stats.duration!==void 0&&t.stats.duration<=1);this.activeBuffs=this.activeBuffs.map(t=>(t.stats.duration&&(t.stats.duration-=1),t)).filter(t=>t.stats.duration===void 0||t.stats.duration>0),e.length>0&&this.recalculateStats()}recalculateStats(){const e=this.hp/this.maxHp;let t=T.power,n=T.maxHp;this.inventory.weapon&&(t+=this.inventory.weapon.stats.power||0,n+=this.inventory.weapon.stats.maxHp||0),this.inventory.armor&&(t+=this.inventory.armor.stats.power||0,n+=this.inventory.armor.stats.maxHp||0),this.activeBuffs.forEach(i=>{t+=i.stats.power||0,n+=i.stats.maxHp||0}),this.power=t,this.maxHp=n,this.hp=Math.round(this.maxHp*e)}toJSON(){return{hp:this.hp,maxHp:this.maxHp,power:this.power,traits:this.traits,inventory:this.inventory,activeBuffs:this.activeBuffs,skill:this.skill,challengeHistory:this.challengeHistory,flowState:this.flowState,roomHistory:this.roomHistory,lootHistory:this.lootHistory,boredomCounter:this.boredomCounter}}static fromJSON(e,t){const n=e.traits,i=new H(n,t);return i.hp=e.hp,i.maxHp=e.maxHp,i.power=e.power,i.inventory=e.inventory,i.activeBuffs=e.activeBuffs,i.skill=e.skill,i.challengeHistory=e.challengeHistory,i.flowState=e.flowState,i.roomHistory=e.roomHistory,i.lootHistory=e.lootHistory,i.boredomCounter=e.boredomCounter,i}}class M{constructor(){this.entries=[],this.listeners=[],this.muted=!1}on(e){this.listeners.push(e)}log(e,t="INFO",n){const i={message:e,level:t,timestamp:Date.now(),data:n};this.muted||(this.entries.push(i),t!=="DEBUG"&&console.log(`[${t}] ${e}`)),this.listeners.forEach(a=>a(i))}debug(e){this.log(e,"DEBUG")}info(e){this.log(e,"INFO")}warn(e){this.log(e,"WARN")}error(e){this.log(e,"ERROR")}toJSON(){return{entries:this.entries}}static fromJSON(e){const t=new M;return t.entries=e.entries||[],t}}const ue=99,pe=10,q=10,D=32,ge=8;let X={};async function ee(s,e){try{X=await e.loadJson(`locales/${s}.json`)}catch(t){console.warn(`Failed to load ${s} translations:`,t),s!=="en"&&await ee("en",e)}}function fe(){return typeof navigator<"u"&&navigator.language?navigator.language.split("-")[0]:"en"}function o(s,e={}){let n=s.split(".").reduce((i,a)=>i?i[a]:void 0,X);if(!n)return console.warn(`Translation not found for key: ${s}`),s;for(const i in e)n=n.replace(`{${i}}`,String(e[i]));return n}async function be(s){const e=fe();await ee(e,s)}var C=(s=>(s.WORKSHOP="workshop",s.HAND_SIZE_INCREASE="hand_size_increase",s.ADVENTURER_TRAITS="ADVENTURER_TRAITS",s.BP_MULTIPLIER="BP_MULTIPLIER",s.WORKSHOP_ACCESS="WORKSHOP_ACCESS",s.BP_MULTIPLIER_2="BP_MULTIPLIER_2",s))(C||{});const te=[{feature:"workshop",runThreshold:2,title:()=>o("unlocks.workshop.title"),description:()=>o("unlocks.workshop.description")},{feature:"hand_size_increase",runThreshold:3,title:()=>o("unlocks.hand_size_increase.title"),description:()=>o("unlocks.hand_size_increase.description")},{feature:"ADVENTURER_TRAITS",runThreshold:5,title:()=>o("unlocks.adventurer_traits.title"),description:()=>o("unlocks.adventurer_traits.description")},{feature:"BP_MULTIPLIER",runThreshold:8,title:()=>o("unlocks.bp_multiplier.title"),description:()=>o("unlocks.bp_multiplier.description")},{feature:"WORKSHOP_ACCESS",runThreshold:13,title:()=>o("unlocks.workshop_access.title"),description:()=>o("unlocks.workshop_access.description")},{feature:"BP_MULTIPLIER_2",runThreshold:21,title:()=>o("unlocks.bp_multiplier_2.title"),description:()=>o("unlocks.bp_multiplier_2.description")}],se=10;function ne(s,e){var b,p,m,g;const{traits:t,inventory:n,hp:i,maxHp:a}=s;let r=(e.rarity==="Uncommon"?2:e.rarity==="Rare"?3:1)*5;const l=((b=n.weapon)==null?void 0:b.stats.power)||0,c=((p=n.armor)==null?void 0:p.stats.maxHp)||0;switch(e.type){case"Weapon":const d=(e.stats.power||0)-l;if(d<=0&&e.id!==((m=n.weapon)==null?void 0:m.id))return-1;r+=d*(t.offense/10),d>0&&(r+=d*(s.skill/10));const h=e.stats.maxHp||0;h<0&&(r+=h*(100-t.resilience)/20);break;case"Armor":const u=(e.stats.maxHp||0)-c;if(u<=0&&e.id!==((g=n.armor)==null?void 0:g.id))return-1;r+=u*(100-t.offense)/10,u>0&&(r+=u*(s.skill/10));const x=e.stats.power||0;x>0&&(r+=x*(t.offense/15));const _=e.stats.power||0;_<0&&(r+=_*(t.resilience/10));break;case"Potion":const v=i/a;r+=10*(100-t.resilience)/100,v<.7&&(r+=20*(1-v)),r+=5*(s.skill/100),n.potions.length>=ue&&(r*=.1);break}return r}function xe(s,e,t){t.debug(`--- Adventurer Loot Decision --- (Offense: ${s.traits.offense}, Resilience: ${s.traits.resilience}, Skill: ${s.skill})`);const n=e.map(r=>({item:r,score:ne(s,r)})).filter(r=>r.score>0);if(n.sort((r,l)=>l.score-r.score),n.length===0||n[0].score<pe)return{choice:null,reason:o("game_engine.adventurer_declines_offer")};const i=n[0].item;t.debug(`Adventurer chooses: ${i.name} (Score: ${n[0].score.toFixed(1)})`);const a=o("game_engine.adventurer_accepts_offer",{itemName:i.name});return{choice:i,reason:a}}function _e(s,e){const{flowState:t,hp:n,maxHp:i,inventory:a,traits:r}=s,l=n/i;if(a.potions.length===0)return"attack";let c=.5;switch(t){case f.Anxiety:case f.Worry:c=.8;break;case f.Arousal:case f.Flow:c=.6;break;case f.Control:case f.Relaxation:c=.4;break;case f.Boredom:case f.Apathy:c=.2;break}return c-=r.resilience/200,l<Math.max(.1,c)?"use_potion":"attack"}function ve(s,e,t){if(e){s.lootHistory.push(e.id),s.lootHistory.filter(a=>a===e.id).length>2&&(s.modifyChallenge(s.challenge-se),s.logger.info(`Adventurer feels a sense of repetitiveness from seeing ${e.name} again.`));const i=ne(s,e);i>60?(s.modifySkill(10),s.modifyChallenge(s.challenge+5)):i>30?(s.modifySkill(5),s.modifyChallenge(s.challenge+2)):s.modifySkill(2)}else t.length>0?s.modifyChallenge(s.challenge-5):s.modifyChallenge(s.challenge-10);s.updateFlowState()}function we(s,e){s.roomHistory.push(e.id),s.roomHistory.filter(i=>i===e.id).length>2&&(s.modifyChallenge(s.challenge-se),s.logger.info(`Adventurer feels a sense of deja vu upon entering ${e.name}.`));let n=0;switch(e.type){case"enemy":n=5;break;case"boss":n=15;break;case"trap":n=10;break;case"healing":n=-15;break}s.modifyChallenge(s.challenge+n),s.updateFlowState()}function ye(s){s.modifySkill(-2),s.updateFlowState()}function U(s,e){switch(e){case"hit":s.modifySkill(.5);break;case"miss":s.modifySkill(-.5);break;case"take_damage":s.modifyChallenge(s.challenge+1);break}s.updateFlowState()}function ke(s,e,t,n){let i;return e>.7?(i=o("game_engine.too_close_for_comfort"),s.modifyChallenge(s.challenge+10),s.modifySkill(-3)):e>.4?(i=o("game_engine.great_battle"),s.modifyChallenge(s.challenge+5),s.modifySkill(5)):t>3&&s.traits.offense>60?(i=o("game_engine.easy_fight"),s.modifyChallenge(s.challenge-10)):(i=o("game_engine.worthy_challenge"),s.modifyChallenge(s.challenge-2),s.modifySkill(2)),t===n&&s.modifySkill(1*t),s.updateFlowState(),i}class Se{constructor(e,t,n){this.gameState=null,this.isLoading=!0,this.error=null,this._allItems=[],this._allRooms=[],this._listeners={},this.init=async()=>{await this._loadGameData()},this.startNewGame=i=>{this.metaManager.incrementAdventurers();const a={offense:y.nextInt(10,90),resilience:y.nextInt(10,90),skill:0},r=new M,l=new H(a,r),c=(i==null?void 0:i.items)||this._allItems.filter(_=>_.cost===null).map(_=>_.id),b=z(c,this._allItems,D),p=this._getHandSize(),m=b.slice(0,p),g=b.slice(p),d=(i==null?void 0:i.rooms)||this._allRooms.filter(_=>_.cost===null).map(_=>_.id),h=Z(d,this._allRooms,D),u=h.slice(0,p),x=h.slice(p);r.info("--- Starting New Adventurer (Run 1) ---"),this.gameState={phase:"DESIGNER_CHOOSING_ROOM",designer:{balancePoints:0},adventurer:l,unlockedDeck:c,availableDeck:g,hand:m,unlockedRoomDeck:d,availableRoomDeck:x,roomHand:u,handSize:p,shopItems:[],offeredLoot:[],offeredRooms:[],feedback:o("game_engine.new_adventurer"),logger:r,run:1,room:1,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null},this.gameState.logger.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),this._emit("state-change",this.gameState)},this.continueGame=()=>{const i=this.gameSaver.load();i?(this.gameState=i,this._emit("state-change",this.gameState)):this.startNewGame()},this.startNewRun=i=>{if(!this.gameState)return;const a=i||this.gameState.run+1;this.metaManager.updateRun(a);const r=this._getHandSize(),l=z(this.gameState.unlockedDeck,this._allItems,D),c=l.slice(0,r),b=l.slice(r),p=Z(this.gameState.unlockedRoomDeck,this._allRooms,D),m=p.slice(0,r),g=p.slice(r),d=new H(this.gameState.adventurer.traits,this.gameState.logger);d.skill=this.gameState.adventurer.skill,d.challengeHistory=[...this.gameState.adventurer.challengeHistory],d.flowState=this.gameState.adventurer.flowState,this.gameState.logger.info(`--- Starting Run ${a} ---`),this.gameState.logger.debug(`Unlocked features: ${[...this.metaManager.acls].join(", ")}`),this.gameState={...this.gameState,adventurer:d,phase:"DESIGNER_CHOOSING_ROOM",availableDeck:b,hand:c,availableRoomDeck:g,roomHand:m,handSize:r,room:1,run:a,feedback:o("game_engine.adventurer_returns"),runEnded:{isOver:!1,reason:"",success:!1,decision:null}},this._emit("state-change",this.gameState)},this.presentOffer=i=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_LOOT"||!this.gameState.hand)return;const a=this.gameState.hand.filter(_=>i.includes(_.instanceId));this.gameState.offeredLoot=a;const r=this.gameState.adventurer,{choice:l,reason:c}=xe(r,this.gameState.offeredLoot,this.gameState.logger);ve(r,l,this.gameState.offeredLoot),l&&this.gameState.logger.log("Item chosen by adventurer","INFO",{event:"item_chosen",item:l});let b=this.gameState.hand,p=this.gameState.availableDeck;b.forEach(_=>_.justDrafted=!1);let m=b.filter(_=>!i.includes(_.instanceId));const g=this.gameState.handSize-m.length,d=p.slice(0,g);d.forEach(_=>{_.draftedRoom=this.gameState.room,_.justDrafted=!0});const h=p.slice(g);m.push(...d),l&&(l.type==="Potion"?r.addPotion(l):l.type==="Buff"?r.applyBuff(l):r.equip(l));const u=this.gameState.room+1,x=this.gameState.designer.balancePoints+this._getBpPerRoom();this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",adventurer:r,feedback:c,availableDeck:h,hand:m,room:u,designer:{balancePoints:x}},this._emit("state-change",this.gameState)},this.runEncounter=i=>{if(!this.gameState||this.gameState.phase!=="DESIGNER_CHOOSING_ROOM")return;this.gameState.offeredRooms=i;let a=this.gameState.adventurer,r=[];const l=y.nextInt(0,this.gameState.offeredRooms.length-1),c=this.gameState.offeredRooms[l];switch(a.roomHistory.push(c.id),we(a,c),this.gameState.logger.log(`--- Encountering Room: ${c.name} ---`,"INFO",{event:"room_encountered",room:c}),c.type){case"enemy":case"boss":const x={enemyCount:c.units??1,enemyPower:c.stats.attack||5,enemyHp:c.stats.hp||10},_=this._simulateEncounter(a,this.gameState.room,x);a=_.newAdventurer,r=_.feedback;break;case"healing":const v=c.stats.hp||0;a.hp=Math.min(a.maxHp,a.hp+v),r.push(o("game_engine.healing_room",{name:c.name,healing:v})),this.gameState.logger.info(o("game_engine.healing_room",{name:c.name,healing:v}));break;case"trap":const w=c.stats.attack||0;a.hp-=w,ye(a),r.push(o("game_engine.trap_room",{name:c.name,damage:w})),this.gameState.logger.info(o("game_engine.trap_room",{name:c.name,damage:w}));break}a.updateBuffs(),this.gameState.designer.balancePoints+=this._getBpPerRoom();let b=this.gameState.roomHand,p=this.gameState.availableRoomDeck;b.forEach(x=>x.justDrafted=!1);const m=this.gameState.offeredRooms.map(x=>x.instanceId);let g=b.filter(x=>!m.includes(x.instanceId));const d=this.gameState.handSize-g.length,h=p.slice(0,d);h.forEach(x=>{x.draftedRoom=this.gameState.room,x.justDrafted=!0});const u=p.slice(d);if(g.push(...h),this.gameState.adventurer=a,a.hp<=0){this._endRun(o("game_engine.adventurer_fell",{room:this.gameState.room,run:this.gameState.run}));return}if(a.boredomCounter>2){const x=a.flowState===f.Boredom?o("game_engine.adventurer_bored",{room:this.gameState.room,run:this.gameState.run}):o("game_engine.adventurer_apathy",{room:this.gameState.room,run:this.gameState.run});this._endRun(x);return}this.gameState.hand&&this.gameState.hand.length===0?(this.gameState.logger.warn("Your hand is empty! The adventurer must press on without new items."),r.push(o("game_engine.empty_hand")),this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_ROOM",room:this.gameState.room+1,designer:{balancePoints:this.gameState.designer.balancePoints+this._getBpPerRoom()},feedback:r,encounter:void 0,roomHand:g,availableRoomDeck:u}):this.gameState={...this.gameState,phase:"DESIGNER_CHOOSING_LOOT",feedback:r,encounter:void 0,roomHand:g,availableRoomDeck:u},this._emit("state-change",this.gameState)},this.forceEndRun=()=>{this.gameState&&(this.gameState.adventurer.modifyChallenge(-20),this.gameState.adventurer.updateFlowState(),this._endRun(o("game_engine.no_more_rooms"),!0))},this.enterWorkshop=()=>{if(!this.gameState)return;if(this.gameState.logger.info("Entering workshop."),!this.metaManager.acls.has(C.WORKSHOP)){this.gameState.logger.info("Workshop not unlocked, starting new run."),this.startNewRun();return}const i=this.gameState.run+1,a=this._allItems.filter(c=>c.cost!==null).filter(c=>!this.gameState.unlockedDeck.includes(c.id)),r=this._allRooms.filter(c=>c.cost!==null).filter(c=>!this.gameState.unlockedRoomDeck.includes(c.id)),l=[...a,...r];this.gameState={...this.gameState,phase:"SHOP",shopReturnPhase:this.gameState.phase,run:i,room:0,shopItems:Q(l).slice(0,4),runEnded:{isOver:!1,reason:"",success:!1,decision:null},feedback:o("game_engine.welcome_to_workshop")},this._emit("state-change",this.gameState)},this.exitWorkshop=()=>{this.gameState&&this.startNewRun()},this.purchaseItem=i=>{if(!this.gameState)return;const a=this._allItems.find(h=>h.id===i),r=this._allRooms.find(h=>h.id===i),l=a||r;if(!l||l.cost===null||this.gameState.designer.balancePoints<l.cost)return;let c=this.gameState.unlockedDeck,b=this.gameState.unlockedRoomDeck,p=this.gameState.availableDeck,m=this.gameState.availableRoomDeck;a?(c=[...this.gameState.unlockedDeck,i],this.isWorkshopAccessUnlocked()&&(p=[a,...this.gameState.availableDeck])):r&&(b=[...this.gameState.unlockedRoomDeck,i],this.isWorkshopAccessUnlocked()&&(m=[r,...this.gameState.availableRoomDeck]));const g=this.gameState.designer.balancePoints-l.cost,d=this.gameState.shopItems.filter(h=>h.id!==i);this.gameState.logger.log(`Purchased ${l.name}.`,"INFO",{event:"item_purchased",item:l}),this.gameState={...this.gameState,designer:{balancePoints:g},unlockedDeck:c,unlockedRoomDeck:b,availableDeck:p,availableRoomDeck:m,shopItems:d},this._emit("state-change",this.gameState)},this.quitGame=(i=!0)=>{i&&this.gameSaver.clear(),this.showMenu()},this.showMenu=()=>{this.gameState={...this.gameState||this._getInitialGameState(),phase:"MENU"},this._emit("state-change",this.gameState)},this._getBpPerRoom=()=>this.metaManager.acls.has(C.BP_MULTIPLIER_2)?q*4:this.metaManager.acls.has(C.BP_MULTIPLIER)?q*2:q,this.saveGame=()=>{this.gameState&&this.gameState.phase!=="MENU"&&this.gameState.phase!=="RUN_OVER"&&this.gameSaver.save(this.gameState)},this.metaManager=e,this.dataLoader=t,this.gameSaver=n}on(e,t){this._listeners[e]||(this._listeners[e]=[]),this._listeners[e].push(t)}_emit(e,t){e==="state-change"&&this.saveGame();const n=this._listeners[e];n&&n.forEach(i=>i(t))}_simulateEncounter(e,t,n){var m,g,d,h,u,x,_,v,w,A,N;(m=this.gameState)==null||m.logger.log(`--- Encounter: Room ${t} ---`,"INFO",{event:"battle_started",encounter:n});const i=[];let a=0,r=0;const l=e.hp;for(let P=0;P<n.enemyCount;P++){(g=this.gameState)==null||g.logger.info(`Adventurer encounters enemy ${P+1}/${n.enemyCount}.`);let B=n.enemyHp;for(;B>0&&e.hp>0;){if(_e(e)==="use_potion"){const $=e.inventory.potions.shift();if($){const k=$.stats.hp||0;e.hp=Math.min(e.maxHp,e.hp+k),i.push(o("game_engine.adventurer_drinks_potion",{potionName:$.name})),(d=this.gameState)==null||d.logger.info(`Adventurer used ${$.name} and recovered ${k} HP.`)}}else{const $=Math.min(.95,.75+e.traits.skill/500+e.traits.offense/1e3);if(y.nextFloat()<$){const k=e.power;B-=k,(h=this.gameState)==null||h.logger.debug(`Adventurer hits for ${k} damage.`),U(e,"hit")}else(u=this.gameState)==null||u.logger.debug("Adventurer misses."),U(e,"miss")}if(B<=0){(x=this.gameState)==null||x.logger.info("Enemy defeated."),r++;break}const oe=Math.max(.4,.75-e.traits.skill/500-(100-e.traits.offense)/1e3);if(y.nextFloat()<oe){const $=(((_=e.inventory.armor)==null?void 0:_.stats.maxHp)||0)/10,k=Math.max(1,n.enemyPower-$);a+=k,e.hp-=k,(v=this.gameState)==null||v.logger.debug(`Enemy hits for ${k} damage.`),U(e,"take_damage")}else(w=this.gameState)==null||w.logger.debug("Enemy misses.")}if(e.hp<=0){(A=this.gameState)==null||A.logger.warn("Adventurer has been defeated.");break}}const c=l-e.hp,b=c/e.maxHp;(N=this.gameState)==null||N.logger.debug(`hpLost: ${c}, hpLostRatio: ${b.toFixed(2)}`);const p=ke(e,b,r,n.enemyCount);return i.push(p),{newAdventurer:e,feedback:i,totalDamageTaken:a}}_endRun(e,t=!1){if(!this.gameState)return;const n=this.metaManager.checkForUnlocks(this.gameState.run);this.gameState.logger.log(`Run ended with ${this.gameState.designer.balancePoints} BP.`,"INFO",{event:"run_end",bp:this.gameState.designer.balancePoints}),this.gameState.logger.error(`GAME OVER: ${e}`);const i=this._getAdventurerEndRunDecision();this.gameState={...this.gameState,phase:"RUN_OVER",runEnded:{isOver:!0,reason:e,success:t,decision:i},newlyUnlocked:n},this._emit("state-change",this.gameState)}_getAdventurerEndRunDecision(){if(!this.gameState)return"retire";const{flowState:e,traits:t,skill:n}=this.gameState.adventurer,{resilience:i,offense:a}=t,r=Math.min(n/100,1);if(e===f.Flow)return"continue";let l=.55;switch(e){case f.Anxiety:l+=.25-i/400;break;case f.Arousal:l-=.1-a/1e3;break;case f.Worry:l+=.2;break;case f.Control:l-=.15;break;case f.Relaxation:l+=.1;break;case f.Boredom:l+=.3;break;case f.Apathy:l+=.4;break}return l-=r*.1,l=Math.max(.05,Math.min(.95,l)),y.nextFloat()<l?"retire":"continue"}handleEndOfRun(e){if(this.gameState){if(this.gameState.logger.info(`Adventurer decided to ${e}.`),e==="retire"){this.quitGame(!1);return}this.enterWorkshop()}}_getInitialGameState(){const e={offense:y.nextInt(10,90),resilience:y.nextInt(10,90),skill:0},t=new M,n=new H(e,t);return{phase:"MENU",designer:{balancePoints:0},adventurer:n,unlockedDeck:[],availableDeck:[],hand:[],unlockedRoomDeck:[],availableRoomDeck:[],roomHand:[],handSize:this._getHandSize(),shopItems:[],offeredLoot:[],offeredRooms:[],feedback:"",logger:t,run:0,room:0,runEnded:{isOver:!1,reason:"",success:!1,decision:null},newlyUnlocked:[],shopReturnPhase:null}}_getHandSize(){return this.metaManager.acls.has(C.HAND_SIZE_INCREASE)?12:ge}isWorkshopAccessUnlocked(){return this.metaManager.acls.has(C.WORKSHOP_ACCESS)}isWorkshopUnlocked(){return this.metaManager.acls.has(C.WORKSHOP)}hasSaveGame(){return this.gameSaver.hasSaveGame()}async _loadGameData(){try{this._allItems=await this.dataLoader.loadJson("game/items.json"),this._allRooms=await this.dataLoader.loadJson("game/rooms.json")}catch(e){this.error=e.message||o("global.unknown_error"),this._emit("error",null)}finally{this.isLoading=!1,this._emit("state-change",this.gameState)}}}const Ee=s=>{if(!s)return o("global.initializing");switch(s.phase){case"AWAITING_ADVENTURER_CHOICE":return o("main.adventurer_considering_offer");case"AWAITING_ENCOUNTER_FEEDBACK":return o("main.adventurer_facing_encounter");default:return o("global.loading")}},$e=s=>{const e=document.createElement("loading-indicator");return e.setAttribute("text",Ee(s)),e},K=(s,e,t)=>{const n=document.createElement("choice-panel");return n.engine=e,t==="item"?(n.choices=s.hand,n.deckType="item",n.offerImpossible=de(s)):(n.choices=s.roomHand,n.deckType="room",n.roomSelectionImpossible=ce(s)),n},Ce=(s,e,t)=>{s.innerHTML="";const n=document.createElement("div");n.className="min-h-screen p-4 md:p-6 lg:p-8 flex flex-col items-center",s.appendChild(n);const i=document.createElement("div");i.className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6",n.appendChild(i);const a=document.createElement("div");a.className="lg:col-span-1 space-y-6",i.appendChild(a);const r=document.createElement("game-stats");r.engine=t,t.isWorkshopUnlocked()&&r.setAttribute("balance-points",e.designer.balancePoints.toString()),r.setAttribute("run",e.run.toString()),r.setAttribute("room",e.room.toString()),r.setAttribute("deck-size",e.availableDeck.length.toString()),a.appendChild(r);const l=document.createElement("feedback-panel"),c=Array.isArray(e.feedback)?e.feedback.join(" "):e.feedback;l.setAttribute("message",c),a.appendChild(l);const b=document.createElement("log-panel");b.logger=e.logger,b.traits=e.adventurer.traits,a.appendChild(b);const p=document.createElement("div");p.className="lg:col-span-2 space-y-6",i.appendChild(p);const m=document.createElement("adventurer-status");m.metaState=t.metaManager.metaState,m.adventurer=e.adventurer,p.appendChild(m);const g=document.createElement("div");switch(g.className="lg:col-span-3",i.appendChild(g),e.phase){case"RUN_OVER":{const d=document.createElement("run-ended-screen");d.setAttribute("final-bp",e.designer.balancePoints.toString()),d.setAttribute("reason",e.runEnded.reason),d.setAttribute("run",e.run.toString()),t.isWorkshopUnlocked()&&d.setAttribute("workshop-unlocked",""),e.runEnded.decision&&d.initialize(e.runEnded.decision,e.newlyUnlocked,t),g.appendChild(d);break}case"DESIGNER_CHOOSING_LOOT":g.appendChild(K(e,t,"item"));break;case"DESIGNER_CHOOSING_ROOM":g.appendChild(K(e,t,"room"));break;case"AWAITING_ADVENTURER_CHOICE":case"AWAITING_ENCOUNTER_FEEDBACK":g.appendChild($e(e));break}},Ie=(s,e)=>{s.innerHTML="";const t=document.createElement("menu-screen");t.engine=e,t.metaManager=e.metaManager,s.appendChild(t)},Re=(s,e,t)=>{s.innerHTML="";const n=document.createElement("workshop-screen");n.items=e.shopItems,n.balancePoints=e.designer.balancePoints,n.engine=t,s.appendChild(n)},He=(s,e,t)=>{if(!e){s.innerHTML=`<div>${o("global.loading")}</div>`;return}switch(e.phase){case"MENU":Ie(s,t);break;case"SHOP":Re(s,e,t);break;default:Ce(s,e,t);break}};function Te(){document.querySelectorAll("[data-tooltip-key]").forEach(e=>{const t=document.createElement("span");t.textContent="?",t.className="tooltip-icon",e.appendChild(t)})}const V="rogue-steward-meta";class Le{constructor(e){this.storage=e,this._metaState=this._load()}get metaState(){return this._metaState}get acls(){return new Set(this._metaState.unlockedFeatures)}checkForUnlocks(e){const t=[];for(const n of te)e>=n.runThreshold&&!this._metaState.unlockedFeatures.includes(n.feature)&&(this._metaState.unlockedFeatures.push(n.feature),t.push(n.feature));return t.length>0&&this.save(),t}incrementAdventurers(){this._metaState.adventurers=(this._metaState.adventurers||0)+1,this._metaState.adventurers>1&&this.save()}updateRun(e){e>this._metaState.highestRun&&(this._metaState.highestRun=e,this.save())}_load(){try{const e=this.storage.getItem(V);if(e){const t=JSON.parse(e);if(typeof t.highestRun=="number"&&Array.isArray(t.unlockedFeatures))return typeof t.adventurers!="number"&&(t.adventurers=1),t}}catch(e){console.error("Failed to load meta state:",e)}return this._defaultState()}save(){try{this.storage.setItem(V,JSON.stringify(this._metaState))}catch(e){console.error("Failed to save meta state:",e)}}reset(){this._metaState=this._defaultState(),this.save()}_defaultState(){return{highestRun:0,unlockedFeatures:[],adventurers:0}}}const O="rogue-steward-savegame",G="1.0.0";class Me{constructor(e){this.storage=e}save(e){try{const t=this._serialize(e);this.storage.setItem(O,JSON.stringify(t))}catch(t){console.error("Failed to save game state:",t)}}load(){try{const e=this.storage.getItem(O);if(e){const t=JSON.parse(e);return t.version!==G?(console.warn(`Save game version mismatch. Found ${t.version}, expected ${G}. Discarding save.`),this.clear(),null):this._deserialize(t)}}catch(e){console.error("Failed to load game state:",e),this.clear()}return null}hasSaveGame(){return this.storage.getItem(O)!==null}clear(){this.storage.setItem(O,"")}_serialize(e){const{adventurer:t,logger:n,...i}=e;return{version:G,...i,adventurer:t.toJSON(),logger:n.toJSON()}}_deserialize(e){const{adventurer:t,logger:n,...i}=e,a=M.fromJSON(n),r=H.fromJSON(t,a);return{...i,adventurer:r,logger:a}}}class Ae{getItem(e){return window.localStorage.getItem(e)}setItem(e,t){window.localStorage.setItem(e,t)}}class De{async loadJson(e){const t=await fetch(e);if(!t.ok)throw new Error(`Could not load ${e}`);return t.json()}}const Oe=()=>'<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1 text-red-400" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd" /></svg>',Ne=()=>'<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1 text-blue-400" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M240-400q0 68.92 36.77 126.58 36.77 57.65 98.85 86.5-7.93-11.93-11.77-24.77Q360-224.54 360-238q0-23.54 9.31-44.62 9.31-21.07 26.15-37.92L480-403.85l85.31 83.31q16.84 16.85 25.77 37.92Q600-261.54 600-238q0 13.46-3.85 26.31-3.84 12.84-11.77 24.77 62.08-28.85 98.85-86.5Q720-331.08 720-400q0-50-18.5-94.5T648-574q-20 13-42 19.5t-45 6.5q-62.77 0-108.27-41-45.5-41-51.73-102.54-39 32.23-69 67.73-30 35.5-50.5 72.77-20.5 37.27-31 75.27-10.5 38-10.5 75.77Zm240 52-57 56q-11 11-17 25t-6 29q0 32 23.5 55t56.5 23q33 0 56.5-23t23.5-55q0-16-6-29.5T537-292l-57-56Zm-40-420.46V-708q0 50.92 35.04 85.46Q510.08-588 561-588q18.77 0 36.58-6.35 17.8-6.34 33.65-18.27l17.23-13.53q52.46 38.92 82 98.92T760-400q0 117.08-81.46 198.54T480-120q-117.08 0-198.54-81.46T200-400q0-102.85 64.58-201.15Q329.15-699.46 440-768.46Z"/></svg>',Pe=()=>'<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1 text-amber-400" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M249.23-80H144.62Q117-80 98.5-98.5 80-117 80-144.62v-104.61h40v104.61q0 10.77 6.92 17.7 6.93 6.92 17.7 6.92h104.61v40Zm461.54 0v-40h104.61q10.77 0 17.7-6.92 6.92-6.93 6.92-17.7v-104.61h40v104.61q0 27.62-18.5 46.12Q843-80 815.38-80H710.77ZM480-250.77q-106.92 0-192.12-60.61Q202.69-372 159.23-480q43.46-108 128.65-168.62 85.2-60.61 192.12-60.61t192.12 60.61Q757.31-588 800.77-480q-43.46 108-128.65 168.62-85.2 60.61-192.12 60.61Zm0-40q91.08 0 163.31-49.54T756.85-480q-41.31-90.15-113.54-139.69-72.23-49.54-163.31-163.31t-163.31 49.54Q244.46-570.15 203.15-480q41.31 90.15 113.54 139.69 72.23 49.54 163.31 49.54Zm0-74.61q48 0 81.31-33.31T594.62-480q0-48-33.31-81.31T480-594.62q-48 0-81.31 33.31T365.38-480q0 48 33.31 81.31T480-365.38Zm0-40q-31.15 0-52.88-21.74-21.74-21.73-21.74-52.88 0-31.15 21.74-52.88 21.73-21.74 52.88-21.74 31.15 0 52.88 21.74 21.74 21.73 21.74 52.88 0 31.15-21.74 52.88-21.73 21.74-52.88 21.74ZM80-710.77v-104.61Q80-843 98.5-861.5 117-880 144.62-880h104.61v40H144.62q-10.77 0-17.7 6.92-6.92 6.93-6.92 17.7v104.61H80Zm760 0v-104.61q0-10.77-6.92-17.7-6.93-6.92-17.7-6.92H710.77v-40h104.61q27.62 0 46.12 18.5Q880-843 880-815.38v104.61h-40ZM480-480Z"/></svg>',Be=()=>'<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M753.54-132.15 631.15-254.31l-88 88-11.07-11.07q-18.39-18.39-18.39-45.47 0-27.07 18.39-45.46l163.61-163.61q18.39-18.39 45.46-18.39 27.08 0 45.47 18.39l11.07 11.07-88 88 122.16 122.39q9.69 9.69 9.69 22.61 0 12.93-9.69 22.62l-33.08 33.08q-9.69 9.69-22.62 9.69-12.92 0-22.61-9.69ZM840-740.92 398.31-298.46l29.61 29.38q18.39 18.39 18.39 45.46 0 27.08-18.39 45.47l-11.07 11.07-88-88-122.39 122.16q-9.69 9.69-22.61 9.69-12.93 0-22.62-9.69L128.15-166q-9.69-9.69-9.69-22.62 0-12.92 9.69-22.61l122.16-122.39-88-88 11.07-11.07q18.39-18.39 45.47-18.39 27.07 0 45.46 18.39l30.15 30.38L736.92-844H840v103.08ZM334-583l23.23-23.77 23-24-23 24L334-583Zm-28.31 28.54L120-740.92V-844h103.08L408-658.31l-27.77 27.54L207-804h-47v47l174 174-28.31 28.54ZM370-327l430-430v-47h-47L323-374l47 47Zm0 0-23.23-23.77L323-374l23.77 23.23L370-327Z"/></svg>',qe=()=>'<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M480-121.54q-120.54-35.77-200.27-146.04Q200-377.85 200-516v-216.31l280-104.61 280 104.61V-516q0 138.15-79.73 248.42Q600.54-157.31 480-121.54Zm0-42.46q104-33 172-132t68-220v-189l-240-89.23L240-705v189q0 121 68 220t172 132Zm0-315.23Z"/></svg>',Ue=()=>'<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-160q-25.54 0-36.31-22.81-10.77-22.81 5.08-42.57L400-506.15V-760h-55.38q-8.5 0-14.25-5.76t-5.75-14.27q0-8.51 5.75-14.24t14.25-5.73h270.76q8.5 0 14.25 5.76t5.75 14.27q0 8.51-5.75 14.24T615.38-760H560v253.85l231.23 280.77q15.85 19.76 5.08 42.57T760-160H200Zm80-80h400L544-400H416L280-240Zm-80 40h560L520-492v-268h-80v268L200-200Zm280-280Z"/></svg>',Ge=()=>'<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-purple-400" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M200-160q-25.54 0-36.31-22.81-10.77-22.81 5.08-42.57L400-506.15V-760h-55.38q-8.5 0-14.25-5.76t-5.75-14.27q0-8.51 5.75-14.24t14.25-5.73h270.76q8.5 0 14.25 5.76t5.75 14.27q0 8.51-5.75 14.24T615.38-760H560v253.85l231.23 280.77q15.85 19.76 5.08 42.57T760-160H200Zm80-80h400L544-400H416L280-240Zm-80 40h560L520-492v-268h-80v268L200-200Zm280-280Z"/></svg>';class je extends HTMLElement{constructor(){super(),this._adventurer=null,this._metaState=null}set adventurer(e){this._adventurer=e,this.render()}set metaState(e){this._metaState=e,this.render()}get adventurer(){return this._adventurer}connectedCallback(){this.render()}render(){var a,r;if(!this._adventurer){this.innerHTML="";return}const e=((a=this._metaState)==null?void 0:a.adventurers)||1,t=Math.max(0,this._adventurer.hp),n=t/this._adventurer.maxHp*100,i=(r=this._metaState)==null?void 0:r.unlockedFeatures.includes(C.ADVENTURER_TRAITS);this.innerHTML=`
        ...
        `,(t=this.querySelector("#enter-workshop-btn"))==null||t.addEventListener("click",()=>{var i;(i=this.engine)==null||i.enterWorkshop()}),(n=this.querySelector("#quit-game-btn"))==null||n.addEventListener("click",()=>{var i;confirm(o("global.quit_confirm"))&&((i=this.engine)==null||i.quitGame(!1))})}}customElements.define("game-stats",ze);class Ze extends HTMLElement{constructor(){super(),this._text="Loading..."}static get observedAttributes(){return["text"]}attributeChangedCallback(e,t,n){e==="text"&&(this._text=n,this.render())}connectedCallback(){this.render()}render(){this.innerHTML=`
