...
describe('GameSaver', () => {
  ...
  beforeEach(() => {
    ...
    gameState = {
      ...
      availableDeck: [{ id: 'item3', instanceId: 'i3', name: 'Deck Item', type: 'item_weapon', cost: null, stats: {}, rarity: 'common' }],
      hand: [{ id: 'item4', instanceId: 'i4', name: 'Hand Item', type: 'item_armor', cost: null, stats: {}, rarity: 'common' }],
      unlockedRoomDeck: ['room1'],
      availableRoomDeck: [{ id: 'room2', instanceId: 'r2', name: 'Deck Room', type: 'room_enemy', cost: null, stats: {}, rarity: 'common' }],
      roomHand: [{ id: 'room3', instanceId: 'r3', name: 'Hand Room', type: 'room_trap', cost: null, stats: {}, rarity: 'common' }],
      handSize: 10,
      shopItems: [],
      offeredLoot: [],
      offeredRooms: [],
