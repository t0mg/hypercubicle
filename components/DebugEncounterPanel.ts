            ...
            <div class="w-full bg-brand-surface p-6 rounded-lg shadow-xl border border-gray-700 animate-fade-in">
                ...
                <form class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                    <div class="md:col-span-1">
                        <label for="base-damage" class="block text-sm font-medium text-brand-text-muted mb-1">${t('debug_encounter_panel.base_damage')}</label>
                        <input
                            id="base-damage"
                            type="number"
                            step="1"
                            ...
                            aria-label="${t('debug_encounter_panel.base_damage')}"
                        />
                    </div>
                    <div class="md:col-span-1">
                        <label for="difficulty-factor" class="block text-sm font-medium text-brand-text-muted mb-1">${t('debug_encounter_panel.difficulty_factor')}</label>
                        <input
                            ...
                            value="1.0"
                            class="w-full bg-brand-primary p-2 rounded-md border border-gray-600 focus:ring-brand-secondary focus:border-brand-secondary text-white"
                            aria-label="${t('debug_encounter_panel.difficulty_factor')}"
                        />
                    </div>
                    <div class="md:col-span-1">
                        <button
